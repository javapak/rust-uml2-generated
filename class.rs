...
lazy_static! {
    static ref CLASS_REGISTRY: Mutex<RefCell<HashMap<String, Class>>> = 
...
#[wasm_bindgen]
impl Class {
    /// Creates a new Class and returns its ID
    #[wasm_bindgen]
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Class> = CLASS_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Class instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLASS_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Class instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Class = serde_wasm_bindgen::from_value(instance_js)
