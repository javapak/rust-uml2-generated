...
lazy_static! {
    static ref WRITE_LINK_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, WriteLinkAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct WriteLinkAction {
...
#[wasm_bindgen]
impl WriteLinkAction {
    /// Creates a new WriteLinkAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        WRITE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a WriteLinkAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: WriteLinkAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a WriteLinkAction by ID
    ...
    /// Checks if a WriteLinkAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all WriteLinkAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<WriteLinkAction> = WRITE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of WriteLinkAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        WRITE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all WriteLinkAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        WRITE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds WriteLinkAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: WriteLinkAction = serde_wasm_bindgen::from_value(instance_js)
