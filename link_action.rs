...
lazy_static! {
    static ref LINK_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, LinkAction>>> = 
...
#[wasm_bindgen]
impl LinkAction {
    /// Creates a new LinkAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a LinkAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LinkAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a LinkAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LinkAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LinkAction> = LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LinkAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LinkAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LinkAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LinkAction = serde_wasm_bindgen::from_value(instance_js)
