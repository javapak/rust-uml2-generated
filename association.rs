// Association - Generated UML Class
...
const TYPE_NAME: &str = "Association";
...
pub fn set_is_derived(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn add_owned_end(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<Property>(&ref_id) {
            target.owning_association = Some(instance_id.clone());
    ...
    pub fn remove_owned_end(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.owned_end.len();
        instance.owned_end.retain(|id| id != &ref_id);
        let removed = instance.owned_end.len() < initial_len;
    ...
    pub fn add_member_end(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        // Update opposite reference
        if let Some(mut target) = registry::get::<Property>(&ref_id) {
            target.association = Some(instance_id.clone());
            let _ = registry::insert(ref_id.clone(), "Property", &target);
        }
    ...
    pub fn remove_member_end(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.member_end.len();
        instance.member_end.retain(|id| id != &ref_id);
        let removed = instance.member_end.len() < initial_len;
    ...
    pub fn remove_navigable_owned_end(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.navigable_owned_end.len();
        instance.navigable_owned_end.retain(|id| id != &ref_id);
        let removed = instance.navigable_owned_end.len() < initial_len;
