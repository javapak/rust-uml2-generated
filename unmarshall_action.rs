...
lazy_static! {
    static ref UNMARSHALL_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, UnmarshallAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct UnmarshallAction {
    ...
    pub unmarshall_type: String,
    pub object: String,
}

#[wasm_bindgen]
impl UnmarshallAction {
    /// Creates a new UnmarshallAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, unmarshall_type: String, object: String) -> String {
        ...
        let instance = Self {
            ...
            result: Vec::new(),
            unmarshall_type: unmarshall_type,
            object: object,
        };

        UNMARSHALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a UnmarshallAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: UnmarshallAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a UnmarshallAction by ID
    ...
    /// Checks if a UnmarshallAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all UnmarshallAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<UnmarshallAction> = UNMARSHALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of UnmarshallAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        UNMARSHALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all UnmarshallAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        UNMARSHALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds UnmarshallAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: UnmarshallAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the unmarshall_type reference
    #[wasm_bindgen]
    pub fn set_unmarshall_type(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: UnmarshallAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.unmarshall_type = ref_id;
...
impl UnmarshallAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate unmarshall_type reference exists
        if !Classifier::exists(self.unmarshall_type.clone()) {
            errors.push(format!("Classifier {} not found", self.unmarshall_type));
        }
