...
pub struct UnmarshallAction {
    ...
    unmarshall_type: String,
    object: InputPin,
}

#[wasm_bindgen]
impl UnmarshallAction {
    pub fn new(is_leaf: bool, result: Vec<OutputPin>, unmarshall_type: String, object: InputPin) -> Self {
        Self {
    ...
    /// Returns a clone of unmarshall_type
    pub fn unmarshall_type(&self) -> String {
        self.unmarshall_type.clone()
    }

    /// Sets unmarshall_type
    pub fn set_unmarshall_type(&mut self, value: String) {
        self.unmarshall_type = value;
    }

    /// Takes ownership of unmarshall_type, replacing it with an empty string
    pub fn take_unmarshall_type(&mut self) -> String {
        std::mem::take(&mut self.unmarshall_type)
    }
