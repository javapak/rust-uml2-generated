...
pub struct UnmarshallAction {
    ...
    unmarshall_type: Rc<RefCell<Classifier>>,
    object: InputPin,
}

impl UnmarshallAction {
    pub fn new(is_leaf: bool, result: Vec<OutputPin>, unmarshall_type: Rc<RefCell<Classifier>>, object: InputPin) -> Self {
        Self {
    ...
    /// Returns a reference to unmarshall_type
    pub fn unmarshall_type(&self) -> &Rc<RefCell<Classifier>> {
        &self.unmarshall_type
    }

    /// Returns a mutable reference to unmarshall_type
    pub fn unmarshall_type_mut(&mut self) -> &mut Rc<RefCell<Classifier>> {
        &mut self.unmarshall_type
    }

    /// Sets unmarshall_type
    pub fn set_unmarshall_type(&mut self, value: Rc<RefCell<Classifier>>) {
        self.unmarshall_type = value;
    }
...
impl Default for UnmarshallAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
            ...
            local_postcondition: Vec::new(),
            result: Vec::new(),
            unmarshall_type: Default::default(),
            object: Default::default(),
        }
    }
}

impl std::fmt::Display for UnmarshallAction {
