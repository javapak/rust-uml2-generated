...
// ============================================================================
//
// Type:           StructuredActivityNode (struct)
// Source Package: uml
...
lazy_static! {
    static ref STRUCTURED_ACTIVITY_NODE_REGISTRY: Mutex<RefCell<HashMap<String, StructuredActivityNode>>> = 
...
impl StructuredActivityNode {
    /// Creates a new StructuredActivityNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, must_isolate: String) -> String {
        ...
        STRUCTURED_ACTIVITY_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a StructuredActivityNode by ID
    ...
    /// Updates a StructuredActivityNode instance
    ...
    /// Deletes a StructuredActivityNode by ID
    ...
    /// Checks if a StructuredActivityNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StructuredActivityNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StructuredActivityNode> = STRUCTURED_ACTIVITY_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StructuredActivityNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STRUCTURED_ACTIVITY_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StructuredActivityNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STRUCTURED_ACTIVITY_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StructuredActivityNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StructuredActivityNode = serde_wasm_bindgen::from_value(instance_js)
