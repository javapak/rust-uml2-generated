// BroadcastSignalAction - Generated UML Class
...
const TYPE_NAME: &str = "BroadcastSignalAction";
...
impl BroadcastSignalAction {
    /// Creates a new BroadcastSignalAction instance
    #[wasm_bindgen]
