...
// ============================================================================
//
// Type:           BroadcastSignalAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref BROADCAST_SIGNAL_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, BroadcastSignalAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct BroadcastSignalAction {
...
#[wasm_bindgen]
impl BroadcastSignalAction {
    /// Creates a new BroadcastSignalAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, signal: String) -> String {
        ...
        BROADCAST_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a BroadcastSignalAction by ID
    ...
    /// Updates a BroadcastSignalAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: BroadcastSignalAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a BroadcastSignalAction by ID
    ...
    /// Checks if a BroadcastSignalAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all BroadcastSignalAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<BroadcastSignalAction> = BROADCAST_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of BroadcastSignalAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        BROADCAST_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all BroadcastSignalAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        BROADCAST_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds BroadcastSignalAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: BroadcastSignalAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_signal(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: BroadcastSignalAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.signal = ref_id;
...
impl BroadcastSignalAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate signal reference exists
        if !Signal::exists(self.signal.clone()) {
            errors.push(format!("Signal {} not found", self.signal));
        }
