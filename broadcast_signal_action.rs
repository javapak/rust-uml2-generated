...
impl BroadcastSignalAction {
    pub fn new(is_leaf: bool, signal: String) -> Self {
        Self {
    ...
    /// Takes ownership of signal, replacing it with an empty string
    pub fn take_signal(&mut self) -> String {
    ...
    pub fn type_name() -> String {
        "BroadcastSignalAction".to_string()
    }

}

impl Default for BroadcastSignalAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for BroadcastSignalAction {
