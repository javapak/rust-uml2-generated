...
lazy_static! {
    static ref DEPLOYED_ARTIFACT_REGISTRY: Mutex<RefCell<HashMap<String, DeployedArtifact>>> = 
...
impl DeployedArtifact {
    /// Creates a new DeployedArtifact and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DEPLOYED_ARTIFACT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DeployedArtifact instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DeployedArtifact = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DeployedArtifact by ID
    ...
    /// Checks if a DeployedArtifact exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DeployedArtifact instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DeployedArtifact> = DEPLOYED_ARTIFACT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DeployedArtifact instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DEPLOYED_ARTIFACT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DeployedArtifact instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DEPLOYED_ARTIFACT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DeployedArtifact instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DeployedArtifact = serde_wasm_bindgen::from_value(instance_js)
