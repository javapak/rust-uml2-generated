...
pub struct InteractionConstraint {
    ...
    minint: Option<ValueSpecification>,
    maxint: Option<ValueSpecification>,
}
...
impl InteractionConstraint {
    ...
    /// Returns a reference to minint if present
    pub fn minint(&self) -> Option<&ValueSpecification> {
        self.minint.as_ref()
    }

    /// Returns a mutable reference to minint if present
    pub fn minint_mut(&mut self) -> Option<&mut ValueSpecification> {
        self.minint.as_mut()
    }

    /// Sets minint
    pub fn set_minint(&mut self, value: ValueSpecification) {
        self.minint = Some(value);
    }

    /// Takes minint, leaving None in its place
    pub fn take_minint(&mut self) -> Option<ValueSpecification> {
        self.minint.take()
    }

    /// Returns a reference to maxint if present
    pub fn maxint(&self) -> Option<&ValueSpecification> {
        self.maxint.as_ref()
    }

    /// Returns a mutable reference to maxint if present
    pub fn maxint_mut(&mut self) -> Option<&mut ValueSpecification> {
        self.maxint.as_mut()
    }

    /// Sets maxint
    pub fn set_maxint(&mut self, value: ValueSpecification) {
        self.maxint = Some(value);
    }

    /// Takes maxint, leaving None in its place
    pub fn take_maxint(&mut self) -> Option<ValueSpecification> {
        self.maxint.take()
    }
...
impl std::fmt::Display for InteractionConstraint {
