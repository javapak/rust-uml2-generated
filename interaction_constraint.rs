...
lazy_static! {
    static ref INTERACTION_CONSTRAINT_REGISTRY: Mutex<RefCell<HashMap<String, InteractionConstraint>>> = 
...
pub struct InteractionConstraint {
    ...
    pub constrained_element: Vec<String>,
    pub specification: String,
    pub context: Option<String>,
    pub minint: Option<String>,
    pub maxint: Option<String>,
}

#[wasm_bindgen]
impl InteractionConstraint {
    /// Creates a new InteractionConstraint and returns its ID
    #[wasm_bindgen]
    pub fn create(specification: String) -> String {
        ...
        INTERACTION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a InteractionConstraint by ID
    ...
    /// Updates a InteractionConstraint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: InteractionConstraint = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a InteractionConstraint by ID
    ...
    /// Checks if a InteractionConstraint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InteractionConstraint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InteractionConstraint> = INTERACTION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InteractionConstraint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INTERACTION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InteractionConstraint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INTERACTION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InteractionConstraint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a Element to constrained_element
    #[wasm_bindgen]
    pub fn add_constrained_element(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.constrained_element.contains(&ref_id) {
            return Ok(false);
        }

        instance.constrained_element.push(ref_id.clone());
    ...
    /// Removes a Element from constrained_element
    #[wasm_bindgen]
    pub fn remove_constrained_element(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.constrained_element.iter().position(|x| x == &ref_id) {
            instance.constrained_element.remove(pos);
    ...
    /// Clears all Element from constrained_element
    #[wasm_bindgen]
    pub fn clear_constrained_element(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.constrained_element.len();

        instance.constrained_element.clear();
    ...
    #[wasm_bindgen]
    pub fn set_specification(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
    ...
    #[wasm_bindgen]
    pub fn set_context(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        // Remove from old opposite
        if let Some(old_ref_id) = &instance.context {
            if let Ok(target_js) = Namespace::get(old_ref_id.clone()) {
                if let Ok(mut target) = serde_wasm_bindgen::from_value::<Namespace>(target_js) {
                    target.owned_rule.retain(|x| x != &instance_id);
                    if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
        ...
        // Add to new opposite
        if let Some(new_ref_id) = &ref_id {
        if let Ok(target_js) = Namespace::get(new_ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<Namespace>(target_js) {
                if !target.owned_rule.contains(&instance_id) {
                    target.owned_rule.push(instance_id.clone());
                }
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = Namespace::update(target_js);
                }
    ...
    /// Sets the minint reference
    #[wasm_bindgen]
    pub fn set_minint(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.minint = ref_id;
    ...
    /// Sets the maxint reference
    #[wasm_bindgen]
    pub fn set_maxint(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InteractionConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.maxint = ref_id;
...
impl InteractionConstraint {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all constrained_element references exist
        for id in &self.constrained_element {
        ...
        if !ValueSpecification::exists(self.specification.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.specification));
        }

        // Validate context reference exists
        if let Some(id) = &self.context {
            if !Namespace::exists(id.clone()) {
                errors.push(format!("Namespace {} not found", id));
            }
        }

        // Validate minint reference exists
        if let Some(id) = &self.minint {
            if !ValueSpecification::exists(id.clone()) {
                errors.push(format!("ValueSpecification {} not found", id));
            }
        }

        // Validate maxint reference exists
        if let Some(id) = &self.maxint {
            if !ValueSpecification::exists(id.clone()) {
                errors.push(format!("ValueSpecification {} not found", id));
            }
        }
