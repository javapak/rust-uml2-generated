...
// ============================================================================
//
// Type:           EncapsulatedClassifier (struct)
// Source Package: uml
...
lazy_static! {
    static ref ENCAPSULATED_CLASSIFIER_REGISTRY: Mutex<RefCell<HashMap<String, EncapsulatedClassifier>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct EncapsulatedClassifier {
...
#[wasm_bindgen]
impl EncapsulatedClassifier {
    /// Creates a new EncapsulatedClassifier and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        ENCAPSULATED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a EncapsulatedClassifier by ID
    ...
    /// Updates a EncapsulatedClassifier instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: EncapsulatedClassifier = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a EncapsulatedClassifier by ID
    ...
    /// Checks if a EncapsulatedClassifier exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all EncapsulatedClassifier instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<EncapsulatedClassifier> = ENCAPSULATED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of EncapsulatedClassifier instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ENCAPSULATED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all EncapsulatedClassifier instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ENCAPSULATED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds EncapsulatedClassifier instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: EncapsulatedClassifier = serde_wasm_bindgen::from_value(instance_js)
