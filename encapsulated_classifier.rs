// EncapsulatedClassifier - Generated UML Class
...
const TYPE_NAME: &str = "EncapsulatedClassifier";
...
impl EncapsulatedClassifier {
    /// Creates a new EncapsulatedClassifier instance
    #[wasm_bindgen]
...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "EncapsulatedClassifier".to_string()
    }
