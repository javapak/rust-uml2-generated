...
lazy_static! {
    static ref PROPERTY_REGISTRY: Mutex<RefCell<HashMap<String, Property>>> = 
...
#[wasm_bindgen]
impl Property {
    /// Creates a new Property and returns its ID
    #[wasm_bindgen]
    ...
    /// Gets all Property instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Property> = PROPERTY_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Property instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PROPERTY_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Property instances
    #[wasm_bindgen]
    pub fn clear_all() {
        PROPERTY_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Property instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Property = serde_wasm_bindgen::from_value(instance_js)
