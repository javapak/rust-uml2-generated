...
// ============================================================================
//
// Type:           ClearStructuralFeatureAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref CLEAR_STRUCTURAL_FEATURE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ClearStructuralFeatureAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ClearStructuralFeatureAction {
...
#[wasm_bindgen]
impl ClearStructuralFeatureAction {
    /// Creates a new ClearStructuralFeatureAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String) -> String {
        ...
        CLEAR_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ClearStructuralFeatureAction by ID
    ...
    /// Updates a ClearStructuralFeatureAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ClearStructuralFeatureAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ClearStructuralFeatureAction by ID
    ...
    /// Checks if a ClearStructuralFeatureAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ClearStructuralFeatureAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ClearStructuralFeatureAction> = CLEAR_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ClearStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLEAR_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ClearStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CLEAR_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ClearStructuralFeatureAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ClearStructuralFeatureAction = serde_wasm_bindgen::from_value(instance_js)
