...
lazy_static! {
    static ref EXECUTABLE_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ExecutableNode>>> = 
...
#[wasm_bindgen]
impl ExecutableNode {
    /// Creates a new ExecutableNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        EXECUTABLE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ExecutableNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ExecutableNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ExecutableNode by ID
    ...
    /// Checks if a ExecutableNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ExecutableNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ExecutableNode> = EXECUTABLE_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ExecutableNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXECUTABLE_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ExecutableNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXECUTABLE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ExecutableNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ExecutableNode = serde_wasm_bindgen::from_value(instance_js)
