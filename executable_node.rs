// ExecutableNode - Generated UML Class
...
const TYPE_NAME: &str = "ExecutableNode";
...
#[wasm_bindgen]
impl ExecutableNode {
    /// Creates a new ExecutableNode instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn add_handler(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<ExceptionHandler>(&ref_id) {
            target.protected_node = instance_id.clone();
            let _ = registry::insert(ref_id.clone(), "ExceptionHandler", &target);
        }
    ...
    pub fn remove_handler(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.handler.len();
        instance.handler.retain(|id| id != &ref_id);
        let removed = instance.handler.len() < initial_len;
        ...
        // Update opposite reference
        if let Some(target) = registry::get::<ExceptionHandler>(&ref_id) {
            let _ = registry::insert(ref_id.clone(), "ExceptionHandler", &target);
        }
