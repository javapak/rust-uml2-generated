...
lazy_static! {
    static ref VERTEX_REGISTRY: Mutex<RefCell<HashMap<String, Vertex>>> = 
...
impl Vertex {
    ...
    /// Gets all Vertex instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Vertex> = VERTEX_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Vertex instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        VERTEX_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Vertex instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Vertex = serde_wasm_bindgen::from_value(instance_js)
