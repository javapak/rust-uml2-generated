...
// ============================================================================
//
// Type:           CallBehaviorAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref CALL_BEHAVIOR_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CallBehaviorAction>>> = 
...
impl CallBehaviorAction {
    /// Creates a new CallBehaviorAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_synchronous: String, behavior: String) -> String {
        ...
        CALL_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CallBehaviorAction by ID
    ...
    /// Updates a CallBehaviorAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CallBehaviorAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CallBehaviorAction by ID
    ...
    /// Checks if a CallBehaviorAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CallBehaviorAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CallBehaviorAction> = CALL_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CallBehaviorAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CALL_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CallBehaviorAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CALL_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CallBehaviorAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CallBehaviorAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_behavior(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CallBehaviorAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl CallBehaviorAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !Behavior::exists(self.behavior.clone()) {
            errors.push(format!("Behavior {} not found", self.behavior));
        }
