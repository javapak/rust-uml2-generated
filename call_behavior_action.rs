...
impl CallBehaviorAction {
    pub fn new(is_leaf: bool, is_synchronous: bool, behavior: String) -> Self {
        Self {
    ...
    /// Takes ownership of behavior, replacing it with an empty string
    pub fn take_behavior(&mut self) -> String {
        std::mem::take(&mut self.behavior)
    }
