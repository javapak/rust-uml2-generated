// InteractionUse - Generated UML Class
...
const TYPE_NAME: &str = "InteractionUse";
...
#[wasm_bindgen]
impl InteractionUse {
    /// Creates a new InteractionUse instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn set_refers_to(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.refers_to = ref_id.clone();
    ...
    pub fn remove_actual_gate(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.actual_gate.len();
        instance.actual_gate.retain(|id| id != &ref_id);
        let removed = instance.actual_gate.len() < initial_len;
