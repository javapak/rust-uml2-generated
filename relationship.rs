...
lazy_static! {
    static ref RELATIONSHIP_REGISTRY: Mutex<RefCell<HashMap<String, Relationship>>> = 
...
#[wasm_bindgen]
impl Relationship {
    /// Creates a new Relationship and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Relationship instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Relationship = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Relationship exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Relationship instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Relationship> = RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Relationship instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Relationship instances
    #[wasm_bindgen]
    pub fn clear_all() {
        RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Relationship = serde_wasm_bindgen::from_value(instance_js)
