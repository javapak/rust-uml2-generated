...
pub struct Interface {
    ...
    redefined_interface: Vec<String>,
...
impl Interface {
    ...
    /// Returns a clone of redefined_interface
    pub fn redefined_interface(&self) -> Vec<String> {
        self.redefined_interface.clone()
    }

    /// Adds an existing Interface to redefined_interface by ID
    pub fn add_redefined_interface_by_id(&mut self, id: String) {
        self.redefined_interface.push(id);
    }
