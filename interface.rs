...
pub struct Interface {
    ...
    redefined_interface: Vec<Rc<RefCell<Interface>>>,
    owned_reception: Vec<Reception>,
    protocol: Option<ProtocolStateMachine>,
}
...
impl Interface {
    ...
    /// Returns a reference to redefined_interface
    pub fn redefined_interface(&self) -> &Vec<Rc<RefCell<Interface>>> {
        &self.redefined_interface
    }

    /// Returns a mutable reference to redefined_interface
    pub fn redefined_interface_mut(&mut self) -> &mut Vec<Rc<RefCell<Interface>>> {
        &mut self.redefined_interface
    }

    /// Adds an item to redefined_interface
    pub fn add_redefined_interface(&mut self, item: Rc<RefCell<Interface>>) {
        self.redefined_interface.push(item);
    }

    /// Clears all items from redefined_interface
    pub fn clear_redefined_interface(&mut self) {
        self.redefined_interface.clear();
    }
    ...
    pub fn protocol(&self) -> Option<&ProtocolStateMachine> {
        self.protocol.as_ref()
    }

    /// Returns a mutable reference to protocol if present
    pub fn protocol_mut(&mut self) -> Option<&mut ProtocolStateMachine> {
        self.protocol.as_mut()
    }

    /// Sets protocol
    pub fn set_protocol(&mut self, value: ProtocolStateMachine) {
        self.protocol = Some(value);
    }

    /// Takes protocol, leaving None in its place
    pub fn take_protocol(&mut self) -> Option<ProtocolStateMachine> {
        self.protocol.take()
    }
