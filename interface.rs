...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_owned_attribute(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.owned_attribute.len();
        instance.owned_attribute.retain(|id| id != &ref_id);
        let removed = instance.owned_attribute.len() < initial_len;
    ...
    pub fn add_owned_operation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<Operation>(&ref_id) {
            target.interface = Some(instance_id.clone());
    ...
    pub fn remove_redefined_interface(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.redefined_interface.len();
        instance.redefined_interface.retain(|id| id != &ref_id);
        let removed = instance.redefined_interface.len() < initial_len;
