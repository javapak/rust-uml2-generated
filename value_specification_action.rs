...
impl ValueSpecificationAction {
    pub fn new(is_leaf: bool, value: ValueSpecification, result: OutputPin) -> Self {
        Self {
    ...
    pub fn value_mut(&mut self) -> &mut ValueSpecification {
        &mut self.value
    }

    /// Sets value
    pub fn set_value(&mut self, value: ValueSpecification) {
        self.value = value;
    }
...
impl Default for ValueSpecificationAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ValueSpecificationAction {
