...
// ============================================================================
//
// Type:           ValueSpecificationAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref VALUE_SPECIFICATION_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ValueSpecificationAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ValueSpecificationAction {
...
#[wasm_bindgen]
impl ValueSpecificationAction {
    /// Creates a new ValueSpecificationAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, value: String, result: String) -> String {
        ...
        VALUE_SPECIFICATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ValueSpecificationAction by ID
    ...
    /// Updates a ValueSpecificationAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ValueSpecificationAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ValueSpecificationAction by ID
    ...
    /// Checks if a ValueSpecificationAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ValueSpecificationAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ValueSpecificationAction> = VALUE_SPECIFICATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ValueSpecificationAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        VALUE_SPECIFICATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ValueSpecificationAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        VALUE_SPECIFICATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ValueSpecificationAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ValueSpecificationAction = serde_wasm_bindgen::from_value(instance_js)
