// ValueSpecificationAction - Generated UML Class
...
const TYPE_NAME: &str = "ValueSpecificationAction";
...
impl ValueSpecificationAction {
    /// Creates a new ValueSpecificationAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "ValueSpecificationAction".to_string()
    }
