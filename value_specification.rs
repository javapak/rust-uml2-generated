...
lazy_static! {
    static ref VALUE_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, ValueSpecification>>> = 
...
impl ValueSpecification {
    /// Creates a new ValueSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        VALUE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ValueSpecification by ID
    ...
    /// Updates a ValueSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ValueSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ValueSpecification by ID
    ...
    /// Checks if a ValueSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ValueSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ValueSpecification> = VALUE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ValueSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        VALUE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ValueSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        VALUE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ValueSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ValueSpecification = serde_wasm_bindgen::from_value(instance_js)
