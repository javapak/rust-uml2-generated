...
lazy_static! {
    static ref CLEAR_VARIABLE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ClearVariableAction>>> = 
...
impl ClearVariableAction {
    /// Creates a new ClearVariableAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String) -> String {
        ...
        CLEAR_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ClearVariableAction by ID
    ...
    /// Updates a ClearVariableAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ClearVariableAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ClearVariableAction by ID
    ...
    /// Checks if a ClearVariableAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ClearVariableAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ClearVariableAction> = CLEAR_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ClearVariableAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLEAR_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ClearVariableAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CLEAR_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ClearVariableAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ClearVariableAction = serde_wasm_bindgen::from_value(instance_js)
