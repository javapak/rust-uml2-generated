...
lazy_static! {
    static ref ACTIVITY_FINAL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ActivityFinalNode>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ActivityFinalNode {
...
#[wasm_bindgen]
impl ActivityFinalNode {
    /// Creates a new ActivityFinalNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        ACTIVITY_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ActivityFinalNode by ID
    ...
    /// Updates a ActivityFinalNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ActivityFinalNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ActivityFinalNode by ID
    ...
    /// Checks if a ActivityFinalNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ActivityFinalNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ActivityFinalNode> = ACTIVITY_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ActivityFinalNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTIVITY_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ActivityFinalNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACTIVITY_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ActivityFinalNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ActivityFinalNode = serde_wasm_bindgen::from_value(instance_js)
