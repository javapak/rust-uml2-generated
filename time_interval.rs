...
lazy_static! {
    static ref TIME_INTERVAL_REGISTRY: Mutex<RefCell<HashMap<String, TimeInterval>>> = 
...
#[wasm_bindgen]
impl TimeInterval {
    /// Creates a new TimeInterval and returns its ID
    #[wasm_bindgen]
    pub fn create(min: String, max: String) -> String {
        ...
        TIME_INTERVAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a TimeInterval instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TimeInterval = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a TimeInterval exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TimeInterval instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TimeInterval> = TIME_INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TimeInterval instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TIME_INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TimeInterval instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TIME_INTERVAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TimeInterval instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TimeInterval = serde_wasm_bindgen::from_value(instance_js)
