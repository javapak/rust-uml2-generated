...
lazy_static! {
    static ref TYPE_REGISTRY: Mutex<RefCell<HashMap<String, Type>>> = 
...
impl Type {
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Type = serde_wasm_bindgen::from_value(value)
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Type> = TYPE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Type instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TYPE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Type instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Type = serde_wasm_bindgen::from_value(instance_js)
