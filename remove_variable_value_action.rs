...
impl RemoveVariableValueAction {
    pub fn new(is_leaf: bool, variable: Rc<RefCell<Variable>>, value: InputPin, is_remove_duplicates: bool) -> Self {
        Self {
...
impl Default for RemoveVariableValueAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for RemoveVariableValueAction {
