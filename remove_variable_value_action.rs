// RemoveVariableValueAction - Generated UML Class
...
const TYPE_NAME: &str = "RemoveVariableValueAction";
...
impl RemoveVariableValueAction {
    /// Creates a new RemoveVariableValueAction instance
    #[wasm_bindgen]
...
pub fn set_is_remove_duplicates(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "RemoveVariableValueAction".to_string()
    }
