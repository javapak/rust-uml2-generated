...
// ============================================================================
//
// Type:           RemoveVariableValueAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref REMOVE_VARIABLE_VALUE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, RemoveVariableValueAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct RemoveVariableValueAction {
...
#[wasm_bindgen]
impl RemoveVariableValueAction {
    /// Creates a new RemoveVariableValueAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String, value: String, is_remove_duplicates: String) -> String {
        ...
        REMOVE_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a RemoveVariableValueAction by ID
    ...
    /// Updates a RemoveVariableValueAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: RemoveVariableValueAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a RemoveVariableValueAction by ID
    ...
    /// Checks if a RemoveVariableValueAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all RemoveVariableValueAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<RemoveVariableValueAction> = REMOVE_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of RemoveVariableValueAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REMOVE_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all RemoveVariableValueAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REMOVE_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds RemoveVariableValueAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: RemoveVariableValueAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_variable(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: RemoveVariableValueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.variable = ref_id;
...
impl RemoveVariableValueAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate variable reference exists
        if !Variable::exists(self.variable.clone()) {
            errors.push(format!("Variable {} not found", self.variable));
        }
