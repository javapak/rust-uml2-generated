...
impl RemoveVariableValueAction {
    pub fn new(is_leaf: bool, variable: String, value: InputPin, is_remove_duplicates: bool) -> Self {
        Self {
    ...
    /// Sets variable
    pub fn set_variable(&mut self, value: String) {
        self.variable = value;
    }

    /// Takes ownership of variable, replacing it with an empty string
    pub fn take_variable(&mut self) -> String {
        std::mem::take(&mut self.variable)
    }
