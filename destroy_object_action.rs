...
pub struct DestroyObjectAction {
    ...
    is_destroy_links: bool,
    is_destroy_owned_objects: bool,
    target: InputPin,
}

impl DestroyObjectAction {
    pub fn new(is_leaf: bool, is_destroy_links: bool, is_destroy_owned_objects: bool, target: InputPin) -> Self {
        Self {
    ...
    /// Returns is_destroy_links
    pub fn is_destroy_links(&self) -> bool {
        self.is_destroy_links
    }

    /// Sets is_destroy_links
    pub fn set_is_destroy_links(&mut self, value: bool) {
        self.is_destroy_links = value;
    }

    /// Returns is_destroy_owned_objects
    pub fn is_destroy_owned_objects(&self) -> bool {
        self.is_destroy_owned_objects
    }

    /// Sets is_destroy_owned_objects
    pub fn set_is_destroy_owned_objects(&mut self, value: bool) {
        self.is_destroy_owned_objects = value;
    }

    /// Returns a reference to target
    pub fn target(&self) -> &InputPin {
        &self.target
    }

    /// Returns a mutable reference to target
    pub fn target_mut(&mut self) -> &mut InputPin {
        &mut self.target
    }

    /// Sets target
    pub fn set_target(&mut self, value: InputPin) {
        self.target = value;
    }

}

impl Default for DestroyObjectAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
            ...
            local_precondition: Vec::new(),
            local_postcondition: Vec::new(),
            is_destroy_links: false,
            is_destroy_owned_objects: false,
            target: Default::default(),
        }
    }
}

impl std::fmt::Display for DestroyObjectAction {
