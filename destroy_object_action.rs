...
// ============================================================================
//
// Type:           DestroyObjectAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref DESTROY_OBJECT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, DestroyObjectAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct DestroyObjectAction {
    ...
    pub is_destroy_links: String,
    pub is_destroy_owned_objects: String,
    pub target: String,
}

#[wasm_bindgen]
impl DestroyObjectAction {
    /// Creates a new DestroyObjectAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_destroy_links: String, is_destroy_owned_objects: String, target: String) -> String {
        ...
        let instance = Self {
            ...
            is_destroy_links: is_destroy_links,
            is_destroy_owned_objects: is_destroy_owned_objects,
            target: target,
        };

        DESTROY_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a DestroyObjectAction by ID
    ...
    /// Updates a DestroyObjectAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DestroyObjectAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DestroyObjectAction by ID
    ...
    /// Checks if a DestroyObjectAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DestroyObjectAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DestroyObjectAction> = DESTROY_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DestroyObjectAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DESTROY_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DestroyObjectAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DESTROY_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DestroyObjectAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DestroyObjectAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the is_destroy_links field
    #[wasm_bindgen]
    pub fn set_is_destroy_links(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DestroyObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_destroy_links = value;
    ...
    /// Sets the is_destroy_owned_objects field
    #[wasm_bindgen]
    pub fn set_is_destroy_owned_objects(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DestroyObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_destroy_owned_objects = value;
