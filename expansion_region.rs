...
pub struct ExpansionRegion {
    ...
    mode: String,
    input_element: Vec<Rc<RefCell<ExpansionNode>>>,
    output_element: Vec<Rc<RefCell<ExpansionNode>>>,
}

impl ExpansionRegion {
    pub fn new(is_leaf: bool, must_isolate: bool, mode: String, input_element: Vec<Rc<RefCell<ExpansionNode>>>) -> Self {
        Self {
    ...
    /// Returns mode as a string slice
    pub fn mode(&self) -> &str {
        &self.mode
    }

    /// Sets mode
    pub fn set_mode(&mut self, value: impl Into<String>) {
    ...
    /// Returns a reference to input_element
    pub fn input_element(&self) -> &Vec<Rc<RefCell<ExpansionNode>>> {
        &self.input_element
    }

    /// Returns a mutable reference to input_element
    pub fn input_element_mut(&mut self) -> &mut Vec<Rc<RefCell<ExpansionNode>>> {
        &mut self.input_element
    }

    /// Adds an item to input_element
    pub fn add_input_element(&mut self, item: Rc<RefCell<ExpansionNode>>) {
        self.input_element.push(item);
    }
    ...
    /// Returns a reference to output_element
    pub fn output_element(&self) -> &Vec<Rc<RefCell<ExpansionNode>>> {
        &self.output_element
    }

    /// Returns a mutable reference to output_element
    pub fn output_element_mut(&mut self) -> &mut Vec<Rc<RefCell<ExpansionNode>>> {
        &mut self.output_element
    }

    /// Adds an item to output_element
    pub fn add_output_element(&mut self, item: Rc<RefCell<ExpansionNode>>) {
        self.output_element.push(item);
    }
