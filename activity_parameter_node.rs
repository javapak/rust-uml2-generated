...
lazy_static! {
    static ref ACTIVITY_PARAMETER_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ActivityParameterNode>>> = 
...
impl ActivityParameterNode {
    /// Creates a new ActivityParameterNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String, parameter: String) -> String {
        ...
        ACTIVITY_PARAMETER_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ActivityParameterNode by ID
    ...
    /// Updates a ActivityParameterNode instance
    ...
    /// Deletes a ActivityParameterNode by ID
    ...
    /// Checks if a ActivityParameterNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ActivityParameterNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ActivityParameterNode> = ACTIVITY_PARAMETER_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ActivityParameterNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTIVITY_PARAMETER_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ActivityParameterNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACTIVITY_PARAMETER_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ActivityParameterNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ActivityParameterNode = serde_wasm_bindgen::from_value(instance_js)
...
impl ActivityParameterNode {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !Parameter::exists(self.parameter.clone()) {
            errors.push(format!("Parameter {} not found", self.parameter));
        }
