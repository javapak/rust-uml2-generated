...
lazy_static! {
    static ref CONSTRAINT_REGISTRY: Mutex<RefCell<HashMap<String, Constraint>>> = 
...
impl Constraint {
    ...
    pub fn create(specification: String) -> String {
        ...
        CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Constraint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Constraint = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Constraint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Constraint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Constraint> = CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Constraint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Constraint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Constraint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Constraint = serde_wasm_bindgen::from_value(instance_js)
