...
impl ReadLinkObjectEndQualifierAction {
    pub fn new(is_leaf: bool, object: InputPin, result: OutputPin, qualifier: Rc<RefCell<Property>>) -> Self {
        Self {
...
impl Default for ReadLinkObjectEndQualifierAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadLinkObjectEndQualifierAction {
