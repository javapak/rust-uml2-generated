// ReadLinkObjectEndQualifierAction - Generated UML Class
...
const TYPE_NAME: &str = "ReadLinkObjectEndQualifierAction";
...
impl ReadLinkObjectEndQualifierAction {
    /// Creates a new ReadLinkObjectEndQualifierAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "ReadLinkObjectEndQualifierAction".to_string()
    }
