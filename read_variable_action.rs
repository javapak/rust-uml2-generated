...
// ============================================================================
//
// Type:           ReadVariableAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref READ_VARIABLE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadVariableAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadVariableAction {
...
#[wasm_bindgen]
impl ReadVariableAction {
    /// Creates a new ReadVariableAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String, result: String) -> String {
        ...
        READ_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReadVariableAction by ID
    ...
    /// Updates a ReadVariableAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadVariableAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadVariableAction by ID
    ...
    /// Checks if a ReadVariableAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadVariableAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadVariableAction> = READ_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadVariableAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadVariableAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadVariableAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadVariableAction = serde_wasm_bindgen::from_value(instance_js)
