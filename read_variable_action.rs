...
impl ReadVariableAction {
    pub fn new(is_leaf: bool, variable: String, result: OutputPin) -> Self {
        Self {
    ...
    pub fn type_name() -> String {
        "ReadVariableAction".to_string()
    }

}

impl Default for ReadVariableAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadVariableAction {
