...
lazy_static! {
    static ref CREATION_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, CreationEvent>>> = 
...
#[wasm_bindgen]
impl CreationEvent {
    /// Creates a new CreationEvent and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        CREATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CreationEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CreationEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a CreationEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CreationEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CreationEvent> = CREATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CreationEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CREATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CreationEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CREATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CreationEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CreationEvent = serde_wasm_bindgen::from_value(instance_js)
