...
lazy_static! {
    static ref FUNCTION_BEHAVIOR_REGISTRY: Mutex<RefCell<HashMap<String, FunctionBehavior>>> = 
...
impl FunctionBehavior {
    /// Creates a new FunctionBehavior and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_active: String, is_reentrant: String) -> String {
        ...
        FUNCTION_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a FunctionBehavior instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: FunctionBehavior = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a FunctionBehavior by ID
    ...
    /// Checks if a FunctionBehavior exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all FunctionBehavior instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<FunctionBehavior> = FUNCTION_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of FunctionBehavior instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        FUNCTION_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all FunctionBehavior instances
    #[wasm_bindgen]
    pub fn clear_all() {
        FUNCTION_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds FunctionBehavior instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: FunctionBehavior = serde_wasm_bindgen::from_value(instance_js)
