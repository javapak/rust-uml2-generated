...
lazy_static! {
    static ref CLEAR_ASSOCIATION_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ClearAssociationAction>>> = 
...
impl ClearAssociationAction {
    /// Creates a new ClearAssociationAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, object: String, association: String) -> String {
        ...
        CLEAR_ASSOCIATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ClearAssociationAction by ID
    ...
    /// Updates a ClearAssociationAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ClearAssociationAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ClearAssociationAction by ID
    ...
    /// Checks if a ClearAssociationAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ClearAssociationAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ClearAssociationAction> = CLEAR_ASSOCIATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ClearAssociationAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLEAR_ASSOCIATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ClearAssociationAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CLEAR_ASSOCIATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ClearAssociationAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ClearAssociationAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_association(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ClearAssociationAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl ClearAssociationAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !Association::exists(self.association.clone()) {
            errors.push(format!("Association {} not found", self.association));
        }
