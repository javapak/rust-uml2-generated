...
pub struct ClearAssociationAction {
    ...
    object: InputPin,
    association: Rc<RefCell<Association>>,
}

impl ClearAssociationAction {
    pub fn new(is_leaf: bool, object: InputPin, association: Rc<RefCell<Association>>) -> Self {
        Self {
    ...
    /// Returns a reference to association
    pub fn association(&self) -> &Rc<RefCell<Association>> {
        &self.association
    }

    /// Returns a mutable reference to association
    pub fn association_mut(&mut self) -> &mut Rc<RefCell<Association>> {
