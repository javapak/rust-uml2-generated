...
lazy_static! {
    static ref READ_LINK_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadLinkAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadLinkAction {
...
#[wasm_bindgen]
impl ReadLinkAction {
    /// Creates a new ReadLinkAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, result: String) -> String {
        ...
        READ_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ReadLinkAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadLinkAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadLinkAction by ID
    ...
    /// Checks if a ReadLinkAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadLinkAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadLinkAction> = READ_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadLinkAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadLinkAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadLinkAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadLinkAction = serde_wasm_bindgen::from_value(instance_js)
