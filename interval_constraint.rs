...
lazy_static! {
    static ref INTERVAL_CONSTRAINT_REGISTRY: Mutex<RefCell<HashMap<String, IntervalConstraint>>> = 
...
impl IntervalConstraint {
    /// Creates a new IntervalConstraint and returns its ID
    #[wasm_bindgen]
    pub fn create(specification: String) -> String {
        ...
        INTERVAL_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a IntervalConstraint by ID
    ...
    /// Updates a IntervalConstraint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: IntervalConstraint = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a IntervalConstraint by ID
    ...
    /// Checks if a IntervalConstraint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all IntervalConstraint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<IntervalConstraint> = INTERVAL_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of IntervalConstraint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INTERVAL_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all IntervalConstraint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INTERVAL_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds IntervalConstraint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: IntervalConstraint = serde_wasm_bindgen::from_value(instance_js)
