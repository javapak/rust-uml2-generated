...
lazy_static! {
    static ref CALL_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, CallEvent>>> = 
...
#[wasm_bindgen]
impl CallEvent {
    /// Creates a new CallEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(operation: String) -> String {
        ...
        CALL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CallEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CallEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a CallEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CallEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CallEvent> = CALL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CallEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CALL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CallEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CALL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CallEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CallEvent = serde_wasm_bindgen::from_value(instance_js)
