...
pub struct Substitution {
    ...
    contract: String,
    substituting_classifier: String,
}

#[wasm_bindgen]
impl Substitution {
    pub fn new(supplier: Vec<String>, client: Vec<String>, contract: String, substituting_classifier: String) -> Self {
        Self {
    ...
    /// Returns a clone of substituting_classifier
    pub fn substituting_classifier(&self) -> String {
        self.substituting_classifier.clone()
    }

    /// Sets substituting_classifier
    pub fn set_substituting_classifier(&mut self, value: String) {
        self.substituting_classifier = value;
    }

    /// Takes ownership of substituting_classifier, replacing it with an empty string
    pub fn take_substituting_classifier(&mut self) -> String {
        std::mem::take(&mut self.substituting_classifier)
    }
