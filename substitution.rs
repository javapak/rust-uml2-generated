...
pub struct Substitution {
    ...
    contract: Rc<RefCell<Classifier>>,
    substituting_classifier: Weak<RefCell<Classifier>>,
}

impl Substitution {
    pub fn new(supplier: Vec<Rc<RefCell<NamedElement>>>, client: Vec<Rc<RefCell<NamedElement>>>, contract: Rc<RefCell<Classifier>>, substituting_classifier: Weak<RefCell<Classifier>>) -> Self {
        Self {
    ...
    pub fn contract(&self) -> &Rc<RefCell<Classifier>> {
        &self.contract
    }

    /// Returns a mutable reference to contract
    pub fn contract_mut(&mut self) -> &mut Rc<RefCell<Classifier>> {
        &mut self.contract
    }

    /// Sets contract
    pub fn set_contract(&mut self, value: Rc<RefCell<Classifier>>) {
        self.contract = value;
    }

    /// Returns a reference to substituting_classifier
    pub fn substituting_classifier(&self) -> &Weak<RefCell<Classifier>> {
        &self.substituting_classifier
    }

    /// Returns a mutable reference to substituting_classifier
    pub fn substituting_classifier_mut(&mut self) -> &mut Weak<RefCell<Classifier>> {
        &mut self.substituting_classifier
    }

    /// Sets substituting_classifier
    pub fn set_substituting_classifier(&mut self, value: Weak<RefCell<Classifier>>) {
        self.substituting_classifier = value;
    }
...
impl Default for Substitution {
    fn default() -> Self {
        Self {
            ...
            substituting_classifier: Default::default(),
        }
    }
}
