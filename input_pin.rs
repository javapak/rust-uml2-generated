...
lazy_static! {
    static ref INPUT_PIN_REGISTRY: Mutex<RefCell<HashMap<String, InputPin>>> = 
...
#[wasm_bindgen]
impl InputPin {
    /// Creates a new InputPin and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String, is_ordered: String, is_unique: String, is_control: String) -> String {
        ...
        INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a InputPin instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: InputPin = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a InputPin exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InputPin instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InputPin> = INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InputPin instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InputPin instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InputPin instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InputPin = serde_wasm_bindgen::from_value(instance_js)
