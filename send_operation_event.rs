...
// ============================================================================
//
// Type:           SendOperationEvent (struct)
// Source Package: uml
...
lazy_static! {
    static ref SEND_OPERATION_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, SendOperationEvent>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct SendOperationEvent {
...
#[wasm_bindgen]
impl SendOperationEvent {
    /// Creates a new SendOperationEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(operation: String) -> String {
        ...
        SEND_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a SendOperationEvent by ID
    ...
    /// Updates a SendOperationEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SendOperationEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a SendOperationEvent by ID
    ...
    /// Checks if a SendOperationEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SendOperationEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SendOperationEvent> = SEND_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SendOperationEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SEND_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SendOperationEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SEND_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SendOperationEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SendOperationEvent = serde_wasm_bindgen::from_value(instance_js)
