...
pub struct Collaboration {
    ...
    collaboration_role: Vec<Rc<RefCell<ConnectableElement>>>,
}
...
impl Collaboration {
    ...
    /// Returns a reference to collaboration_role
    pub fn collaboration_role(&self) -> &Vec<Rc<RefCell<ConnectableElement>>> {
        &self.collaboration_role
    }

    /// Returns a mutable reference to collaboration_role
    pub fn collaboration_role_mut(&mut self) -> &mut Vec<Rc<RefCell<ConnectableElement>>> {
        &mut self.collaboration_role
    }

    /// Adds an item to collaboration_role
    pub fn add_collaboration_role(&mut self, item: Rc<RefCell<ConnectableElement>>) {
        self.collaboration_role.push(item);
    }

    /// Clears all items from collaboration_role
    pub fn clear_collaboration_role(&mut self) {
        self.collaboration_role.clear();
    }
