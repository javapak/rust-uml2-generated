...
impl Collaboration {
    ...
    /// Returns a clone of collaboration_role
    pub fn collaboration_role(&self) -> Vec<String> {
        self.collaboration_role.clone()
    }

    /// Adds an existing ConnectableElement to collaboration_role by ID
    pub fn add_collaboration_role_by_id(&mut self, id: String) {
        self.collaboration_role.push(id);
    }
