...
lazy_static! {
    static ref COLLABORATION_REGISTRY: Mutex<RefCell<HashMap<String, Collaboration>>> = 
...
pub struct Collaboration {
    ...
    pub collaboration_role: Vec<String>,
}

#[wasm_bindgen]
impl Collaboration {
    /// Creates a new Collaboration and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        let instance = Self {
            ...
            collaboration_role: Vec::new(),
        };

        COLLABORATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Collaboration instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Collaboration = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Collaboration exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Collaboration instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Collaboration> = COLLABORATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Collaboration instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        COLLABORATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Collaboration instances
    #[wasm_bindgen]
    pub fn clear_all() {
        COLLABORATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Collaboration instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Collaboration = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a ConnectableElement to collaboration_role
    #[wasm_bindgen]
    pub fn add_collaboration_role(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Collaboration = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.collaboration_role.contains(&ref_id) {
            return Ok(false);
        }

        instance.collaboration_role.push(ref_id.clone());
    ...
    /// Removes a ConnectableElement from collaboration_role
    #[wasm_bindgen]
    pub fn remove_collaboration_role(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Collaboration = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.collaboration_role.iter().position(|x| x == &ref_id) {
            instance.collaboration_role.remove(pos);
    ...
    /// Clears all ConnectableElement from collaboration_role
    #[wasm_bindgen]
    pub fn clear_collaboration_role(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Collaboration = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.collaboration_role.len();

        instance.collaboration_role.clear();
...
impl Collaboration {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all collaboration_role references exist
        for id in &self.collaboration_role {
            if !ConnectableElement::exists(id.clone()) {
                errors.push(format!("ConnectableElement {} not found", id));
            }
        }
