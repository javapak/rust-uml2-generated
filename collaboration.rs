// Collaboration - Generated UML Class
...
const TYPE_NAME: &str = "Collaboration";
...
#[wasm_bindgen]
impl Collaboration {
    /// Creates a new Collaboration instance
    #[wasm_bindgen]
...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_collaboration_role(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.collaboration_role.len();
        instance.collaboration_role.retain(|id| id != &ref_id);
        let removed = instance.collaboration_role.len() < initial_len;
