...
lazy_static! {
    static ref STRING_EXPRESSION_REGISTRY: Mutex<RefCell<HashMap<String, StringExpression>>> = 
...
impl StringExpression {
    /// Creates a new StringExpression and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        STRING_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a StringExpression instance
    ...
    /// Deletes a StringExpression by ID
    ...
    /// Checks if a StringExpression exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StringExpression instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StringExpression> = STRING_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StringExpression instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STRING_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StringExpression instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STRING_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StringExpression instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StringExpression = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a ValueSpecification to operand
    #[wasm_bindgen]
    ...
    /// Removes a ValueSpecification from operand
    #[wasm_bindgen]
    ...
    /// Clears all ValueSpecification from operand
    #[wasm_bindgen]
    ...
    /// Adds a StringExpression to sub_expression
    #[wasm_bindgen]
    pub fn add_sub_expression(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Ok(target_js) = StringExpression::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<StringExpression>(target_js) {
                target.owning_expression = Some(instance_id);
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = StringExpression::update(target_js);
                }
            }
        }
    ...
    /// Removes a StringExpression from sub_expression
    #[wasm_bindgen]
    pub fn remove_sub_expression(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(pos) = instance.sub_expression.iter().position(|x| x == &ref_id) {
            instance.sub_expression.remove(pos);
    ...
    /// Clears all StringExpression from sub_expression
    #[wasm_bindgen]
    ...
    /// Sets the owning_expression reference
    #[wasm_bindgen]
    pub fn set_owning_expression(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        if let Some(old_ref_id) = &instance.owning_expression {
            if let Ok(target_js) = StringExpression::get(old_ref_id.clone()) {
                if let Ok(mut target) = serde_wasm_bindgen::from_value::<StringExpression>(target_js) {
                    target.sub_expression.retain(|x| x != &instance_id);
                    if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                        let _ = StringExpression::update(target_js);
                    }
                }
        ...
        // Add to new opposite
        if let Some(new_ref_id) = &ref_id {
        if let Ok(target_js) = StringExpression::get(new_ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<StringExpression>(target_js) {
                if !target.sub_expression.contains(&instance_id) {
                    target.sub_expression.push(instance_id.clone());
                }
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = StringExpression::update(target_js);
                }
        ...
        instance.owning_expression = ref_id;
    ...
    #[wasm_bindgen]
    pub fn set_symbol(instance_id: String, value: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: StringExpression = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl StringExpression {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all sub_expression references exist
        for id in &self.sub_expression {
            if !StringExpression::exists(id.clone()) {
                errors.push(format!("StringExpression {} not found", id));
            }
        }

        // Validate owning_expression reference exists
        if let Some(id) = &self.owning_expression {
            if !StringExpression::exists(id.clone()) {
                errors.push(format!("StringExpression {} not found", id));
            }
        }
