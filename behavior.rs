...
lazy_static! {
    static ref BEHAVIOR_REGISTRY: Mutex<RefCell<HashMap<String, Behavior>>> = 
...
#[wasm_bindgen]
impl Behavior {
    /// Creates a new Behavior and returns its ID
    #[wasm_bindgen]
    ...
    /// Checks if a Behavior exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Behavior instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Behavior> = BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Behavior instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Behavior instances
    #[wasm_bindgen]
    pub fn clear_all() {
        BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Behavior instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Behavior = serde_wasm_bindgen::from_value(instance_js)
