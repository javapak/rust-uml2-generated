// ExecutionSpecification - Generated UML Class
...
const TYPE_NAME: &str = "ExecutionSpecification";
...
impl ExecutionSpecification {
    /// Creates a new ExecutionSpecification instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "ExecutionSpecification".to_string()
    }
