...
lazy_static! {
    static ref EXECUTION_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, ExecutionSpecification>>> = 
...
impl ExecutionSpecification {
    /// Creates a new ExecutionSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create(start: String, finish: String) -> String {
        ...
        EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ExecutionSpecification by ID
    ...
    /// Updates a ExecutionSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ExecutionSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ExecutionSpecification by ID
    ...
    /// Checks if a ExecutionSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ExecutionSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ExecutionSpecification> = EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ExecutionSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ExecutionSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ExecutionSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
