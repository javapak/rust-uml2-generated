...
// ============================================================================
//
// Type:           WriteStructuralFeatureAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref WRITE_STRUCTURAL_FEATURE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, WriteStructuralFeatureAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct WriteStructuralFeatureAction {
...
#[wasm_bindgen]
impl WriteStructuralFeatureAction {
    /// Creates a new WriteStructuralFeatureAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String, value: String) -> String {
        ...
        WRITE_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a WriteStructuralFeatureAction by ID
    ...
    /// Updates a WriteStructuralFeatureAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: WriteStructuralFeatureAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a WriteStructuralFeatureAction by ID
    ...
    /// Checks if a WriteStructuralFeatureAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all WriteStructuralFeatureAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<WriteStructuralFeatureAction> = WRITE_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of WriteStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        WRITE_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all WriteStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        WRITE_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds WriteStructuralFeatureAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: WriteStructuralFeatureAction = serde_wasm_bindgen::from_value(instance_js)
