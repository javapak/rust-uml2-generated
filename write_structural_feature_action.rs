...
impl WriteStructuralFeatureAction {
    pub fn new(is_leaf: bool, structural_feature: Rc<RefCell<StructuralFeature>>, object: InputPin, value: InputPin) -> Self {
        Self {
...
impl Default for WriteStructuralFeatureAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
