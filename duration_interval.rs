...
lazy_static! {
    static ref DURATION_INTERVAL_REGISTRY: Mutex<RefCell<HashMap<String, DurationInterval>>> = 
...
impl DurationInterval {
    /// Creates a new DurationInterval and returns its ID
    #[wasm_bindgen]
    pub fn create(min: String, max: String) -> String {
        ...
        DURATION_INTERVAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DurationInterval instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DurationInterval = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DurationInterval by ID
    ...
    /// Checks if a DurationInterval exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DurationInterval instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DurationInterval> = DURATION_INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DurationInterval instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DURATION_INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DurationInterval instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DURATION_INTERVAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DurationInterval instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DurationInterval = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the min reference
    #[wasm_bindgen]
    pub fn set_min(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DurationInterval = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
    ...
    /// Sets the max reference
    #[wasm_bindgen]
    pub fn set_max(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DurationInterval = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl DurationInterval {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate min reference exists
        if !ValueSpecification::exists(self.min.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.min));
        }

        // Validate max reference exists
        if !ValueSpecification::exists(self.max.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.max));
        }
