...
impl Port {
    ...
    /// Returns a clone of redefined_port
    pub fn redefined_port(&self) -> Vec<String> {
        self.redefined_port.clone()
    }

    /// Adds an existing Port to redefined_port by ID
    pub fn add_redefined_port_by_id(&mut self, id: String) {
        self.redefined_port.push(id);
    }
    ...
    /// Returns a clone of protocol if present
    ...
    pub fn take_protocol(&mut self) -> Option<String> {
        self.protocol.take()
    }
