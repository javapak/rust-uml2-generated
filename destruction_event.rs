...
lazy_static! {
    static ref DESTRUCTION_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, DestructionEvent>>> = 
...
impl DestructionEvent {
    /// Creates a new DestructionEvent and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DESTRUCTION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DestructionEvent instance
    ...
    /// Deletes a DestructionEvent by ID
    ...
    /// Checks if a DestructionEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DestructionEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DestructionEvent> = DESTRUCTION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DestructionEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DESTRUCTION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DestructionEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DESTRUCTION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DestructionEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DestructionEvent = serde_wasm_bindgen::from_value(instance_js)
