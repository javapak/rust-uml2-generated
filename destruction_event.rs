// DestructionEvent - Generated UML Class
...
const TYPE_NAME: &str = "DestructionEvent";
...
impl DestructionEvent {
    /// Creates a new DestructionEvent instance
    #[wasm_bindgen]
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DestructionEvent = serde_wasm_bindgen::from_value(value)
