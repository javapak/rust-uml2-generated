...
impl CreateObjectAction {
    pub fn new(is_leaf: bool, classifier: Rc<RefCell<Classifier>>, result: OutputPin) -> Self {
        Self {
...
impl Default for CreateObjectAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for CreateObjectAction {
