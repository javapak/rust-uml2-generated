...
lazy_static! {
    static ref CREATE_OBJECT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CreateObjectAction>>> = 
...
impl CreateObjectAction {
    /// Creates a new CreateObjectAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, classifier: String, result: String) -> String {
        ...
        CREATE_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CreateObjectAction by ID
    ...
    /// Updates a CreateObjectAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CreateObjectAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CreateObjectAction by ID
    ...
    /// Checks if a CreateObjectAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CreateObjectAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CreateObjectAction> = CREATE_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CreateObjectAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CREATE_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CreateObjectAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CREATE_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CreateObjectAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CreateObjectAction = serde_wasm_bindgen::from_value(instance_js)
