...
lazy_static! {
    static ref FLOW_FINAL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, FlowFinalNode>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct FlowFinalNode {
...
#[wasm_bindgen]
impl FlowFinalNode {
    /// Creates a new FlowFinalNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        FLOW_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a FlowFinalNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: FlowFinalNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a FlowFinalNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all FlowFinalNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<FlowFinalNode> = FLOW_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of FlowFinalNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        FLOW_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all FlowFinalNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        FLOW_FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds FlowFinalNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: FlowFinalNode = serde_wasm_bindgen::from_value(instance_js)
