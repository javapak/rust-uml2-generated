// VariableAction - Generated UML Class
...
const TYPE_NAME: &str = "VariableAction";
...
#[wasm_bindgen]
impl VariableAction {
    /// Creates a new VariableAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_variable(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.variable = ref_id.clone();
