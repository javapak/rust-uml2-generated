...
lazy_static! {
    static ref VARIABLE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, VariableAction>>> = 
...
#[wasm_bindgen]
impl VariableAction {
    /// Creates a new VariableAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String) -> String {
        ...
        VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a VariableAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: VariableAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a VariableAction by ID
    ...
    /// Checks if a VariableAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all VariableAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<VariableAction> = VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of VariableAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all VariableAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds VariableAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: VariableAction = serde_wasm_bindgen::from_value(instance_js)
