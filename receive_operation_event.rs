...
// ============================================================================
//
// Type:           ReceiveOperationEvent (struct)
// Source Package: uml
...
lazy_static! {
    static ref RECEIVE_OPERATION_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, ReceiveOperationEvent>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReceiveOperationEvent {
...
#[wasm_bindgen]
impl ReceiveOperationEvent {
    /// Creates a new ReceiveOperationEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(operation: String) -> String {
        ...
        RECEIVE_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReceiveOperationEvent by ID
    ...
    /// Updates a ReceiveOperationEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReceiveOperationEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReceiveOperationEvent by ID
    ...
    /// Checks if a ReceiveOperationEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReceiveOperationEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReceiveOperationEvent> = RECEIVE_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReceiveOperationEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        RECEIVE_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReceiveOperationEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        RECEIVE_OPERATION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReceiveOperationEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReceiveOperationEvent = serde_wasm_bindgen::from_value(instance_js)
