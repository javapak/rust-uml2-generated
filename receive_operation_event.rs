// ReceiveOperationEvent - Generated UML Class
...
const TYPE_NAME: &str = "ReceiveOperationEvent";
...
impl ReceiveOperationEvent {
    /// Creates a new ReceiveOperationEvent instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "ReceiveOperationEvent".to_string()
    }
