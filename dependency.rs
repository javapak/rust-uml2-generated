...
pub struct Dependency {
    ...
    client_dependency: Vec<Weak<RefCell<Dependency>>>,
...
impl Dependency {
    pub fn new(supplier: Vec<Rc<RefCell<NamedElement>>>, client: Vec<Rc<RefCell<NamedElement>>>) -> Self {
        Self {
    ...
    pub fn client_dependency(&self) -> &Vec<Weak<RefCell<Dependency>>> {
        &self.client_dependency
    }

    /// Returns a mutable reference to client_dependency
    pub fn client_dependency_mut(&mut self) -> &mut Vec<Weak<RefCell<Dependency>>> {
        &mut self.client_dependency
    }

    /// Adds an item to client_dependency
    pub fn add_client_dependency(&mut self, item: Weak<RefCell<Dependency>>) {
