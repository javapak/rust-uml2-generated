...
lazy_static! {
    static ref DEPENDENCY_REGISTRY: Mutex<RefCell<HashMap<String, Dependency>>> = 
...
#[wasm_bindgen]
impl Dependency {
    /// Creates a new Dependency and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DEPENDENCY_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Dependency instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Dependency = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Dependency exists by ID
    #[wasm_bindgen]
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Dependency> = DEPENDENCY_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Dependency instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DEPENDENCY_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Dependency instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DEPENDENCY_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Dependency instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Dependency = serde_wasm_bindgen::from_value(instance_js)
