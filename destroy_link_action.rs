...
lazy_static! {
    static ref DESTROY_LINK_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, DestroyLinkAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct DestroyLinkAction {
...
#[wasm_bindgen]
impl DestroyLinkAction {
    /// Creates a new DestroyLinkAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        DESTROY_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a DestroyLinkAction by ID
    ...
    /// Updates a DestroyLinkAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DestroyLinkAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DestroyLinkAction by ID
    ...
    /// Checks if a DestroyLinkAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DestroyLinkAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DestroyLinkAction> = DESTROY_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DestroyLinkAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DESTROY_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DestroyLinkAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DESTROY_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DestroyLinkAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DestroyLinkAction = serde_wasm_bindgen::from_value(instance_js)
