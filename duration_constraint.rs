...
lazy_static! {
    static ref DURATION_CONSTRAINT_REGISTRY: Mutex<RefCell<HashMap<String, DurationConstraint>>> = 
...
pub struct DurationConstraint {
    ...
    pub first_event: Vec<String>,
}

#[wasm_bindgen]
impl DurationConstraint {
    /// Creates a new DurationConstraint and returns its ID
    #[wasm_bindgen]
    pub fn create(specification: String) -> String {
        ...
        DURATION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a DurationConstraint by ID
    ...
    /// Updates a DurationConstraint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DurationConstraint = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DurationConstraint by ID
    ...
    /// Checks if a DurationConstraint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DurationConstraint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DurationConstraint> = DURATION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DurationConstraint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DURATION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DurationConstraint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DURATION_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DurationConstraint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DurationConstraint = serde_wasm_bindgen::from_value(instance_js)
