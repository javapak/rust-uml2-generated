...
lazy_static! {
    static ref CONTROL_FLOW_REGISTRY: Mutex<RefCell<HashMap<String, ControlFlow>>> = 
...
#[wasm_bindgen]
impl ControlFlow {
    /// Creates a new ControlFlow and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, source: String, target: String, guard: String, weight: String) -> String {
        ...
        CONTROL_FLOW_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ControlFlow instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ControlFlow = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ControlFlow exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ControlFlow instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ControlFlow> = CONTROL_FLOW_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ControlFlow instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONTROL_FLOW_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ControlFlow instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONTROL_FLOW_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ControlFlow instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ControlFlow = serde_wasm_bindgen::from_value(instance_js)
