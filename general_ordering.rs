...
pub struct GeneralOrdering {
    ...
    before: Rc<RefCell<OccurrenceSpecification>>,
    after: Rc<RefCell<OccurrenceSpecification>>,
}

impl GeneralOrdering {
    pub fn new(before: Rc<RefCell<OccurrenceSpecification>>, after: Rc<RefCell<OccurrenceSpecification>>) -> Self {
        Self {
    ...
    /// Returns a reference to before
    pub fn before(&self) -> &Rc<RefCell<OccurrenceSpecification>> {
        &self.before
    }

    /// Returns a mutable reference to before
    pub fn before_mut(&mut self) -> &mut Rc<RefCell<OccurrenceSpecification>> {
        &mut self.before
    }

    /// Sets before
    pub fn set_before(&mut self, value: Rc<RefCell<OccurrenceSpecification>>) {
        self.before = value;
    }

    /// Returns a reference to after
    pub fn after(&self) -> &Rc<RefCell<OccurrenceSpecification>> {
        &self.after
    }

    /// Returns a mutable reference to after
    pub fn after_mut(&mut self) -> &mut Rc<RefCell<OccurrenceSpecification>> {
        &mut self.after
    }

    /// Sets after
    pub fn set_after(&mut self, value: Rc<RefCell<OccurrenceSpecification>>) {
        self.after = value;
    }

}

impl Default for GeneralOrdering {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for GeneralOrdering {
