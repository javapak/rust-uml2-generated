...
impl GeneralOrdering {
    ...
    /// Returns a clone of before
    pub fn before(&self) -> String {
        self.before.clone()
    }

    /// Sets before
    pub fn set_before(&mut self, value: String) {
        self.before = value;
    }

    /// Takes ownership of before, replacing it with an empty string
    pub fn take_before(&mut self) -> String {
        std::mem::take(&mut self.before)
    }

    /// Returns a clone of after
    pub fn after(&self) -> String {
        self.after.clone()
    }

    /// Sets after
    pub fn set_after(&mut self, value: String) {
        self.after = value;
    }

    /// Takes ownership of after, replacing it with an empty string
    pub fn take_after(&mut self) -> String {
