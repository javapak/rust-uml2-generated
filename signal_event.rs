...
lazy_static! {
    static ref SIGNAL_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, SignalEvent>>> = 
...
#[wasm_bindgen]
impl SignalEvent {
    /// Creates a new SignalEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(signal: String) -> String {
        ...
        SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a SignalEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SignalEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a SignalEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SignalEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SignalEvent> = SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SignalEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SignalEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SignalEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SignalEvent = serde_wasm_bindgen::from_value(instance_js)
