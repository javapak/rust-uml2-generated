...
pub struct Component {
    ...
    is_indirectly_instantiated: bool,
    packaged_element: Vec<PackageableElement>,
    realization: Vec<ComponentRealization>,
}

impl Component {
    pub fn new(is_leaf: bool, is_abstract: bool, is_active: bool, is_indirectly_instantiated: bool) -> Self {
        Self {
    ...
    /// Returns is_indirectly_instantiated
    pub fn is_indirectly_instantiated(&self) -> bool {
        self.is_indirectly_instantiated
    }

    /// Sets is_indirectly_instantiated
    pub fn set_is_indirectly_instantiated(&mut self, value: bool) {
        self.is_indirectly_instantiated = value;
    }
    ...
    /// Returns a slice of realization
    pub fn realization(&self) -> &[ComponentRealization] {
        &self.realization
    }

    /// Returns a mutable reference to realization
    pub fn realization_mut(&mut self) -> &mut Vec<ComponentRealization> {
        &mut self.realization
    }

    /// Adds an item to realization
    pub fn add_realization(&mut self, item: ComponentRealization) {
