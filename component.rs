...
use crate::component_realization::ComponentRealization;

lazy_static! {
    static ref COMPONENT_REGISTRY: Mutex<RefCell<HashMap<String, Component>>> = 
...
pub struct Component {
    ...
    pub is_indirectly_instantiated: String,
...
impl Component {
    ...
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_active: String, is_indirectly_instantiated: String) -> String {
        ...
        let instance = Self {
            ...
            is_indirectly_instantiated: is_indirectly_instantiated,
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Component = serde_wasm_bindgen::from_value(value)
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Component> = COMPONENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Component instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        COMPONENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Component instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Component = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a ComponentRealization to realization
    #[wasm_bindgen]
    pub fn add_realization(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Ok(target_js) = ComponentRealization::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<ComponentRealization>(target_js) {
                target.abstraction = Some(instance_id);
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = ComponentRealization::update(target_js);
                }
            }
        }
    ...
    /// Removes a ComponentRealization from realization
    #[wasm_bindgen]
    ...
    /// Clears all ComponentRealization from realization
    #[wasm_bindgen]
    pub fn clear_realization(instance_id: String) -> Result<usize, JsValue> {
        ...
        // Update all opposite references
        for ref_id in &instance.realization {
            if let Ok(target_js) = ComponentRealization::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<ComponentRealization>(target_js) {
                target.abstraction = None;
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
    ...
    /// Sets the is_indirectly_instantiated field
    #[wasm_bindgen]
    pub fn set_is_indirectly_instantiated(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Component = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_indirectly_instantiated = value;
...
impl Component {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        for id in &self.realization {
            if !ComponentRealization::exists(id.clone()) {
                errors.push(format!("ComponentRealization {} not found", id));
            }
        }
