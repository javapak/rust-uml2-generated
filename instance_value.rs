...
impl InstanceValue {
    ...
    /// Returns a clone of instance
    pub fn instance(&self) -> String {
        self.instance.clone()
    }

    /// Sets instance
    pub fn set_instance(&mut self, value: String) {
        self.instance = value;
    }

    /// Takes ownership of instance, replacing it with an empty string
    pub fn take_instance(&mut self) -> String {
        std::mem::take(&mut self.instance)
    }
