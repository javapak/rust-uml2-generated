...
lazy_static! {
    static ref INSTANCE_VALUE_REGISTRY: Mutex<RefCell<HashMap<String, InstanceValue>>> = 
...
#[wasm_bindgen]
impl InstanceValue {
    /// Creates a new InstanceValue and returns its ID
    #[wasm_bindgen]
    pub fn create(instance: String) -> String {
        ...
        INSTANCE_VALUE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a InstanceValue instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: InstanceValue = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a InstanceValue exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InstanceValue instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InstanceValue> = INSTANCE_VALUE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InstanceValue instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INSTANCE_VALUE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InstanceValue instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INSTANCE_VALUE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InstanceValue instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InstanceValue = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_instance(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: InstanceValue = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.instance = ref_id;
...
impl InstanceValue {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate instance reference exists
        if !InstanceSpecification::exists(self.instance.clone()) {
            errors.push(format!("InstanceSpecification {} not found", self.instance));
        }
