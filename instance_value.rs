...
pub struct InstanceValue {
    ...
    instance: Rc<RefCell<InstanceSpecification>>,
}

impl InstanceValue {
    pub fn new(instance: Rc<RefCell<InstanceSpecification>>) -> Self {
        Self {
    ...
    pub fn instance(&self) -> &Rc<RefCell<InstanceSpecification>> {
        &self.instance
    }

    /// Returns a mutable reference to instance
    pub fn instance_mut(&mut self) -> &mut Rc<RefCell<InstanceSpecification>> {
        &mut self.instance
    }

    /// Sets instance
    pub fn set_instance(&mut self, value: Rc<RefCell<InstanceSpecification>>) {
        self.instance = value;
    }
...
impl std::fmt::Display for InstanceValue {
