// InstanceValue - Generated UML Class
...
const TYPE_NAME: &str = "InstanceValue";
...
#[wasm_bindgen]
impl InstanceValue {
    /// Creates a new InstanceValue instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn set_instance(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.instance = ref_id.clone();
