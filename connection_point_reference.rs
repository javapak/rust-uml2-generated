...
lazy_static! {
    static ref CONNECTION_POINT_REFERENCE_REGISTRY: Mutex<RefCell<HashMap<String, ConnectionPointReference>>> = 
...
impl ConnectionPointReference {
    /// Creates a new ConnectionPointReference and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        CONNECTION_POINT_REFERENCE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ConnectionPointReference by ID
    ...
    /// Updates a ConnectionPointReference instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ConnectionPointReference = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ConnectionPointReference by ID
    ...
    /// Checks if a ConnectionPointReference exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ConnectionPointReference instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ConnectionPointReference> = CONNECTION_POINT_REFERENCE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ConnectionPointReference instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONNECTION_POINT_REFERENCE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ConnectionPointReference instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONNECTION_POINT_REFERENCE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ConnectionPointReference instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a Pseudostate to entry
    #[wasm_bindgen]
    pub fn add_entry(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.entry.contains(&ref_id) {
            return Ok(false);
        }

        instance.entry.push(ref_id.clone());
    ...
    /// Removes a Pseudostate from entry
    #[wasm_bindgen]
    pub fn remove_entry(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.entry.iter().position(|x| x == &ref_id) {
            instance.entry.remove(pos);
    ...
    /// Clears all Pseudostate from entry
    #[wasm_bindgen]
    pub fn clear_entry(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.entry.len();
    ...
    /// Adds a Pseudostate to exit
    #[wasm_bindgen]
    pub fn add_exit(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.exit.contains(&ref_id) {
            return Ok(false);
        }

        instance.exit.push(ref_id.clone());
    ...
    /// Removes a Pseudostate from exit
    #[wasm_bindgen]
    pub fn remove_exit(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.exit.iter().position(|x| x == &ref_id) {
            instance.exit.remove(pos);
    ...
    /// Clears all Pseudostate from exit
    #[wasm_bindgen]
    pub fn clear_exit(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConnectionPointReference = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.exit.len();
    ...
    pub fn set_state(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        if let Some(old_ref_id) = &instance.state {
            if let Ok(target_js) = State::get(old_ref_id.clone()) {
                if let Ok(mut target) = serde_wasm_bindgen::from_value::<State>(target_js) {
                    target.connection.retain(|x| x != &instance_id);
                    if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
        ...
        if let Ok(target_js) = State::get(new_ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<State>(target_js) {
                if !target.connection.contains(&instance_id) {
                    target.connection.push(instance_id.clone());
                }
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = State::update(target_js);
                }
...
impl ConnectionPointReference {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all entry references exist
        ...
        // Validate all exit references exist
        for id in &self.exit {
            if !Pseudostate::exists(id.clone()) {
                errors.push(format!("Pseudostate {} not found", id));
            }
