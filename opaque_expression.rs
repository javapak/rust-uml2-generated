...
lazy_static! {
    static ref OPAQUE_EXPRESSION_REGISTRY: Mutex<RefCell<HashMap<String, OpaqueExpression>>> = 
...
impl OpaqueExpression {
    /// Creates a new OpaqueExpression and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        OPAQUE_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a OpaqueExpression instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: OpaqueExpression = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a OpaqueExpression by ID
    ...
    /// Checks if a OpaqueExpression exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all OpaqueExpression instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<OpaqueExpression> = OPAQUE_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of OpaqueExpression instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OPAQUE_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all OpaqueExpression instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OPAQUE_EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds OpaqueExpression instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: OpaqueExpression = serde_wasm_bindgen::from_value(instance_js)
