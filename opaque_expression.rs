// OpaqueExpression - Generated UML Class
...
const TYPE_NAME: &str = "OpaqueExpression";
...
impl OpaqueExpression {
    /// Creates a new OpaqueExpression instance
    #[wasm_bindgen]
...
pub fn add_language(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_behavior(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        instance.behavior = ref_id.clone();
    ...
    #[wasm_bindgen]
    pub fn clear_behavior(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
