// InvocationAction - Generated UML Class
...
const TYPE_NAME: &str = "InvocationAction";
...
impl InvocationAction {
    /// Creates a new InvocationAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    #[wasm_bindgen]
    pub fn clear_on_port(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.on_port.is_none() {
            return Ok(false);
        }
        
        instance.on_port = None;
