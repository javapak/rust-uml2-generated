...
lazy_static! {
    static ref INVOCATION_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, InvocationAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct InvocationAction {
...
impl InvocationAction {
    /// Creates a new InvocationAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        INVOCATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a InvocationAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: InvocationAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a InvocationAction by ID
    ...
    /// Checks if a InvocationAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InvocationAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InvocationAction> = INVOCATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InvocationAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INVOCATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InvocationAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INVOCATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InvocationAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InvocationAction = serde_wasm_bindgen::from_value(instance_js)
