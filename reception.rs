...
lazy_static! {
    static ref RECEPTION_REGISTRY: Mutex<RefCell<HashMap<String, Reception>>> = 
...
#[wasm_bindgen]
impl Reception {
    /// Creates a new Reception and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_static: String, is_abstract: String, concurrency: CallConcurrencyKind) -> String {
        ...
        RECEPTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Reception instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Reception = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Reception exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Reception instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Reception> = RECEPTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Reception instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        RECEPTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Reception instances
    #[wasm_bindgen]
    pub fn clear_all() {
        RECEPTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Reception instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Reception = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_signal(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Reception = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl Reception {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if let Some(id) = &self.signal {
            if !Signal::exists(id.clone()) {
                errors.push(format!("Signal {} not found", id));
            }
        }
