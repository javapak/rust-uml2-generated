...
pub struct Reception {
    ...
    signal: Option<Rc<RefCell<Signal>>>,
}
...
impl Reception {
    ...
    /// Returns a reference to signal if present
    pub fn signal(&self) -> Option<&Rc<RefCell<Signal>>> {
        self.signal.as_ref()
    }

    /// Returns a mutable reference to signal if present
    pub fn signal_mut(&mut self) -> Option<&mut Rc<RefCell<Signal>>> {
        self.signal.as_mut()
    }
    ...
    pub fn take_signal(&mut self) -> Option<Rc<RefCell<Signal>>> {
        self.signal.take()
    }
