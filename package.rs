...
lazy_static! {
    static ref PACKAGE_REGISTRY: Mutex<RefCell<HashMap<String, Package>>> = 
...
impl Package {
    ...
    /// Checks if a Package exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Package instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Package> = PACKAGE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Package instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PACKAGE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Package instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Package = serde_wasm_bindgen::from_value(instance_js)
