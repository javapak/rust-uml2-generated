...
// ============================================================================
//
// Type:           ReadStructuralFeatureAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref READ_STRUCTURAL_FEATURE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadStructuralFeatureAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadStructuralFeatureAction {
...
#[wasm_bindgen]
impl ReadStructuralFeatureAction {
    /// Creates a new ReadStructuralFeatureAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String, result: String) -> String {
        ...
        READ_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReadStructuralFeatureAction by ID
    ...
    /// Updates a ReadStructuralFeatureAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadStructuralFeatureAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadStructuralFeatureAction by ID
    ...
    /// Checks if a ReadStructuralFeatureAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadStructuralFeatureAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadStructuralFeatureAction> = READ_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadStructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadStructuralFeatureAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadStructuralFeatureAction = serde_wasm_bindgen::from_value(instance_js)
