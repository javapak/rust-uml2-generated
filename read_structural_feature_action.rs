...
impl ReadStructuralFeatureAction {
    pub fn new(is_leaf: bool, structural_feature: Rc<RefCell<StructuralFeature>>, object: InputPin, result: OutputPin) -> Self {
        Self {
...
impl Default for ReadStructuralFeatureAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadStructuralFeatureAction {
