...
lazy_static! {
    static ref CONTROL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ControlNode>>> = 
...
#[wasm_bindgen]
impl ControlNode {
    /// Creates a new ControlNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        CONTROL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ControlNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ControlNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ControlNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ControlNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ControlNode> = CONTROL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ControlNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONTROL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ControlNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONTROL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ControlNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ControlNode = serde_wasm_bindgen::from_value(instance_js)
