...
lazy_static! {
    static ref DEVICE_REGISTRY: Mutex<RefCell<HashMap<String, Device>>> = 
...
impl Device {
    ...
    /// Updates a Device instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Device = serde_wasm_bindgen::from_value(value)
    ...
    /// Gets all Device instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Device> = DEVICE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Device instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DEVICE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Device instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Device = serde_wasm_bindgen::from_value(instance_js)
