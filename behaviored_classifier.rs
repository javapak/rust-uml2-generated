...
// ============================================================================
//
// Type:           BehavioredClassifier (struct)
// Source Package: uml
...
lazy_static! {
    static ref BEHAVIORED_CLASSIFIER_REGISTRY: Mutex<RefCell<HashMap<String, BehavioredClassifier>>> = 
...
impl BehavioredClassifier {
    /// Creates a new BehavioredClassifier and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        BEHAVIORED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a BehavioredClassifier by ID
    ...
    /// Updates a BehavioredClassifier instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: BehavioredClassifier = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a BehavioredClassifier by ID
    ...
    /// Checks if a BehavioredClassifier exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all BehavioredClassifier instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<BehavioredClassifier> = BEHAVIORED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of BehavioredClassifier instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        BEHAVIORED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all BehavioredClassifier instances
    #[wasm_bindgen]
    pub fn clear_all() {
        BEHAVIORED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds BehavioredClassifier instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: BehavioredClassifier = serde_wasm_bindgen::from_value(instance_js)
