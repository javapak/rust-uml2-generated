...
lazy_static! {
    static ref EXTENSION_REGISTRY: Mutex<RefCell<HashMap<String, Extension>>> = 
...
#[wasm_bindgen]
impl Extension {
    /// Creates a new Extension and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_derived: String) -> String {
        ...
        EXTENSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Extension = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Extension exists by ID
    #[wasm_bindgen]
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Extension> = EXTENSION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Extension instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXTENSION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Extension instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXTENSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Extension instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Extension = serde_wasm_bindgen::from_value(instance_js)
