...
// ============================================================================
//
// Type:           PackageableElement (struct)
// Source Package: uml
...
lazy_static! {
    static ref PACKAGEABLE_ELEMENT_REGISTRY: Mutex<RefCell<HashMap<String, PackageableElement>>> = 
...
impl PackageableElement {
    /// Creates a new PackageableElement and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        PACKAGEABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a PackageableElement by ID
    ...
    /// Updates a PackageableElement instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: PackageableElement = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a PackageableElement by ID
    ...
    /// Checks if a PackageableElement exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all PackageableElement instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<PackageableElement> = PACKAGEABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of PackageableElement instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PACKAGEABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all PackageableElement instances
    #[wasm_bindgen]
    pub fn clear_all() {
        PACKAGEABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds PackageableElement instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: PackageableElement = serde_wasm_bindgen::from_value(instance_js)
