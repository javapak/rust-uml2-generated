...
// ============================================================================
//
// Type:           AddStructuralFeatureValueAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref ADD_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, AddStructuralFeatureValueAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct AddStructuralFeatureValueAction {
...
#[wasm_bindgen]
impl AddStructuralFeatureValueAction {
    /// Creates a new AddStructuralFeatureValueAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String, value: String, is_replace_all: String) -> String {
        ...
        ADD_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a AddStructuralFeatureValueAction by ID
    ...
    /// Updates a AddStructuralFeatureValueAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AddStructuralFeatureValueAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AddStructuralFeatureValueAction by ID
    ...
    /// Checks if a AddStructuralFeatureValueAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AddStructuralFeatureValueAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AddStructuralFeatureValueAction> = ADD_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AddStructuralFeatureValueAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ADD_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AddStructuralFeatureValueAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ADD_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AddStructuralFeatureValueAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AddStructuralFeatureValueAction = serde_wasm_bindgen::from_value(instance_js)
