...
pub struct AddStructuralFeatureValueAction {
    ...
    value: InputPin,
    is_replace_all: bool,
    insert_at: Option<InputPin>,
}

impl AddStructuralFeatureValueAction {
    pub fn new(is_leaf: bool, structural_feature: Rc<RefCell<StructuralFeature>>, object: InputPin, value: InputPin, is_replace_all: bool) -> Self {
        Self {
    ...
    pub fn insert_at(&self) -> Option<&InputPin> {
        self.insert_at.as_ref()
    }

    /// Returns a mutable reference to insert_at if present
    pub fn insert_at_mut(&mut self) -> Option<&mut InputPin> {
        self.insert_at.as_mut()
    }

    /// Sets insert_at
    pub fn set_insert_at(&mut self, value: InputPin) {
        self.insert_at = Some(value);
    }

    /// Takes insert_at, leaving None in its place
    pub fn take_insert_at(&mut self) -> Option<InputPin> {
        self.insert_at.take()
    }

}

impl Default for AddStructuralFeatureValueAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for AddStructuralFeatureValueAction {
