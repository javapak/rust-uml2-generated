...
lazy_static! {
    static ref EVENT_REGISTRY: Mutex<RefCell<HashMap<String, Event>>> = 
...
impl Event {
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Event = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Event exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Event instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Event> = EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Event instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Event instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Event = serde_wasm_bindgen::from_value(instance_js)
