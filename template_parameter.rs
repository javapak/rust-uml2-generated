...
lazy_static! {
    static ref TEMPLATE_PARAMETER_REGISTRY: Mutex<RefCell<HashMap<String, TemplateParameter>>> = 
...
impl TemplateParameter {
    /// Creates a new TemplateParameter and returns its ID
    #[wasm_bindgen]
    pub fn create(signature: String, parametered_element: String) -> String {
        ...
        TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a TemplateParameter by ID
    ...
    /// Updates a TemplateParameter instance
    ...
    /// Deletes a TemplateParameter by ID
    ...
    /// Checks if a TemplateParameter exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TemplateParameter instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TemplateParameter> = TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TemplateParameter instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TemplateParameter instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TemplateParameter = serde_wasm_bindgen::from_value(instance_js)
