...
impl ValuePin {
    pub fn new(is_leaf: bool, ordering: String, is_control_type: bool, upper_bound: ValueSpecification, is_ordered: bool, is_unique: bool, is_control: bool, value: ValueSpecification) -> Self {
        Self {
...
impl std::fmt::Display for ValuePin {
