...
lazy_static! {
    static ref VALUE_PIN_REGISTRY: Mutex<RefCell<HashMap<String, ValuePin>>> = 
...
#[wasm_bindgen]
impl ValuePin {
    /// Creates a new ValuePin and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String, is_ordered: String, is_unique: String, is_control: String, value: String) -> String {
        ...
        VALUE_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Checks if a ValuePin exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ValuePin instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ValuePin> = VALUE_PIN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ValuePin instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        VALUE_PIN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ValuePin instances
    #[wasm_bindgen]
    pub fn clear_all() {
        VALUE_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ValuePin instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ValuePin = serde_wasm_bindgen::from_value(instance_js)
...
impl ValuePin {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !ValueSpecification::exists(self.value.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.value));
        }
