// ProtocolStateMachine - Generated UML Class
...
const TYPE_NAME: &str = "ProtocolStateMachine";
...
impl ProtocolStateMachine {
    /// Creates a new ProtocolStateMachine instance
    #[wasm_bindgen]
...
pub fn set_is_reentrant(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn add_conformance(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<ProtocolConformance>(&ref_id) {
            target.specific_machine = instance_id.clone();
            let _ = registry::insert(ref_id.clone(), "ProtocolConformance", &target);
        }
    ...
    pub fn remove_conformance(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.conformance.len();
        instance.conformance.retain(|id| id != &ref_id);
        let removed = instance.conformance.len() < initial_len;
        ...
        // Update opposite reference
        if let Some(target) = registry::get::<ProtocolConformance>(&ref_id) {
            let _ = registry::insert(ref_id.clone(), "ProtocolConformance", &target);
        }
