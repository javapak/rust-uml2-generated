...
lazy_static! {
    static ref ACTOR_REGISTRY: Mutex<RefCell<HashMap<String, Actor>>> = 
...
impl Actor {
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Actor = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Actor exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Actor instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Actor> = ACTOR_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Actor instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTOR_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Actor instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Actor = serde_wasm_bindgen::from_value(instance_js)
