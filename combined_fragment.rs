...
lazy_static! {
    static ref COMBINED_FRAGMENT_REGISTRY: Mutex<RefCell<HashMap<String, CombinedFragment>>> = 
...
impl CombinedFragment {
    /// Creates a new CombinedFragment and returns its ID
    #[wasm_bindgen]
    pub fn create(interaction_operator: InteractionOperatorKind) -> String {
        ...
        COMBINED_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CombinedFragment instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CombinedFragment = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CombinedFragment by ID
    ...
    /// Checks if a CombinedFragment exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CombinedFragment instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CombinedFragment> = COMBINED_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CombinedFragment instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        COMBINED_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CombinedFragment instances
    #[wasm_bindgen]
    pub fn clear_all() {
        COMBINED_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CombinedFragment instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CombinedFragment = serde_wasm_bindgen::from_value(instance_js)
