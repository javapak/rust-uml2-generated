...
lazy_static! {
    static ref REPLY_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReplyAction>>> = 
...
pub struct ReplyAction {
    ...
    pub reply_to_call: String,
    pub return_information: String,
    pub reply_value: Vec<String>,
}

#[wasm_bindgen]
impl ReplyAction {
    /// Creates a new ReplyAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, reply_to_call: String, return_information: String) -> String {
        ...
        let instance = Self {
            ...
            reply_to_call: reply_to_call,
            return_information: return_information,
            reply_value: Vec::new(),
        };

        REPLY_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ReplyAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReplyAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ReplyAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReplyAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReplyAction> = REPLY_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReplyAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REPLY_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReplyAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REPLY_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReplyAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the reply_to_call reference
    #[wasm_bindgen]
    pub fn set_reply_to_call(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.reply_to_call = ref_id;
    ...
    /// Sets the return_information reference
    #[wasm_bindgen]
    pub fn set_return_information(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.return_information = ref_id;
    ...
    /// Adds a InputPin to reply_value
    #[wasm_bindgen]
    pub fn add_reply_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.reply_value.contains(&ref_id) {
            return Ok(false);
        }

        instance.reply_value.push(ref_id.clone());
    ...
    /// Removes a InputPin from reply_value
    #[wasm_bindgen]
    pub fn remove_reply_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.reply_value.iter().position(|x| x == &ref_id) {
            instance.reply_value.remove(pos);
    ...
    /// Clears all InputPin from reply_value
    #[wasm_bindgen]
    pub fn clear_reply_value(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReplyAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.reply_value.len();

        instance.reply_value.clear();
...
impl ReplyAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate reply_to_call reference exists
        if !Trigger::exists(self.reply_to_call.clone()) {
            errors.push(format!("Trigger {} not found", self.reply_to_call));
        }

        // Validate return_information reference exists
        if !InputPin::exists(self.return_information.clone()) {
            errors.push(format!("InputPin {} not found", self.return_information));
        }

        // Validate all reply_value references exist
        for id in &self.reply_value {
