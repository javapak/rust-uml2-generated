...
#[wasm_bindgen]
impl ReplyAction {
    pub fn new(is_leaf: bool, reply_to_call: String, return_information: InputPin) -> Self {
        Self {
    ...
    /// Returns a clone of reply_to_call
    pub fn reply_to_call(&self) -> String {
        self.reply_to_call.clone()
    }

    /// Sets reply_to_call
    pub fn set_reply_to_call(&mut self, value: String) {
        self.reply_to_call = value;
    }

    /// Takes ownership of reply_to_call, replacing it with an empty string
    pub fn take_reply_to_call(&mut self) -> String {
        std::mem::take(&mut self.reply_to_call)
    }
