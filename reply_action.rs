...
pub struct ReplyAction {
    ...
    reply_to_call: Rc<RefCell<Trigger>>,
    return_information: InputPin,
    reply_value: Vec<InputPin>,
}

impl ReplyAction {
    pub fn new(is_leaf: bool, reply_to_call: Rc<RefCell<Trigger>>, return_information: InputPin) -> Self {
        Self {
    ...
    /// Returns a reference to reply_to_call
    pub fn reply_to_call(&self) -> &Rc<RefCell<Trigger>> {
        &self.reply_to_call
    }

    /// Returns a mutable reference to reply_to_call
    pub fn reply_to_call_mut(&mut self) -> &mut Rc<RefCell<Trigger>> {
        &mut self.reply_to_call
    }

    /// Sets reply_to_call
    pub fn set_reply_to_call(&mut self, value: Rc<RefCell<Trigger>>) {
        self.reply_to_call = value;
    }

    /// Returns a reference to return_information
    pub fn return_information(&self) -> &InputPin {
        &self.return_information
    }

    /// Returns a mutable reference to return_information
    pub fn return_information_mut(&mut self) -> &mut InputPin {
        &mut self.return_information
    }

    /// Sets return_information
    pub fn set_return_information(&mut self, value: InputPin) {
        self.return_information = value;
    }

    /// Returns a slice of reply_value
    pub fn reply_value(&self) -> &[InputPin] {
        &self.reply_value
    }

    /// Returns a mutable reference to reply_value
    pub fn reply_value_mut(&mut self) -> &mut Vec<InputPin> {
        &mut self.reply_value
    }

    /// Adds an item to reply_value
    pub fn add_reply_value(&mut self, item: InputPin) {
        self.reply_value.push(item);
    }

    /// Clears all items from reply_value
    pub fn clear_reply_value(&mut self) {
        self.reply_value.clear();
    }

}

impl Default for ReplyAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
            ...
            local_precondition: Vec::new(),
            local_postcondition: Vec::new(),
            reply_to_call: Default::default(),
            return_information: Default::default(),
            reply_value: Vec::new(),
        }
    }
}
