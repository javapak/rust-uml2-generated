...
lazy_static! {
    static ref READ_SELF_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadSelfAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadSelfAction {
...
#[wasm_bindgen]
impl ReadSelfAction {
    /// Creates a new ReadSelfAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, result: String) -> String {
        ...
        READ_SELF_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ReadSelfAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadSelfAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadSelfAction by ID
    ...
    /// Checks if a ReadSelfAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadSelfAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadSelfAction> = READ_SELF_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadSelfAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_SELF_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadSelfAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_SELF_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadSelfAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadSelfAction = serde_wasm_bindgen::from_value(instance_js)
