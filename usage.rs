...
lazy_static! {
    static ref USAGE_REGISTRY: Mutex<RefCell<HashMap<String, Usage>>> = 
...
#[wasm_bindgen]
impl Usage {
    /// Creates a new Usage and returns its ID
    #[wasm_bindgen]
    ...
    /// Checks if a Usage exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Usage instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Usage> = USAGE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Usage instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        USAGE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Usage instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Usage = serde_wasm_bindgen::from_value(instance_js)
