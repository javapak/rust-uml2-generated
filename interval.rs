...
lazy_static! {
    static ref INTERVAL_REGISTRY: Mutex<RefCell<HashMap<String, Interval>>> = 
...
impl Interval {
    ...
    /// Updates a Interval instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Interval = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Interval exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Interval instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Interval> = INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Interval instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INTERVAL_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Interval instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INTERVAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Interval instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Interval = serde_wasm_bindgen::from_value(instance_js)
