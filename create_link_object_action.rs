// CreateLinkObjectAction - Generated UML Class
...
const TYPE_NAME: &str = "CreateLinkObjectAction";
...
impl CreateLinkObjectAction {
    /// Creates a new CreateLinkObjectAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "CreateLinkObjectAction".to_string()
    }
