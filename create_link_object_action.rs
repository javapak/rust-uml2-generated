...
// ============================================================================
//
// Type:           CreateLinkObjectAction (struct)
// Source Package: uml
...
use crate::link_end_data::LinkEndData;
use crate::input_pin::InputPin;
use crate::output_pin::OutputPin;

lazy_static! {
    static ref CREATE_LINK_OBJECT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CreateLinkObjectAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct CreateLinkObjectAction {
    ...
    pub end_data: Vec<String>,
    pub input_value: Vec<String>,
    pub result: String,
}

#[wasm_bindgen]
impl CreateLinkObjectAction {
    /// Creates a new CreateLinkObjectAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, result: String) -> String {
        ...
        CREATE_LINK_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CreateLinkObjectAction by ID
    ...
    /// Updates a CreateLinkObjectAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CreateLinkObjectAction by ID
    ...
    /// Checks if a CreateLinkObjectAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CreateLinkObjectAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CreateLinkObjectAction> = CREATE_LINK_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CreateLinkObjectAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CREATE_LINK_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CreateLinkObjectAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CREATE_LINK_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CreateLinkObjectAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a LinkEndData to end_data
    #[wasm_bindgen]
    pub fn add_end_data(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.end_data.contains(&ref_id) {
            return Ok(false);
        }

        instance.end_data.push(ref_id.clone());
    ...
    /// Removes a LinkEndData from end_data
    #[wasm_bindgen]
    pub fn remove_end_data(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.end_data.iter().position(|x| x == &ref_id) {
            instance.end_data.remove(pos);
    ...
    /// Clears all LinkEndData from end_data
    #[wasm_bindgen]
    pub fn clear_end_data(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.end_data.len();

        instance.end_data.clear();
    ...
    /// Adds a InputPin to input_value
    #[wasm_bindgen]
    pub fn add_input_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.input_value.contains(&ref_id) {
            return Ok(false);
        }

        instance.input_value.push(ref_id.clone());
    ...
    /// Removes a InputPin from input_value
    #[wasm_bindgen]
    pub fn remove_input_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.input_value.iter().position(|x| x == &ref_id) {
            instance.input_value.remove(pos);
    ...
    /// Clears all InputPin from input_value
    #[wasm_bindgen]
    pub fn clear_input_value(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CreateLinkObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.input_value.len();

        instance.input_value.clear();
...
impl CreateLinkObjectAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all end_data references exist
        for id in &self.end_data {
            if !LinkEndData::exists(id.clone()) {
                errors.push(format!("LinkEndData {} not found", id));
            }
        }

        // Validate all input_value references exist
        for id in &self.input_value {
