...
pub struct CreateLinkObjectAction {
    ...
    end_data: Vec<LinkEndData>,
    input_value: Vec<InputPin>,
    result: OutputPin,
}

impl CreateLinkObjectAction {
    pub fn new(is_leaf: bool, end_data: Vec<LinkEndData>, input_value: Vec<InputPin>, result: OutputPin) -> Self {
        Self {
    ...
    /// Returns a slice of end_data
    pub fn end_data(&self) -> &[LinkEndData] {
        &self.end_data
    }

    /// Returns a mutable reference to end_data
    pub fn end_data_mut(&mut self) -> &mut Vec<LinkEndData> {
        &mut self.end_data
    }

    /// Adds an item to end_data
    pub fn add_end_data(&mut self, item: LinkEndData) {
        self.end_data.push(item);
    }

    /// Clears all items from end_data
    pub fn clear_end_data(&mut self) {
        self.end_data.clear();
    }

    /// Returns a slice of input_value
    pub fn input_value(&self) -> &[InputPin] {
        &self.input_value
    }

    /// Returns a mutable reference to input_value
    pub fn input_value_mut(&mut self) -> &mut Vec<InputPin> {
        &mut self.input_value
    }

    /// Adds an item to input_value
    pub fn add_input_value(&mut self, item: InputPin) {
        self.input_value.push(item);
    }

    /// Clears all items from input_value
    ...
    pub fn result_mut(&mut self) -> &mut OutputPin {
        &mut self.result
    }

    /// Sets result
    pub fn set_result(&mut self, value: OutputPin) {
        self.result = value;
    }

}

impl Default for CreateLinkObjectAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for CreateLinkObjectAction {
