...
lazy_static! {
    static ref TIME_OBSERVATION_REGISTRY: Mutex<RefCell<HashMap<String, TimeObservation>>> = 
...
impl TimeObservation {
    /// Creates a new TimeObservation and returns its ID
    #[wasm_bindgen]
    pub fn create(event: String, first_event: String) -> String {
        ...
        TIME_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a TimeObservation instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TimeObservation = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a TimeObservation by ID
    ...
    /// Checks if a TimeObservation exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TimeObservation instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TimeObservation> = TIME_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TimeObservation instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TIME_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TimeObservation instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TIME_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TimeObservation instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TimeObservation = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_first_event(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TimeObservation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl TimeObservation {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !NamedElement::exists(self.event.clone()) {
            errors.push(format!("NamedElement {} not found", self.event));
        }
