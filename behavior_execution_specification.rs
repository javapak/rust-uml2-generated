...
// ============================================================================
//
// Type:           BehaviorExecutionSpecification (struct)
// Source Package: uml
...
lazy_static! {
    static ref BEHAVIOR_EXECUTION_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, BehaviorExecutionSpecification>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct BehaviorExecutionSpecification {
...
#[wasm_bindgen]
impl BehaviorExecutionSpecification {
    /// Creates a new BehaviorExecutionSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create(start: String, finish: String) -> String {
        ...
        BEHAVIOR_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a BehaviorExecutionSpecification by ID
    ...
    /// Updates a BehaviorExecutionSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: BehaviorExecutionSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a BehaviorExecutionSpecification by ID
    ...
    /// Checks if a BehaviorExecutionSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all BehaviorExecutionSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<BehaviorExecutionSpecification> = BEHAVIOR_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of BehaviorExecutionSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        BEHAVIOR_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all BehaviorExecutionSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        BEHAVIOR_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds BehaviorExecutionSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: BehaviorExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the start reference
    #[wasm_bindgen]
    pub fn set_start(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: BehaviorExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.start = ref_id;
    ...
    /// Sets the finish reference
    #[wasm_bindgen]
    pub fn set_finish(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: BehaviorExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.finish = ref_id;
    ...
    /// Sets the behavior reference
    #[wasm_bindgen]
    pub fn set_behavior(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: BehaviorExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.behavior = ref_id;
...
impl BehaviorExecutionSpecification {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate start reference exists
        if !OccurrenceSpecification::exists(self.start.clone()) {
            errors.push(format!("OccurrenceSpecification {} not found", self.start));
        }

        // Validate finish reference exists
        if !OccurrenceSpecification::exists(self.finish.clone()) {
            errors.push(format!("OccurrenceSpecification {} not found", self.finish));
        }

        // Validate behavior reference exists
