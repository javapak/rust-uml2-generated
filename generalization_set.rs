...
pub struct GeneralizationSet {
    ...
    is_covering: bool,
    is_disjoint: bool,
    powertype: Option<String>,
    generalization: Vec<String>,
}
...
impl GeneralizationSet {
    ...
    /// Returns a clone of powertype if present
    pub fn powertype(&self) -> Option<String> {
        self.powertype.clone()
    }

    /// Sets powertype
    pub fn set_powertype(&mut self, value: String) {
        self.powertype = Some(value);
    }

    /// Takes powertype, leaving None in its place
    pub fn take_powertype(&mut self) -> Option<String> {
        self.powertype.take()
    }

    /// Returns a clone of generalization
    pub fn generalization(&self) -> Vec<String> {
        self.generalization.clone()
    }

    /// Adds an existing Generalization to generalization by ID
    pub fn add_generalization_by_id(&mut self, id: String) {
        self.generalization.push(id);
    }
