...
lazy_static! {
    static ref CREATE_LINK_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CreateLinkAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct CreateLinkAction {
...
#[wasm_bindgen]
impl CreateLinkAction {
    /// Creates a new CreateLinkAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        CREATE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CreateLinkAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CreateLinkAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CreateLinkAction by ID
    ...
    /// Checks if a CreateLinkAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CreateLinkAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CreateLinkAction> = CREATE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CreateLinkAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CREATE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CreateLinkAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CREATE_LINK_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CreateLinkAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CreateLinkAction = serde_wasm_bindgen::from_value(instance_js)
