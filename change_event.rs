...
pub struct ChangeEvent {
    ...
    change_expression: ValueSpecification,
}

impl ChangeEvent {
    pub fn new(change_expression: ValueSpecification) -> Self {
        Self {
    ...
    /// Returns a reference to change_expression
    pub fn change_expression(&self) -> &ValueSpecification {
        &self.change_expression
    }

    /// Returns a mutable reference to change_expression
    pub fn change_expression_mut(&mut self) -> &mut ValueSpecification {
        &mut self.change_expression
    }

    /// Sets change_expression
    pub fn set_change_expression(&mut self, value: ValueSpecification) {
        self.change_expression = value;
    }
...
impl Default for ChangeEvent {
    fn default() -> Self {
        Self {
            ...
            owning_template_parameter: None,
            template_parameter: None,
            change_expression: Default::default(),
        }
    }
}
