...
lazy_static! {
    static ref CHANGE_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, ChangeEvent>>> = 
...
pub struct ChangeEvent {
    ...
    pub change_expression: String,
}

#[wasm_bindgen]
impl ChangeEvent {
    /// Creates a new ChangeEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(change_expression: String) -> String {
        ...
        CHANGE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ChangeEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ChangeEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ChangeEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ChangeEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ChangeEvent> = CHANGE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ChangeEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CHANGE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ChangeEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CHANGE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ChangeEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ChangeEvent = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the change_expression reference
    #[wasm_bindgen]
    pub fn set_change_expression(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ChangeEvent = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.change_expression = ref_id;
...
impl ChangeEvent {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate change_expression reference exists
        if !ValueSpecification::exists(self.change_expression.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.change_expression));
        }
