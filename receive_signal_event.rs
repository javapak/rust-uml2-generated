...
lazy_static! {
    static ref RECEIVE_SIGNAL_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, ReceiveSignalEvent>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReceiveSignalEvent {
...
#[wasm_bindgen]
impl ReceiveSignalEvent {
    /// Creates a new ReceiveSignalEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(signal: String) -> String {
        ...
        RECEIVE_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReceiveSignalEvent by ID
    ...
    /// Updates a ReceiveSignalEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReceiveSignalEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReceiveSignalEvent by ID
    ...
    /// Checks if a ReceiveSignalEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReceiveSignalEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReceiveSignalEvent> = RECEIVE_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReceiveSignalEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        RECEIVE_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReceiveSignalEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        RECEIVE_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReceiveSignalEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReceiveSignalEvent = serde_wasm_bindgen::from_value(instance_js)
