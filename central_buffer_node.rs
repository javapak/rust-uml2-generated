...
lazy_static! {
    static ref CENTRAL_BUFFER_NODE_REGISTRY: Mutex<RefCell<HashMap<String, CentralBufferNode>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct CentralBufferNode {
...
#[wasm_bindgen]
impl CentralBufferNode {
    /// Creates a new CentralBufferNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String) -> String {
        ...
        CENTRAL_BUFFER_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CentralBufferNode by ID
    ...
    /// Updates a CentralBufferNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CentralBufferNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CentralBufferNode by ID
    ...
    /// Checks if a CentralBufferNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CentralBufferNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CentralBufferNode> = CENTRAL_BUFFER_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CentralBufferNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CENTRAL_BUFFER_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CentralBufferNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CENTRAL_BUFFER_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CentralBufferNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CentralBufferNode = serde_wasm_bindgen::from_value(instance_js)
