...
// ============================================================================
//
// Type:           StructuredClassifier (struct)
// Source Package: uml
...
lazy_static! {
    static ref STRUCTURED_CLASSIFIER_REGISTRY: Mutex<RefCell<HashMap<String, StructuredClassifier>>> = 
...
#[wasm_bindgen]
impl StructuredClassifier {
    /// Creates a new StructuredClassifier and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        STRUCTURED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a StructuredClassifier by ID
    ...
    /// Updates a StructuredClassifier instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: StructuredClassifier = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a StructuredClassifier by ID
    ...
    /// Checks if a StructuredClassifier exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StructuredClassifier instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StructuredClassifier> = STRUCTURED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StructuredClassifier instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STRUCTURED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StructuredClassifier instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STRUCTURED_CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StructuredClassifier instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StructuredClassifier = serde_wasm_bindgen::from_value(instance_js)
