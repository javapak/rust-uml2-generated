// StructuredClassifier - Generated UML Class
...
const TYPE_NAME: &str = "StructuredClassifier";
...
impl StructuredClassifier {
    /// Creates a new StructuredClassifier instance
    #[wasm_bindgen]
...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_owned_connector(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.owned_connector.len();
        instance.owned_connector.retain(|id| id != &ref_id);
        let removed = instance.owned_connector.len() < initial_len;
