...
lazy_static! {
    static ref LITERAL_INTEGER_REGISTRY: Mutex<RefCell<HashMap<String, LiteralInteger>>> = 
...
#[wasm_bindgen]
impl LiteralInteger {
    /// Creates a new LiteralInteger and returns its ID
    #[wasm_bindgen]
    pub fn create(value: String) -> String {
        ...
        LITERAL_INTEGER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a LiteralInteger instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LiteralInteger = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a LiteralInteger by ID
    ...
    /// Checks if a LiteralInteger exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LiteralInteger instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LiteralInteger> = LITERAL_INTEGER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LiteralInteger instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LITERAL_INTEGER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LiteralInteger instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LITERAL_INTEGER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LiteralInteger instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LiteralInteger = serde_wasm_bindgen::from_value(instance_js)
