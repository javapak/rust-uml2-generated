// TimeConstraint - Generated UML Class
...
const TYPE_NAME: &str = "TimeConstraint";
...
#[wasm_bindgen]
impl TimeConstraint {
    /// Creates a new TimeConstraint instance
    #[wasm_bindgen]
...
pub fn set_first_event(instance_id: String, value: String) -> Result<(), JsValue> {
    let mut instance: Self = registry::get(&instance_id)
        .ok_or_else(|| JsValue::from_str("Instance not found"))?;
    instance.first_event = Some(value);
    registry::insert(instance_id, TYPE_NAME, &instance)?;
    Ok(())
}

#[wasm_bindgen]
pub fn clear_first_event(instance_id: String) -> Result<(), JsValue> {
    let mut instance: Self = registry::get(&instance_id)
        .ok_or_else(|| JsValue::from_str("Instance not found"))?;
    instance.first_event = None;
    registry::insert(instance_id, TYPE_NAME, &instance)?;
    Ok(())
}
