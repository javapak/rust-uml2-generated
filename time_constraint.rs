...
lazy_static! {
    static ref TIME_CONSTRAINT_REGISTRY: Mutex<RefCell<HashMap<String, TimeConstraint>>> = 
...
#[wasm_bindgen]
impl TimeConstraint {
    /// Creates a new TimeConstraint and returns its ID
    #[wasm_bindgen]
    pub fn create(specification: String) -> String {
        ...
        TIME_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a TimeConstraint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TimeConstraint = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a TimeConstraint by ID
    ...
    /// Checks if a TimeConstraint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TimeConstraint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TimeConstraint> = TIME_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TimeConstraint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TIME_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TimeConstraint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TIME_CONSTRAINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TimeConstraint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TimeConstraint = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the first_event field
    #[wasm_bindgen]
    pub fn set_first_event(instance_id: String, value: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TimeConstraint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.first_event = value;
