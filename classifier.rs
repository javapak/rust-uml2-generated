...
lazy_static! {
    static ref CLASSIFIER_REGISTRY: Mutex<RefCell<HashMap<String, Classifier>>> = 
...
#[wasm_bindgen]
impl Classifier {
    /// Creates a new Classifier and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Checks if a Classifier exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Classifier instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Classifier> = CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Classifier instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Classifier instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CLASSIFIER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Classifier instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Classifier = serde_wasm_bindgen::from_value(instance_js)
