// ReadLinkObjectEndAction - Generated UML Class
...
const TYPE_NAME: &str = "ReadLinkObjectEndAction";
...
impl ReadLinkObjectEndAction {
    /// Creates a new ReadLinkObjectEndAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "ReadLinkObjectEndAction".to_string()
    }
