...
impl ReadLinkObjectEndAction {
    pub fn new(is_leaf: bool, object: InputPin, end: Rc<RefCell<Property>>, result: OutputPin) -> Self {
        Self {
...
impl Default for ReadLinkObjectEndAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadLinkObjectEndAction {
