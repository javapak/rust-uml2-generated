...
// ============================================================================
//
// Type:           ReadLinkObjectEndAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref READ_LINK_OBJECT_END_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadLinkObjectEndAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadLinkObjectEndAction {
...
#[wasm_bindgen]
impl ReadLinkObjectEndAction {
    /// Creates a new ReadLinkObjectEndAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, object: String, end: String, result: String) -> String {
        ...
        READ_LINK_OBJECT_END_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReadLinkObjectEndAction by ID
    ...
    /// Updates a ReadLinkObjectEndAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadLinkObjectEndAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadLinkObjectEndAction by ID
    ...
    /// Checks if a ReadLinkObjectEndAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadLinkObjectEndAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadLinkObjectEndAction> = READ_LINK_OBJECT_END_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadLinkObjectEndAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_LINK_OBJECT_END_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadLinkObjectEndAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_LINK_OBJECT_END_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadLinkObjectEndAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadLinkObjectEndAction = serde_wasm_bindgen::from_value(instance_js)
