...
// ============================================================================
//
// Type:           StartClassifierBehaviorAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref START_CLASSIFIER_BEHAVIOR_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, StartClassifierBehaviorAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct StartClassifierBehaviorAction {
...
#[wasm_bindgen]
impl StartClassifierBehaviorAction {
    /// Creates a new StartClassifierBehaviorAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, object: String) -> String {
        ...
        START_CLASSIFIER_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a StartClassifierBehaviorAction by ID
    ...
    /// Updates a StartClassifierBehaviorAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: StartClassifierBehaviorAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a StartClassifierBehaviorAction by ID
    ...
    /// Checks if a StartClassifierBehaviorAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StartClassifierBehaviorAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StartClassifierBehaviorAction> = START_CLASSIFIER_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StartClassifierBehaviorAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        START_CLASSIFIER_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StartClassifierBehaviorAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        START_CLASSIFIER_BEHAVIOR_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StartClassifierBehaviorAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StartClassifierBehaviorAction = serde_wasm_bindgen::from_value(instance_js)
