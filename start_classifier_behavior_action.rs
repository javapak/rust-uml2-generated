// StartClassifierBehaviorAction - Generated UML Class
...
const TYPE_NAME: &str = "StartClassifierBehaviorAction";
...
impl StartClassifierBehaviorAction {
    /// Creates a new StartClassifierBehaviorAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "StartClassifierBehaviorAction".to_string()
    }
