...
lazy_static! {
    static ref PRIMITIVE_TYPE_REGISTRY: Mutex<RefCell<HashMap<String, PrimitiveType>>> = 
...
#[wasm_bindgen]
impl PrimitiveType {
    /// Creates a new PrimitiveType and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        PRIMITIVE_TYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a PrimitiveType instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: PrimitiveType = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a PrimitiveType exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all PrimitiveType instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<PrimitiveType> = PRIMITIVE_TYPE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of PrimitiveType instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PRIMITIVE_TYPE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all PrimitiveType instances
    #[wasm_bindgen]
    pub fn clear_all() {
        PRIMITIVE_TYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds PrimitiveType instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: PrimitiveType = serde_wasm_bindgen::from_value(instance_js)
