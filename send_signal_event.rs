...
lazy_static! {
    static ref SEND_SIGNAL_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, SendSignalEvent>>> = 
...
#[wasm_bindgen]
impl SendSignalEvent {
    /// Creates a new SendSignalEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(signal: String) -> String {
        ...
        SEND_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a SendSignalEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SendSignalEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a SendSignalEvent by ID
    ...
    /// Checks if a SendSignalEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SendSignalEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SendSignalEvent> = SEND_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SendSignalEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SEND_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SendSignalEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SEND_SIGNAL_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SendSignalEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SendSignalEvent = serde_wasm_bindgen::from_value(instance_js)
