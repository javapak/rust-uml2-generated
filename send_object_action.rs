...
lazy_static! {
    static ref SEND_OBJECT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, SendObjectAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct SendObjectAction {
...
#[wasm_bindgen]
impl SendObjectAction {
    /// Creates a new SendObjectAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, target: String, request: String) -> String {
        ...
        SEND_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a SendObjectAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SendObjectAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a SendObjectAction by ID
    ...
    /// Checks if a SendObjectAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SendObjectAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SendObjectAction> = SEND_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SendObjectAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SEND_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SendObjectAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SEND_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SendObjectAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SendObjectAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_request(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: SendObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.request = ref_id;
...
impl SendObjectAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate request reference exists
        if !InputPin::exists(self.request.clone()) {
            errors.push(format!("InputPin {} not found", self.request));
        }
