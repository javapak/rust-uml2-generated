...
impl SendObjectAction {
    pub fn new(is_leaf: bool, target: InputPin, request: InputPin) -> Self {
        Self {
    ...
    /// Returns a reference to request
    pub fn request(&self) -> &InputPin {
        &self.request
    }

    /// Returns a mutable reference to request
    pub fn request_mut(&mut self) -> &mut InputPin {
        &mut self.request
    }

    /// Sets request
    pub fn set_request(&mut self, value: InputPin) {
        self.request = value;
    }

}

impl Default for SendObjectAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for SendObjectAction {
