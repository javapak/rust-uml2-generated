// SendObjectAction - Generated UML Class
...
const TYPE_NAME: &str = "SendObjectAction";
...
impl SendObjectAction {
    /// Creates a new SendObjectAction instance
    #[wasm_bindgen]
