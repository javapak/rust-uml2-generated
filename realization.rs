...
lazy_static! {
    static ref REALIZATION_REGISTRY: Mutex<RefCell<HashMap<String, Realization>>> = 
...
#[wasm_bindgen]
impl Realization {
    /// Creates a new Realization and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        REALIZATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Realization instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Realization = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Realization exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Realization instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Realization> = REALIZATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Realization instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REALIZATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Realization instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REALIZATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Realization instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Realization = serde_wasm_bindgen::from_value(instance_js)
