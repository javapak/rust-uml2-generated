...
lazy_static! {
    static ref ACCEPT_EVENT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, AcceptEventAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct AcceptEventAction {
...
#[wasm_bindgen]
impl AcceptEventAction {
    /// Creates a new AcceptEventAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_unmarshall: String) -> String {
        ...
        ACCEPT_EVENT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a AcceptEventAction by ID
    ...
    /// Updates a AcceptEventAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AcceptEventAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AcceptEventAction by ID
    ...
    /// Checks if a AcceptEventAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AcceptEventAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AcceptEventAction> = ACCEPT_EVENT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AcceptEventAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACCEPT_EVENT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AcceptEventAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACCEPT_EVENT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AcceptEventAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AcceptEventAction = serde_wasm_bindgen::from_value(instance_js)
