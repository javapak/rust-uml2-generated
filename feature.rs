...
lazy_static! {
    static ref FEATURE_REGISTRY: Mutex<RefCell<HashMap<String, Feature>>> = 
...
impl Feature {
    ...
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_static: String) -> String {
    ...
    /// Updates a Feature instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Feature = serde_wasm_bindgen::from_value(value)
    ...
    /// Gets all Feature instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Feature> = FEATURE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Feature instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        FEATURE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Feature instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Feature = serde_wasm_bindgen::from_value(instance_js)
