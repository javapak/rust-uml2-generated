// LiteralSpecification - Generated UML Class
...
const TYPE_NAME: &str = "LiteralSpecification";
...
impl LiteralSpecification {
    /// Creates a new LiteralSpecification instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "LiteralSpecification".to_string()
    }
