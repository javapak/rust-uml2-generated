...
// ============================================================================
//
// Type:           LiteralSpecification (struct)
// Source Package: uml
...
lazy_static! {
    static ref LITERAL_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, LiteralSpecification>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct LiteralSpecification {
...
#[wasm_bindgen]
impl LiteralSpecification {
    /// Creates a new LiteralSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        LITERAL_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a LiteralSpecification by ID
    ...
    /// Updates a LiteralSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LiteralSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a LiteralSpecification by ID
    ...
    /// Checks if a LiteralSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LiteralSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LiteralSpecification> = LITERAL_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LiteralSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LITERAL_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LiteralSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LITERAL_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LiteralSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LiteralSpecification = serde_wasm_bindgen::from_value(instance_js)
