...
impl AddVariableValueAction {
    pub fn new(is_leaf: bool, variable: Rc<RefCell<Variable>>, value: InputPin, is_replace_all: bool) -> Self {
        Self {
...
impl Default for AddVariableValueAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for AddVariableValueAction {
