...
// ============================================================================
//
// Type:           AddVariableValueAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref ADD_VARIABLE_VALUE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, AddVariableValueAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct AddVariableValueAction {
...
#[wasm_bindgen]
impl AddVariableValueAction {
    /// Creates a new AddVariableValueAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String, value: String, is_replace_all: String) -> String {
        ...
        ADD_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a AddVariableValueAction by ID
    ...
    /// Updates a AddVariableValueAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AddVariableValueAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AddVariableValueAction by ID
    ...
    /// Checks if a AddVariableValueAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AddVariableValueAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AddVariableValueAction> = ADD_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AddVariableValueAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ADD_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AddVariableValueAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ADD_VARIABLE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AddVariableValueAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AddVariableValueAction = serde_wasm_bindgen::from_value(instance_js)
