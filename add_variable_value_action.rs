// AddVariableValueAction - Generated UML Class
...
const TYPE_NAME: &str = "AddVariableValueAction";
...
impl AddVariableValueAction {
    /// Creates a new AddVariableValueAction instance
    #[wasm_bindgen]
...
pub fn set_is_replace_all(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "AddVariableValueAction".to_string()
    }
