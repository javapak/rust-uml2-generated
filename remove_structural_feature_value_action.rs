...
// ============================================================================
//
// Type:           RemoveStructuralFeatureValueAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, RemoveStructuralFeatureValueAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct RemoveStructuralFeatureValueAction {
    ...
    pub structural_feature: String,
    pub object: String,
    pub value: String,
    pub is_remove_duplicates: String,
    pub remove_at: Option<String>,
}

#[wasm_bindgen]
impl RemoveStructuralFeatureValueAction {
    /// Creates a new RemoveStructuralFeatureValueAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String, value: String, is_remove_duplicates: String) -> String {
        ...
        let instance = Self {
            ...
            object: object,
            value: value,
            is_remove_duplicates: is_remove_duplicates,
            remove_at: None,
        };

        REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a RemoveStructuralFeatureValueAction by ID
    ...
    /// Updates a RemoveStructuralFeatureValueAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: RemoveStructuralFeatureValueAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a RemoveStructuralFeatureValueAction by ID
    ...
    /// Checks if a RemoveStructuralFeatureValueAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all RemoveStructuralFeatureValueAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<RemoveStructuralFeatureValueAction> = REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of RemoveStructuralFeatureValueAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all RemoveStructuralFeatureValueAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds RemoveStructuralFeatureValueAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: RemoveStructuralFeatureValueAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the structural_feature reference
    #[wasm_bindgen]
    pub fn set_structural_feature(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: RemoveStructuralFeatureValueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.structural_feature = ref_id;
    ...
    /// Sets the remove_at reference
    #[wasm_bindgen]
    pub fn set_remove_at(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: RemoveStructuralFeatureValueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.remove_at = ref_id;
    ...
    /// Sets the is_remove_duplicates field
    #[wasm_bindgen]
    pub fn set_is_remove_duplicates(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: RemoveStructuralFeatureValueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_remove_duplicates = value;
...
impl RemoveStructuralFeatureValueAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate structural_feature reference exists
        if !StructuralFeature::exists(self.structural_feature.clone()) {
            errors.push(format!("StructuralFeature {} not found", self.structural_feature));
        }
        ...
        // Validate remove_at reference exists
        if let Some(id) = &self.remove_at {
