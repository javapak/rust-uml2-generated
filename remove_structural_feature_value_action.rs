...
impl RemoveStructuralFeatureValueAction {
    pub fn new(is_leaf: bool, structural_feature: String, object: InputPin, value: InputPin, is_remove_duplicates: bool) -> Self {
        Self {
    ...
    /// Returns a clone of structural_feature
    pub fn structural_feature(&self) -> String {
        self.structural_feature.clone()
    }

    /// Sets structural_feature
    pub fn set_structural_feature(&mut self, value: String) {
        self.structural_feature = value;
    }

    /// Takes ownership of structural_feature, replacing it with an empty string
    pub fn take_structural_feature(&mut self) -> String {
        std::mem::take(&mut self.structural_feature)
    }
    ...
    pub fn type_name() -> String {
        "RemoveStructuralFeatureValueAction".to_string()
    }
