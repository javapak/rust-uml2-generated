...
pub struct RemoveStructuralFeatureValueAction {
    ...
    structural_feature: Rc<RefCell<StructuralFeature>>,
    object: InputPin,
    value: InputPin,
    is_remove_duplicates: bool,
    remove_at: Option<InputPin>,
}

impl RemoveStructuralFeatureValueAction {
    pub fn new(is_leaf: bool, structural_feature: Rc<RefCell<StructuralFeature>>, object: InputPin, value: InputPin, is_remove_duplicates: bool) -> Self {
        Self {
    ...
    /// Returns a reference to structural_feature
    pub fn structural_feature(&self) -> &Rc<RefCell<StructuralFeature>> {
        &self.structural_feature
    }

    /// Returns a mutable reference to structural_feature
    pub fn structural_feature_mut(&mut self) -> &mut Rc<RefCell<StructuralFeature>> {
        &mut self.structural_feature
    }

    /// Sets structural_feature
    pub fn set_structural_feature(&mut self, value: Rc<RefCell<StructuralFeature>>) {
        self.structural_feature = value;
    }

    /// Returns a reference to object
    pub fn object(&self) -> &InputPin {
        &self.object
    }

    /// Returns a mutable reference to object
    pub fn object_mut(&mut self) -> &mut InputPin {
        &mut self.object
    }

    /// Sets object
    pub fn set_object(&mut self, value: InputPin) {
        self.object = value;
    }

    /// Returns a reference to value
    pub fn value(&self) -> &InputPin {
        &self.value
    }

    /// Returns a mutable reference to value
    pub fn value_mut(&mut self) -> &mut InputPin {
        &mut self.value
    }

    /// Sets value
    pub fn set_value(&mut self, value: InputPin) {
        self.value = value;
    }

    /// Returns is_remove_duplicates
    pub fn is_remove_duplicates(&self) -> bool {
        self.is_remove_duplicates
    }

    /// Sets is_remove_duplicates
    pub fn set_is_remove_duplicates(&mut self, value: bool) {
        self.is_remove_duplicates = value;
    }

    /// Returns a reference to remove_at if present
    pub fn remove_at(&self) -> Option<&InputPin> {
        self.remove_at.as_ref()
    }

    /// Returns a mutable reference to remove_at if present
    pub fn remove_at_mut(&mut self) -> Option<&mut InputPin> {
        self.remove_at.as_mut()
    }

    /// Sets remove_at
    pub fn set_remove_at(&mut self, value: InputPin) {
        self.remove_at = Some(value);
    }

    /// Takes remove_at, leaving None in its place
    pub fn take_remove_at(&mut self) -> Option<InputPin> {
        self.remove_at.take()
    }

}

impl Default for RemoveStructuralFeatureValueAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
            ...
            local_precondition: Vec::new(),
            local_postcondition: Vec::new(),
            structural_feature: Default::default(),
...
impl std::fmt::Display for RemoveStructuralFeatureValueAction {
