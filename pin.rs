...
lazy_static! {
    static ref PIN_REGISTRY: Mutex<RefCell<HashMap<String, Pin>>> = 
...
#[wasm_bindgen]
impl Pin {
    /// Creates a new Pin and returns its ID
    #[wasm_bindgen]
    ...
    /// Updates a Pin instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Pin = serde_wasm_bindgen::from_value(value)
    ...
    /// Gets all Pin instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Pin> = PIN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Pin instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PIN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Pin instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Pin = serde_wasm_bindgen::from_value(instance_js)
