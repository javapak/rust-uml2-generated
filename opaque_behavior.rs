...
lazy_static! {
    static ref OPAQUE_BEHAVIOR_REGISTRY: Mutex<RefCell<HashMap<String, OpaqueBehavior>>> = 
...
#[wasm_bindgen]
impl OpaqueBehavior {
    /// Creates a new OpaqueBehavior and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_active: String, is_reentrant: String) -> String {
        ...
        OPAQUE_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a OpaqueBehavior instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: OpaqueBehavior = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a OpaqueBehavior by ID
    ...
    /// Checks if a OpaqueBehavior exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all OpaqueBehavior instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<OpaqueBehavior> = OPAQUE_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of OpaqueBehavior instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OPAQUE_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all OpaqueBehavior instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OPAQUE_BEHAVIOR_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds OpaqueBehavior instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: OpaqueBehavior = serde_wasm_bindgen::from_value(instance_js)
