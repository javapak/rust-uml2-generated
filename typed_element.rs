...
lazy_static! {
    static ref TYPED_ELEMENT_REGISTRY: Mutex<RefCell<HashMap<String, TypedElement>>> = 
...
#[wasm_bindgen]
impl TypedElement {
    /// Creates a new TypedElement and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        TYPED_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a TypedElement instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TypedElement = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a TypedElement exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TypedElement instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TypedElement> = TYPED_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TypedElement instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TYPED_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TypedElement instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TYPED_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TypedElement instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TypedElement = serde_wasm_bindgen::from_value(instance_js)
