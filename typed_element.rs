// TypedElement - Generated UML Class
...
const TYPE_NAME: &str = "TypedElement";
...
#[wasm_bindgen]
impl TypedElement {
    /// Creates a new TypedElement instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    #[wasm_bindgen]
    pub fn clear_type_(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.type_.is_none() {
            return Ok(false);
        }
