...
lazy_static! {
    static ref NAMESPACE_REGISTRY: Mutex<RefCell<HashMap<String, Namespace>>> = 
...
impl Namespace {
    ...
    pub fn create() -> String {
        ...
        NAMESPACE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Checks if a Namespace exists by ID
    #[wasm_bindgen]
    ...
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Namespace> = NAMESPACE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Namespace instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        NAMESPACE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Namespace instances
    #[wasm_bindgen]
    pub fn clear_all() {
        NAMESPACE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Namespace instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Namespace = serde_wasm_bindgen::from_value(instance_js)
