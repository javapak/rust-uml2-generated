...
lazy_static! {
    static ref OBJECT_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ObjectNode>>> = 
...
#[wasm_bindgen]
impl ObjectNode {
    /// Creates a new ObjectNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String) -> String {
        ...
        OBJECT_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ObjectNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ObjectNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ObjectNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ObjectNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ObjectNode> = OBJECT_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ObjectNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OBJECT_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ObjectNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OBJECT_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ObjectNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ObjectNode = serde_wasm_bindgen::from_value(instance_js)
