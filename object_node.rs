// ObjectNode - Generated UML Class
...
const TYPE_NAME: &str = "ObjectNode";
...
pub fn set_is_control_type(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_upper_bound(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.upper_bound = ref_id.clone();
    ...
    pub fn remove_in_state(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.in_state.len();
        instance.in_state.retain(|id| id != &ref_id);
        let removed = instance.in_state.len() < initial_len;
    ...
    pub fn set_selection(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        instance.selection = ref_id.clone();
    ...
    #[wasm_bindgen]
    pub fn clear_selection(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.selection.is_none() {
            return Ok(false);
        }
