...
lazy_static! {
    static ref FORK_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ForkNode>>> = 
...
#[wasm_bindgen]
impl ForkNode {
    /// Creates a new ForkNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        FORK_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ForkNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ForkNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ForkNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ForkNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ForkNode> = FORK_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ForkNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        FORK_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ForkNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        FORK_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ForkNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ForkNode = serde_wasm_bindgen::from_value(instance_js)
