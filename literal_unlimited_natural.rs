// LiteralUnlimitedNatural - Generated UML Class
...
const TYPE_NAME: &str = "LiteralUnlimitedNatural";
...
impl LiteralUnlimitedNatural {
    /// Creates a new LiteralUnlimitedNatural instance
    #[wasm_bindgen]
...
pub fn set_value(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn type_name() -> String {
        "LiteralUnlimitedNatural".to_string()
    }
