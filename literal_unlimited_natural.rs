...
// ============================================================================
//
// Type:           LiteralUnlimitedNatural (struct)
// Source Package: uml
...
lazy_static! {
    static ref LITERAL_UNLIMITED_NATURAL_REGISTRY: Mutex<RefCell<HashMap<String, LiteralUnlimitedNatural>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct LiteralUnlimitedNatural {
...
#[wasm_bindgen]
impl LiteralUnlimitedNatural {
    /// Creates a new LiteralUnlimitedNatural and returns its ID
    #[wasm_bindgen]
    pub fn create(value: String) -> String {
        ...
        LITERAL_UNLIMITED_NATURAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a LiteralUnlimitedNatural by ID
    ...
    /// Updates a LiteralUnlimitedNatural instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LiteralUnlimitedNatural = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a LiteralUnlimitedNatural by ID
    ...
    /// Checks if a LiteralUnlimitedNatural exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LiteralUnlimitedNatural instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LiteralUnlimitedNatural> = LITERAL_UNLIMITED_NATURAL_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LiteralUnlimitedNatural instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LITERAL_UNLIMITED_NATURAL_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LiteralUnlimitedNatural instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LITERAL_UNLIMITED_NATURAL_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LiteralUnlimitedNatural instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LiteralUnlimitedNatural = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_value(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: LiteralUnlimitedNatural = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
