...
lazy_static! {
    static ref JOIN_NODE_REGISTRY: Mutex<RefCell<HashMap<String, JoinNode>>> = 
...
pub struct JoinNode {
    ...
    pub is_combine_duplicate: String,
    pub join_spec: String,
}

#[wasm_bindgen]
impl JoinNode {
    /// Creates a new JoinNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_combine_duplicate: String, join_spec: String) -> String {
        ...
        let instance = Self {
            ...
            is_combine_duplicate: is_combine_duplicate,
            join_spec: join_spec,
        };

        JOIN_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a JoinNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: JoinNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a JoinNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all JoinNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<JoinNode> = JOIN_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of JoinNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        JOIN_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all JoinNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        JOIN_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds JoinNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: JoinNode = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the join_spec reference
    #[wasm_bindgen]
    pub fn set_join_spec(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: JoinNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.join_spec = ref_id;
    ...
    /// Sets the is_combine_duplicate field
    #[wasm_bindgen]
    pub fn set_is_combine_duplicate(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: JoinNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_combine_duplicate = value;
...
impl JoinNode {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate join_spec reference exists
        if !ValueSpecification::exists(self.join_spec.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.join_spec));
        }
