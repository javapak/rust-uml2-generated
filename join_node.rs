...
pub struct JoinNode {
    ...
    is_combine_duplicate: bool,
    join_spec: ValueSpecification,
}

impl JoinNode {
    pub fn new(is_leaf: bool, is_combine_duplicate: bool, join_spec: ValueSpecification) -> Self {
        Self {
    ...
    /// Returns is_combine_duplicate
    pub fn is_combine_duplicate(&self) -> bool {
        self.is_combine_duplicate
    }

    /// Sets is_combine_duplicate
    pub fn set_is_combine_duplicate(&mut self, value: bool) {
        self.is_combine_duplicate = value;
    }

    /// Returns a reference to join_spec
    pub fn join_spec(&self) -> &ValueSpecification {
        &self.join_spec
    }

    /// Returns a mutable reference to join_spec
    pub fn join_spec_mut(&mut self) -> &mut ValueSpecification {
        &mut self.join_spec
    }

    /// Sets join_spec
    pub fn set_join_spec(&mut self, value: ValueSpecification) {
        self.join_spec = value;
    }
...
impl Default for JoinNode {
    fn default() -> Self {
        Self {
            ...
            in_interruptible_region: Vec::new(),
            redefined_node: Vec::new(),
            is_combine_duplicate: false,
            join_spec: Default::default(),
        }
    }
}
