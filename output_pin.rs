...
lazy_static! {
    static ref OUTPUT_PIN_REGISTRY: Mutex<RefCell<HashMap<String, OutputPin>>> = 
...
#[wasm_bindgen]
impl OutputPin {
    /// Creates a new OutputPin and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String, is_ordered: String, is_unique: String, is_control: String) -> String {
        ...
        OUTPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a OutputPin instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: OutputPin = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a OutputPin exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all OutputPin instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<OutputPin> = OUTPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of OutputPin instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OUTPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all OutputPin instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OUTPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds OutputPin instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: OutputPin = serde_wasm_bindgen::from_value(instance_js)
