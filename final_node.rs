...
lazy_static! {
    static ref FINAL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, FinalNode>>> = 
...
#[wasm_bindgen]
impl FinalNode {
    /// Creates a new FinalNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a FinalNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: FinalNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a FinalNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all FinalNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<FinalNode> = FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of FinalNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all FinalNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        FINAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds FinalNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: FinalNode = serde_wasm_bindgen::from_value(instance_js)
