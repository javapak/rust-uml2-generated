...
pub struct ParameterSet {
    ...
    parameter: Vec<Rc<RefCell<Parameter>>>,
    condition: Vec<Constraint>,
}

impl ParameterSet {
    pub fn new(parameter: Vec<Rc<RefCell<Parameter>>>) -> Self {
        Self {
    ...
    pub fn parameter(&self) -> &Vec<Rc<RefCell<Parameter>>> {
        &self.parameter
    }

    /// Returns a mutable reference to parameter
    pub fn parameter_mut(&mut self) -> &mut Vec<Rc<RefCell<Parameter>>> {
        &mut self.parameter
    }

    /// Adds an item to parameter
    pub fn add_parameter(&mut self, item: Rc<RefCell<Parameter>>) {
    ...
    /// Returns a slice of condition
    pub fn condition(&self) -> &[Constraint] {
        &self.condition
    }

    /// Returns a mutable reference to condition
    pub fn condition_mut(&mut self) -> &mut Vec<Constraint> {
        &mut self.condition
    }

    /// Adds an item to condition
    pub fn add_condition(&mut self, item: Constraint) {
        self.condition.push(item);
    }

    /// Clears all items from condition
