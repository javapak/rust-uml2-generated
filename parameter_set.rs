...
lazy_static! {
    static ref PARAMETER_SET_REGISTRY: Mutex<RefCell<HashMap<String, ParameterSet>>> = 
...
#[wasm_bindgen]
impl ParameterSet {
    /// Creates a new ParameterSet and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        PARAMETER_SET_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ParameterSet instance
    ...
    /// Checks if a ParameterSet exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ParameterSet instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ParameterSet> = PARAMETER_SET_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ParameterSet instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PARAMETER_SET_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ParameterSet instances
    #[wasm_bindgen]
    pub fn clear_all() {
        PARAMETER_SET_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ParameterSet instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ParameterSet = serde_wasm_bindgen::from_value(instance_js)
    ...
    pub fn add_parameter(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Ok(target_js) = Parameter::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<Parameter>(target_js) {
                if !target.parameter_set.contains(&instance_id) {
                    target.parameter_set.push(instance_id);
                }
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = Parameter::update(target_js);
                }
            }
        }
    ...
    /// Removes a Parameter from parameter
    #[wasm_bindgen]
    pub fn remove_parameter(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Ok(target_js) = Parameter::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<Parameter>(target_js) {
                target.parameter_set.retain(|x| x != &instance_id);
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
                    let _ = Parameter::update(target_js);
                }
            }
    ...
    /// Clears all Parameter from parameter
    #[wasm_bindgen]
    ...
    /// Adds a Constraint to condition
    #[wasm_bindgen]
    ...
    /// Removes a Constraint from condition
    #[wasm_bindgen]
    pub fn remove_condition(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(pos) = instance.condition.iter().position(|x| x == &ref_id) {
            instance.condition.remove(pos);
    ...
    /// Clears all Constraint from condition
    #[wasm_bindgen]
...
impl ParameterSet {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all condition references exist
        for id in &self.condition {
