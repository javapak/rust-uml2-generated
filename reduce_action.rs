...
impl ReduceAction {
    pub fn new(is_leaf: bool, reducer: Rc<RefCell<Behavior>>, result: OutputPin, collection: InputPin, is_ordered: bool) -> Self {
        Self {
    ...
    /// Returns a reference to reducer
    pub fn reducer(&self) -> &Rc<RefCell<Behavior>> {
        &self.reducer
    }

    /// Returns a mutable reference to reducer
    pub fn reducer_mut(&mut self) -> &mut Rc<RefCell<Behavior>> {
        &mut self.reducer
    }

    /// Sets reducer
    pub fn set_reducer(&mut self, value: Rc<RefCell<Behavior>>) {
        self.reducer = value;
    }
    ...
    /// Returns a reference to collection
    pub fn collection(&self) -> &InputPin {
        &self.collection
    }

    /// Returns a mutable reference to collection
    pub fn collection_mut(&mut self) -> &mut InputPin {
        &mut self.collection
    }

    /// Sets collection
    pub fn set_collection(&mut self, value: InputPin) {
...
impl std::fmt::Display for ReduceAction {
