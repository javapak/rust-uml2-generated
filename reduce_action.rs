...
lazy_static! {
    static ref REDUCE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReduceAction>>> = 
...
#[wasm_bindgen]
impl ReduceAction {
    /// Creates a new ReduceAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, reducer: String, result: String, collection: String, is_ordered: String) -> String {
        ...
        REDUCE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ReduceAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReduceAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a ReduceAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReduceAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReduceAction> = REDUCE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReduceAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REDUCE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReduceAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REDUCE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReduceAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReduceAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the reducer reference
    #[wasm_bindgen]
    pub fn set_reducer(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReduceAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.reducer = ref_id;
    ...
    #[wasm_bindgen]
    pub fn set_collection(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReduceAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.collection = ref_id;
...
impl ReduceAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate reducer reference exists
        if !Behavior::exists(self.reducer.clone()) {
            errors.push(format!("Behavior {} not found", self.reducer));
        }
        ...
        // Validate collection reference exists
        if !InputPin::exists(self.collection.clone()) {
            errors.push(format!("InputPin {} not found", self.collection));
        }
