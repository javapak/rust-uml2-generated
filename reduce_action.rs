...
#[wasm_bindgen]
impl ReduceAction {
    pub fn new(is_leaf: bool, reducer: String, result: OutputPin, collection: InputPin, is_ordered: bool) -> Self {
        Self {
    ...
    /// Returns a clone of reducer
    pub fn reducer(&self) -> String {
        self.reducer.clone()
    }

    /// Sets reducer
    pub fn set_reducer(&mut self, value: String) {
        self.reducer = value;
    }

    /// Takes ownership of reducer, replacing it with an empty string
    pub fn take_reducer(&mut self) -> String {
