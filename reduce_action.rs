// ReduceAction - Generated UML Class
...
const TYPE_NAME: &str = "ReduceAction";
...
#[wasm_bindgen]
impl ReduceAction {
    /// Creates a new ReduceAction instance
    #[wasm_bindgen]
...
pub fn set_is_ordered(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_collection(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.collection = ref_id.clone();
