// OccurrenceSpecification - Generated UML Class
...
const TYPE_NAME: &str = "OccurrenceSpecification";
...
impl OccurrenceSpecification {
    /// Creates a new OccurrenceSpecification instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn add_to_before(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<GeneralOrdering>(&ref_id) {
            target.after = instance_id.clone();
            let _ = registry::insert(ref_id.clone(), "GeneralOrdering", &target);
        }
    ...
    pub fn remove_to_before(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.to_before.len();
        instance.to_before.retain(|id| id != &ref_id);
        let removed = instance.to_before.len() < initial_len;
        ...
        // Update opposite reference
        if let Some(target) = registry::get::<GeneralOrdering>(&ref_id) {
            let _ = registry::insert(ref_id.clone(), "GeneralOrdering", &target);
        }
    ...
    pub fn add_to_after(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        // Update opposite reference
        if let Some(mut target) = registry::get::<GeneralOrdering>(&ref_id) {
            target.before = instance_id.clone();
            let _ = registry::insert(ref_id.clone(), "GeneralOrdering", &target);
        }
    ...
    pub fn remove_to_after(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.to_after.len();
        instance.to_after.retain(|id| id != &ref_id);
        let removed = instance.to_after.len() < initial_len;
    ...
    pub fn type_name() -> String {
        "OccurrenceSpecification".to_string()
    }
