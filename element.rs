...
lazy_static! {
    static ref ELEMENT_REGISTRY: Mutex<RefCell<HashMap<String, Element>>> = 
...
impl Element {
    ...
    /// Updates a Element instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Element = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Element exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Element instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Element> = ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Element instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Element = serde_wasm_bindgen::from_value(instance_js)
