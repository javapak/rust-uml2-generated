...
impl Element {
    ...
    pub fn remove_owned_comment(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.owned_comment.len();
        instance.owned_comment.retain(|id| id != &ref_id);
        let removed = instance.owned_comment.len() < initial_len;
