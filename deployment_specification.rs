...
pub struct DeploymentSpecification {
    ...
    deployment: Option<Weak<RefCell<Deployment>>>,
}
...
impl DeploymentSpecification {
    ...
    /// Returns a reference to file_name if present
    pub fn file_name(&self) -> Option<&String> {
        self.file_name.as_ref()
    }

    /// Returns a mutable reference to file_name if present
    ...
    /// Returns a slice of nested_artifact
    pub fn nested_artifact(&self) -> &[Artifact] {
        &self.nested_artifact
    }

    /// Returns a mutable reference to nested_artifact
    pub fn nested_artifact_mut(&mut self) -> &mut Vec<Artifact> {
        &mut self.nested_artifact
    }

    /// Adds an item to nested_artifact
    pub fn add_nested_artifact(&mut self, item: Artifact) {
        self.nested_artifact.push(item);
    }

    /// Clears all items from nested_artifact
    pub fn clear_nested_artifact(&mut self) {
        self.nested_artifact.clear();
    }

    /// Returns a slice of manifestation
    pub fn manifestation(&self) -> &[Manifestation] {
        &self.manifestation
    }

    /// Returns a mutable reference to manifestation
    pub fn manifestation_mut(&mut self) -> &mut Vec<Manifestation> {
        &mut self.manifestation
    }

    /// Adds an item to manifestation
    pub fn add_manifestation(&mut self, item: Manifestation) {
        self.manifestation.push(item);
    }

    /// Clears all items from manifestation
    pub fn clear_manifestation(&mut self) {
    ...
    /// Returns a reference to deployment_location if present
    pub fn deployment_location(&self) -> Option<&String> {
        self.deployment_location.as_ref()
    }

    /// Returns a mutable reference to deployment_location if present
    pub fn deployment_location_mut(&mut self) -> Option<&mut String> {
        self.deployment_location.as_mut()
    }
    ...
    /// Returns a reference to execution_location if present
    pub fn execution_location(&self) -> Option<&String> {
        self.execution_location.as_ref()
    }

    /// Returns a mutable reference to execution_location if present
    pub fn execution_location_mut(&mut self) -> Option<&mut String> {
        self.execution_location.as_mut()
    }
    ...
    /// Returns a reference to deployment if present
    pub fn deployment(&self) -> Option<&Weak<RefCell<Deployment>>> {
        self.deployment.as_ref()
    }

    /// Returns a mutable reference to deployment if present
    pub fn deployment_mut(&mut self) -> Option<&mut Weak<RefCell<Deployment>>> {
        self.deployment.as_mut()
    }

    /// Sets deployment
    pub fn set_deployment(&mut self, value: Weak<RefCell<Deployment>>) {
        self.deployment = Some(value);
    }

    /// Takes deployment, leaving None in its place
    pub fn take_deployment(&mut self) -> Option<Weak<RefCell<Deployment>>> {
