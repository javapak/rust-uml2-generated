...
lazy_static! {
    static ref CLASSIFIER_TEMPLATE_PARAMETER_REGISTRY: Mutex<RefCell<HashMap<String, ClassifierTemplateParameter>>> = 
...
pub struct ClassifierTemplateParameter {
    ...
    pub allow_substitutable: String,
    pub default_classifier: Option<String>,
    pub constraining_classifier: Option<String>,
}

#[wasm_bindgen]
impl ClassifierTemplateParameter {
    /// Creates a new ClassifierTemplateParameter and returns its ID
    #[wasm_bindgen]
    pub fn create(signature: String, parametered_element: String, allow_substitutable: String) -> String {
        ...
        CLASSIFIER_TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ClassifierTemplateParameter by ID
    ...
    /// Updates a ClassifierTemplateParameter instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ClassifierTemplateParameter = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ClassifierTemplateParameter by ID
    ...
    /// Checks if a ClassifierTemplateParameter exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ClassifierTemplateParameter instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ClassifierTemplateParameter> = CLASSIFIER_TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ClassifierTemplateParameter instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CLASSIFIER_TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ClassifierTemplateParameter instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CLASSIFIER_TEMPLATE_PARAMETER_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ClassifierTemplateParameter = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the default_classifier reference
    #[wasm_bindgen]
    pub fn set_default_classifier(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ClassifierTemplateParameter = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.default_classifier = ref_id;
    ...
    /// Sets the constraining_classifier reference
    #[wasm_bindgen]
    pub fn set_constraining_classifier(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ClassifierTemplateParameter = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.constraining_classifier = ref_id;
    ...
    /// Sets the allow_substitutable field
    #[wasm_bindgen]
    pub fn set_allow_substitutable(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ClassifierTemplateParameter = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.allow_substitutable = value;
...
impl ClassifierTemplateParameter {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate default_classifier reference exists
        if let Some(id) = &self.default_classifier {
            if !Classifier::exists(id.clone()) {
                errors.push(format!("Classifier {} not found", id));
            }
        }

        // Validate constraining_classifier reference exists
        if let Some(id) = &self.constraining_classifier {
            if !Classifier::exists(id.clone()) {
                errors.push(format!("Classifier {} not found", id));
            }
        }
