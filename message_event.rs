...
lazy_static! {
    static ref MESSAGE_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, MessageEvent>>> = 
...
#[wasm_bindgen]
impl MessageEvent {
    /// Creates a new MessageEvent and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        MESSAGE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a MessageEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: MessageEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a MessageEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all MessageEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<MessageEvent> = MESSAGE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of MessageEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        MESSAGE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all MessageEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        MESSAGE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds MessageEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: MessageEvent = serde_wasm_bindgen::from_value(instance_js)
