// ConditionalNode - Generated UML Class
...
const TYPE_NAME: &str = "ConditionalNode";
...
impl ConditionalNode {
    /// Creates a new ConditionalNode instance
    #[wasm_bindgen]
...
pub fn set_is_assured(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_clause(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.clause.len();
        instance.clause.retain(|id| id != &ref_id);
        let removed = instance.clause.len() < initial_len;
    ...
    pub fn remove_result(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.result.len();
        instance.result.retain(|id| id != &ref_id);
        let removed = instance.result.len() < initial_len;
