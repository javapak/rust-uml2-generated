...
impl ConditionalNode {
    ...
    /// Returns a slice of clause
    pub fn clause(&self) -> &[Clause] {
        &self.clause
    }

    /// Returns a mutable reference to clause
    pub fn clause_mut(&mut self) -> &mut Vec<Clause> {
        &mut self.clause
    }

    /// Adds an item to clause
    pub fn add_clause(&mut self, item: Clause) {
        self.clause.push(item);
    }

    /// Clears all items from clause
    pub fn clear_clause(&mut self) {
        self.clause.clear();
    }
