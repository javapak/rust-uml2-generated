...
lazy_static! {
    static ref CONDITIONAL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, ConditionalNode>>> = 
...
pub struct ConditionalNode {
    ...
    pub node: Vec<String>,
    pub is_determinate: String,
    pub is_assured: String,
...
impl ConditionalNode {
    /// Creates a new ConditionalNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, must_isolate: String, is_determinate: String, is_assured: String) -> String {
        ...
        CONDITIONAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ConditionalNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ConditionalNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ConditionalNode by ID
    ...
    /// Checks if a ConditionalNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ConditionalNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ConditionalNode> = CONDITIONAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ConditionalNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONDITIONAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ConditionalNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONDITIONAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ConditionalNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a Clause to clause
    #[wasm_bindgen]
    pub fn add_clause(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.clause.contains(&ref_id) {
            return Ok(false);
        }

        instance.clause.push(ref_id.clone());
    ...
    /// Removes a Clause from clause
    #[wasm_bindgen]
    pub fn remove_clause(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.clause.iter().position(|x| x == &ref_id) {
            instance.clause.remove(pos);
    ...
    /// Clears all Clause from clause
    #[wasm_bindgen]
    pub fn clear_clause(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.clause.len();
    ...
    /// Sets the is_determinate field
    #[wasm_bindgen]
    pub fn set_is_determinate(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_determinate = value;
    ...
    /// Sets the is_assured field
    #[wasm_bindgen]
    pub fn set_is_assured(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConditionalNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_assured = value;
...
impl ConditionalNode {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all clause references exist
        for id in &self.clause {
