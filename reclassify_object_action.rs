...
pub struct ReclassifyObjectAction {
    ...
    is_replace_all: bool,
    old_classifier: Vec<String>,
    new_classifier: Vec<String>,
    object: InputPin,
}
...
impl ReclassifyObjectAction {
    ...
    /// Returns a clone of old_classifier
    pub fn old_classifier(&self) -> Vec<String> {
        self.old_classifier.clone()
    }

    /// Adds an existing Classifier to old_classifier by ID
    pub fn add_old_classifier_by_id(&mut self, id: String) {
        self.old_classifier.push(id);
    }
    ...
    /// Returns a clone of new_classifier
    pub fn new_classifier(&self) -> Vec<String> {
        self.new_classifier.clone()
    }

    /// Adds an existing Classifier to new_classifier by ID
    pub fn add_new_classifier_by_id(&mut self, id: String) {
        self.new_classifier.push(id);
    }
