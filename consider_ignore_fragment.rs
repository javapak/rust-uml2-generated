...
lazy_static! {
    static ref CONSIDER_IGNORE_FRAGMENT_REGISTRY: Mutex<RefCell<HashMap<String, ConsiderIgnoreFragment>>> = 
...
impl ConsiderIgnoreFragment {
    /// Creates a new ConsiderIgnoreFragment and returns its ID
    #[wasm_bindgen]
    pub fn create(interaction_operator: InteractionOperatorKind) -> String {
        ...
        CONSIDER_IGNORE_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ConsiderIgnoreFragment by ID
    ...
    /// Updates a ConsiderIgnoreFragment instance
    ...
    /// Deletes a ConsiderIgnoreFragment by ID
    ...
    /// Checks if a ConsiderIgnoreFragment exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ConsiderIgnoreFragment instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ConsiderIgnoreFragment> = CONSIDER_IGNORE_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ConsiderIgnoreFragment instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONSIDER_IGNORE_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ConsiderIgnoreFragment instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONSIDER_IGNORE_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ConsiderIgnoreFragment instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a InteractionOperand to operand
    #[wasm_bindgen]
    pub fn add_operand(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.operand.contains(&ref_id) {
            return Ok(false);
        }

        instance.operand.push(ref_id.clone());
    ...
    /// Removes a InteractionOperand from operand
    #[wasm_bindgen]
    pub fn remove_operand(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.operand.iter().position(|x| x == &ref_id) {
            instance.operand.remove(pos);
    ...
    /// Clears all InteractionOperand from operand
    #[wasm_bindgen]
    pub fn clear_operand(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.operand.len();

        instance.operand.clear();
    ...
    /// Adds a Gate to cfragment_gate
    #[wasm_bindgen]
    pub fn add_cfragment_gate(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.cfragment_gate.contains(&ref_id) {
            return Ok(false);
        }

        instance.cfragment_gate.push(ref_id.clone());
    ...
    /// Removes a Gate from cfragment_gate
    #[wasm_bindgen]
    pub fn remove_cfragment_gate(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.cfragment_gate.iter().position(|x| x == &ref_id) {
            instance.cfragment_gate.remove(pos);
    ...
    /// Clears all Gate from cfragment_gate
    #[wasm_bindgen]
    pub fn clear_cfragment_gate(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ConsiderIgnoreFragment = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.cfragment_gate.len();

        instance.cfragment_gate.clear();
    ...
    /// Adds a NamedElement to message
    #[wasm_bindgen]
    ...
    /// Removes a NamedElement from message
    #[wasm_bindgen]
    ...
    /// Clears all NamedElement from message
    #[wasm_bindgen]
    ...
    /// Sets the interaction_operator field
    #[wasm_bindgen]
...
impl ConsiderIgnoreFragment {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all operand references exist
        for id in &self.operand {
            if !InteractionOperand::exists(id.clone()) {
                errors.push(format!("InteractionOperand {} not found", id));
            }
        }

        // Validate all cfragment_gate references exist
        for id in &self.cfragment_gate {
