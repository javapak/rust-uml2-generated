...
pub struct ExpansionNode {
    ...
    region_as_output: Option<Rc<RefCell<ExpansionRegion>>>,
    region_as_input: Option<Rc<RefCell<ExpansionRegion>>>,
}

impl ExpansionNode {
    pub fn new(is_leaf: bool, ordering: String, is_control_type: bool, upper_bound: ValueSpecification) -> Self {
        Self {
    ...
    /// Returns a reference to region_as_output if present
    pub fn region_as_output(&self) -> Option<&Rc<RefCell<ExpansionRegion>>> {
        self.region_as_output.as_ref()
    }

    /// Returns a mutable reference to region_as_output if present
    pub fn region_as_output_mut(&mut self) -> Option<&mut Rc<RefCell<ExpansionRegion>>> {
        self.region_as_output.as_mut()
    }

    /// Sets region_as_output
    pub fn set_region_as_output(&mut self, value: Rc<RefCell<ExpansionRegion>>) {
        self.region_as_output = Some(value);
    }

    /// Takes region_as_output, leaving None in its place
    pub fn take_region_as_output(&mut self) -> Option<Rc<RefCell<ExpansionRegion>>> {
        self.region_as_output.take()
    }

    /// Returns a reference to region_as_input if present
    pub fn region_as_input(&self) -> Option<&Rc<RefCell<ExpansionRegion>>> {
        self.region_as_input.as_ref()
    }

    /// Returns a mutable reference to region_as_input if present
    pub fn region_as_input_mut(&mut self) -> Option<&mut Rc<RefCell<ExpansionRegion>>> {
        self.region_as_input.as_mut()
    }

    /// Sets region_as_input
    pub fn set_region_as_input(&mut self, value: Rc<RefCell<ExpansionRegion>>) {
        self.region_as_input = Some(value);
    }

    /// Takes region_as_input, leaving None in its place
    pub fn take_region_as_input(&mut self) -> Option<Rc<RefCell<ExpansionRegion>>> {
        self.region_as_input.take()
    }

}

impl Default for ExpansionNode {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ExpansionNode {
