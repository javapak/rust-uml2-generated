...
pub struct ExpansionNode {
    ...
    region_as_output: Option<String>,
    region_as_input: Option<String>,
}
...
impl ExpansionNode {
    ...
    /// Returns a clone of region_as_output if present
    pub fn region_as_output(&self) -> Option<String> {
        self.region_as_output.clone()
    }

    /// Sets region_as_output
    pub fn set_region_as_output(&mut self, value: String) {
        self.region_as_output = Some(value);
    }

    /// Takes region_as_output, leaving None in its place
    pub fn take_region_as_output(&mut self) -> Option<String> {
        self.region_as_output.take()
    }

    /// Returns a clone of region_as_input if present
    pub fn region_as_input(&self) -> Option<String> {
        self.region_as_input.clone()
    }

    /// Sets region_as_input
    pub fn set_region_as_input(&mut self, value: String) {
        self.region_as_input = Some(value);
    }

    /// Takes region_as_input, leaving None in its place
    pub fn take_region_as_input(&mut self) -> Option<String> {
