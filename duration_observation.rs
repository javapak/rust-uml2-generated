...
lazy_static! {
    static ref DURATION_OBSERVATION_REGISTRY: Mutex<RefCell<HashMap<String, DurationObservation>>> = 
...
impl DurationObservation {
    /// Creates a new DurationObservation and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DURATION_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a DurationObservation by ID
    ...
    /// Updates a DurationObservation instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DurationObservation = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DurationObservation by ID
    ...
    /// Checks if a DurationObservation exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DurationObservation instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DurationObservation> = DURATION_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DurationObservation instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DURATION_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DurationObservation instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DURATION_OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DurationObservation instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DurationObservation = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a NamedElement to event
    #[wasm_bindgen]
    pub fn add_event(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DurationObservation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.event.contains(&ref_id) {
            return Ok(false);
        }

        instance.event.push(ref_id.clone());
    ...
    /// Removes a NamedElement from event
    #[wasm_bindgen]
    pub fn remove_event(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DurationObservation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.event.iter().position(|x| x == &ref_id) {
            instance.event.remove(pos);
    ...
    /// Clears all NamedElement from event
    #[wasm_bindgen]
    pub fn clear_event(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: DurationObservation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.event.len();
