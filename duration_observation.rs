...
pub struct DurationObservation {
    ...
    event: Vec<Rc<RefCell<NamedElement>>>,
    first_event: Vec<bool>,
}

impl DurationObservation {
    pub fn new(event: Vec<Rc<RefCell<NamedElement>>>) -> Self {
        Self {
    ...
    pub fn event(&self) -> &Vec<Rc<RefCell<NamedElement>>> {
        &self.event
    }

    /// Returns a mutable reference to event
    pub fn event_mut(&mut self) -> &mut Vec<Rc<RefCell<NamedElement>>> {
        &mut self.event
    }

    /// Adds an item to event
    pub fn add_event(&mut self, item: Rc<RefCell<NamedElement>>) {
        self.event.push(item);
    }

    /// Clears all items from event
    pub fn clear_event(&mut self) {
        self.event.clear();
    }

    /// Returns a slice of first_event
    pub fn first_event(&self) -> &[bool] {
        &self.first_event
    }

    /// Returns a mutable reference to first_event
    pub fn first_event_mut(&mut self) -> &mut Vec<bool> {
        &mut self.first_event
    }

    /// Adds an item to first_event
    pub fn add_first_event(&mut self, item: bool) {
        self.first_event.push(item);
    }

    /// Clears all items from first_event
    pub fn clear_first_event(&mut self) {
        self.first_event.clear();
    }

}

impl std::fmt::Display for DurationObservation {
