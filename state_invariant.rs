// StateInvariant - Generated UML Class
...
const TYPE_NAME: &str = "StateInvariant";
...
#[wasm_bindgen]
impl StateInvariant {
    /// Creates a new StateInvariant instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn set_invariant(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.invariant = ref_id.clone();
