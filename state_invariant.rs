...
lazy_static! {
    static ref STATE_INVARIANT_REGISTRY: Mutex<RefCell<HashMap<String, StateInvariant>>> = 
...
#[wasm_bindgen]
impl StateInvariant {
    /// Creates a new StateInvariant and returns its ID
    #[wasm_bindgen]
    pub fn create(invariant: String) -> String {
        ...
        STATE_INVARIANT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a StateInvariant instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: StateInvariant = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a StateInvariant by ID
    ...
    /// Checks if a StateInvariant exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StateInvariant instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StateInvariant> = STATE_INVARIANT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StateInvariant instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STATE_INVARIANT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StateInvariant instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STATE_INVARIANT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StateInvariant instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StateInvariant = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the invariant reference
    #[wasm_bindgen]
    pub fn set_invariant(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: StateInvariant = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.invariant = ref_id;
...
impl StateInvariant {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate invariant reference exists
        if !Constraint::exists(self.invariant.clone()) {
            errors.push(format!("Constraint {} not found", self.invariant));
        }
