...
lazy_static! {
    static ref PART_DECOMPOSITION_REGISTRY: Mutex<RefCell<HashMap<String, PartDecomposition>>> = 
...
impl PartDecomposition {
    /// Creates a new PartDecomposition and returns its ID
    #[wasm_bindgen]
    pub fn create(refers_to: String) -> String {
        ...
        PART_DECOMPOSITION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a PartDecomposition by ID
    ...
    /// Updates a PartDecomposition instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: PartDecomposition = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a PartDecomposition by ID
    ...
    /// Checks if a PartDecomposition exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all PartDecomposition instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<PartDecomposition> = PART_DECOMPOSITION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of PartDecomposition instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        PART_DECOMPOSITION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all PartDecomposition instances
    #[wasm_bindgen]
    pub fn clear_all() {
        PART_DECOMPOSITION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds PartDecomposition instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: PartDecomposition = serde_wasm_bindgen::from_value(instance_js)
