...
pub struct PartDecomposition {
    ...
    refers_to: Rc<RefCell<Interaction>>,
    actual_gate: Vec<Gate>,
    argument: Vec<Action>,
}

impl PartDecomposition {
    pub fn new(refers_to: Rc<RefCell<Interaction>>) -> Self {
        Self {
    ...
    /// Returns a reference to refers_to
    pub fn refers_to(&self) -> &Rc<RefCell<Interaction>> {
        &self.refers_to
    }

    /// Returns a mutable reference to refers_to
    pub fn refers_to_mut(&mut self) -> &mut Rc<RefCell<Interaction>> {
        &mut self.refers_to
    }

    /// Sets refers_to
    pub fn set_refers_to(&mut self, value: Rc<RefCell<Interaction>>) {
        self.refers_to = value;
    }

    /// Returns a slice of actual_gate
    pub fn actual_gate(&self) -> &[Gate] {
        &self.actual_gate
    }

    /// Returns a mutable reference to actual_gate
    pub fn actual_gate_mut(&mut self) -> &mut Vec<Gate> {
        &mut self.actual_gate
    }

    /// Adds an item to actual_gate
    pub fn add_actual_gate(&mut self, item: Gate) {
        self.actual_gate.push(item);
    }

    /// Clears all items from actual_gate
    pub fn clear_actual_gate(&mut self) {
        self.actual_gate.clear();
    }

    /// Returns a slice of argument
    pub fn argument(&self) -> &[Action] {
        &self.argument
    }

    /// Returns a mutable reference to argument
    pub fn argument_mut(&mut self) -> &mut Vec<Action> {
        &mut self.argument
    }

    /// Adds an item to argument
    pub fn add_argument(&mut self, item: Action) {
...
impl Default for PartDecomposition {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for PartDecomposition {
