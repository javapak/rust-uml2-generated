...
impl PartDecomposition {
    pub fn new(refers_to: String) -> Self {
        Self {
    ...
    /// Returns a clone of refers_to
    pub fn refers_to(&self) -> String {
        self.refers_to.clone()
    }

    /// Sets refers_to
    pub fn set_refers_to(&mut self, value: String) {
        self.refers_to = value;
    }

    /// Takes ownership of refers_to, replacing it with an empty string
    pub fn take_refers_to(&mut self) -> String {
        std::mem::take(&mut self.refers_to)
    }
