...
pub struct AssociationClass {
    ...
    member_end: Vec<Rc<RefCell<Property>>>,
    is_derived: bool,
    navigable_owned_end: Vec<Rc<RefCell<Property>>>,
}

impl AssociationClass {
    pub fn new(is_leaf: bool, is_abstract: bool, is_active: bool, member_end: Vec<Rc<RefCell<Property>>>, is_derived: bool) -> Self {
        Self {
    ...
    /// Returns a slice of owned_end
    pub fn owned_end(&self) -> &[Property] {
        &self.owned_end
    }

    /// Returns a mutable reference to owned_end
    pub fn owned_end_mut(&mut self) -> &mut Vec<Property> {
        &mut self.owned_end
    }

    /// Adds an item to owned_end
    pub fn add_owned_end(&mut self, item: Property) {
        self.owned_end.push(item);
    }

    /// Clears all items from owned_end
    pub fn clear_owned_end(&mut self) {
        self.owned_end.clear();
    }

    /// Returns a reference to member_end
    pub fn member_end(&self) -> &Vec<Rc<RefCell<Property>>> {
        &self.member_end
    }

    /// Returns a mutable reference to member_end
    pub fn member_end_mut(&mut self) -> &mut Vec<Rc<RefCell<Property>>> {
        &mut self.member_end
    }

    /// Adds an item to member_end
    pub fn add_member_end(&mut self, item: Rc<RefCell<Property>>) {
        self.member_end.push(item);
    }
    ...
    /// Returns a reference to navigable_owned_end
    pub fn navigable_owned_end(&self) -> &Vec<Rc<RefCell<Property>>> {
        &self.navigable_owned_end
    }

    /// Returns a mutable reference to navigable_owned_end
    pub fn navigable_owned_end_mut(&mut self) -> &mut Vec<Rc<RefCell<Property>>> {
        &mut self.navigable_owned_end
    }

    /// Adds an item to navigable_owned_end
    pub fn add_navigable_owned_end(&mut self, item: Rc<RefCell<Property>>) {
        self.navigable_owned_end.push(item);
    }
...
impl std::fmt::Display for AssociationClass {
