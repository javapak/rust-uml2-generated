...
lazy_static! {
    static ref ASSOCIATION_CLASS_REGISTRY: Mutex<RefCell<HashMap<String, AssociationClass>>> = 
...
impl AssociationClass {
    /// Creates a new AssociationClass and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_active: String, is_derived: String) -> String {
        ...
        ASSOCIATION_CLASS_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a AssociationClass instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AssociationClass = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AssociationClass by ID
    ...
    /// Checks if a AssociationClass exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AssociationClass instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AssociationClass> = ASSOCIATION_CLASS_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AssociationClass instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ASSOCIATION_CLASS_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AssociationClass instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ASSOCIATION_CLASS_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AssociationClass instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AssociationClass = serde_wasm_bindgen::from_value(instance_js)
