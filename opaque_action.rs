...
lazy_static! {
    static ref OPAQUE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, OpaqueAction>>> = 
...
#[wasm_bindgen]
impl OpaqueAction {
    /// Creates a new OpaqueAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        OPAQUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a OpaqueAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: OpaqueAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a OpaqueAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all OpaqueAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<OpaqueAction> = OPAQUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of OpaqueAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OPAQUE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all OpaqueAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OPAQUE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds OpaqueAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: OpaqueAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a OutputPin to output_value
    #[wasm_bindgen]
    pub fn add_output_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: OpaqueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.output_value.contains(&ref_id) {
            return Ok(false);
        }

        instance.output_value.push(ref_id.clone());
    ...
    /// Removes a OutputPin from output_value
    #[wasm_bindgen]
    pub fn remove_output_value(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: OpaqueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.output_value.iter().position(|x| x == &ref_id) {
            instance.output_value.remove(pos);
    ...
    /// Clears all OutputPin from output_value
    #[wasm_bindgen]
    pub fn clear_output_value(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: OpaqueAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.output_value.len();

        instance.output_value.clear();
...
impl OpaqueAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all output_value references exist
        for id in &self.output_value {
