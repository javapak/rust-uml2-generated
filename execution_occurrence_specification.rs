...
impl ExecutionOccurrenceSpecification {
    pub fn new(event: String, execution: String) -> Self {
        Self {
    ...
    /// Returns a clone of execution
    pub fn execution(&self) -> String {
        self.execution.clone()
    }

    /// Sets execution
    pub fn set_execution(&mut self, value: String) {
        self.execution = value;
    }

    /// Takes ownership of execution, replacing it with an empty string
    pub fn take_execution(&mut self) -> String {
        std::mem::take(&mut self.execution)
    }
    ...
    pub fn type_name() -> String {
        "ExecutionOccurrenceSpecification".to_string()
    }
