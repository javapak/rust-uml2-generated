...
// ============================================================================
//
// Type:           ExecutionOccurrenceSpecification (struct)
// Source Package: uml
...
lazy_static! {
    static ref EXECUTION_OCCURRENCE_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, ExecutionOccurrenceSpecification>>> = 
...
impl ExecutionOccurrenceSpecification {
    /// Creates a new ExecutionOccurrenceSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create(event: String, execution: String) -> String {
        ...
        EXECUTION_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ExecutionOccurrenceSpecification by ID
    ...
    /// Updates a ExecutionOccurrenceSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ExecutionOccurrenceSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ExecutionOccurrenceSpecification by ID
    ...
    /// Checks if a ExecutionOccurrenceSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ExecutionOccurrenceSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ExecutionOccurrenceSpecification> = EXECUTION_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ExecutionOccurrenceSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXECUTION_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ExecutionOccurrenceSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXECUTION_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ExecutionOccurrenceSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ExecutionOccurrenceSpecification = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_execution(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ExecutionOccurrenceSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.execution = ref_id;
...
impl ExecutionOccurrenceSpecification {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate execution reference exists
        if !ExecutionSpecification::exists(self.execution.clone()) {
            errors.push(format!("ExecutionSpecification {} not found", self.execution));
        }
