// ExecutionOccurrenceSpecification - Generated UML Class
...
const TYPE_NAME: &str = "ExecutionOccurrenceSpecification";
...
impl ExecutionOccurrenceSpecification {
    /// Creates a new ExecutionOccurrenceSpecification instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn set_execution(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.execution = ref_id.clone();
