...
lazy_static! {
    static ref NODE_REGISTRY: Mutex<RefCell<HashMap<String, Node>>> = 
...
impl Node {
    ...
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Node = serde_wasm_bindgen::from_value(value)
    ...
    /// Gets all Node instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Node> = NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Node instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Node instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Node = serde_wasm_bindgen::from_value(instance_js)
