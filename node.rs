...
pub fn set_is_active(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_nested_node(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.nested_node.len();
        instance.nested_node.retain(|id| id != &ref_id);
        let removed = instance.nested_node.len() < initial_len;
