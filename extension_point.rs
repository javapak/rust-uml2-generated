// ExtensionPoint - Generated UML Class
...
const TYPE_NAME: &str = "ExtensionPoint";
...
#[wasm_bindgen]
impl ExtensionPoint {
    /// Creates a new ExtensionPoint instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_use_case(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        let old_ref_id = instance.use_case.clone();
            if let Some(mut old_target) = registry::get::<UseCase>(&old_ref_id) {
                old_target.extension_point.retain(|id| id != &instance_id);
                let _ = registry::insert(old_ref_id.clone(), "UseCase", &old_target);
            }
        
        instance.use_case = ref_id.clone();
        
            if let Some(mut new_target) = registry::get::<UseCase>(&ref_id) {
                if !new_target.extension_point.contains(&instance_id) {
                    new_target.extension_point.push(instance_id.clone());
                }
