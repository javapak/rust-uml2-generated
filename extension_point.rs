...
#[wasm_bindgen]
impl ExtensionPoint {
    pub fn new(is_leaf: bool, use_case: String) -> Self {
        Self {
    ...
    /// Sets use_case
    pub fn set_use_case(&mut self, value: String) {
        self.use_case = value;
    }

    /// Takes ownership of use_case, replacing it with an empty string
    pub fn take_use_case(&mut self) -> String {
        std::mem::take(&mut self.use_case)
    }
