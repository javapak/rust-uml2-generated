...
pub struct ExtensionPoint {
    ...
    is_leaf: bool,
    use_case: Weak<RefCell<UseCase>>,
}

impl ExtensionPoint {
    pub fn new(is_leaf: bool, use_case: Weak<RefCell<UseCase>>) -> Self {
        Self {
    ...
    pub fn use_case(&self) -> &Weak<RefCell<UseCase>> {
        &self.use_case
    }

    /// Returns a mutable reference to use_case
    pub fn use_case_mut(&mut self) -> &mut Weak<RefCell<UseCase>> {
        &mut self.use_case
    }

    /// Sets use_case
    pub fn set_use_case(&mut self, value: Weak<RefCell<UseCase>>) {
        self.use_case = value;
    }
