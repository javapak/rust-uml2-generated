...
lazy_static! {
    static ref EXTENSION_POINT_REGISTRY: Mutex<RefCell<HashMap<String, ExtensionPoint>>> = 
...
#[wasm_bindgen]
impl ExtensionPoint {
    /// Creates a new ExtensionPoint and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, use_case: String) -> String {
        ...
        EXTENSION_POINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ExtensionPoint instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ExtensionPoint = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ExtensionPoint by ID
    ...
    /// Checks if a ExtensionPoint exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ExtensionPoint instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ExtensionPoint> = EXTENSION_POINT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ExtensionPoint instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXTENSION_POINT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ExtensionPoint instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXTENSION_POINT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ExtensionPoint instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ExtensionPoint = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the use_case reference
    #[wasm_bindgen]
    pub fn set_use_case(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ExtensionPoint = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
        ...
        if let Ok(target_js) = UseCase::get(ref_id.clone()) {
            if let Ok(mut target) = serde_wasm_bindgen::from_value::<UseCase>(target_js) {
                if !target.extension_point.contains(&instance_id) {
                    target.extension_point.push(instance_id.clone());
                }
                if let Ok(target_js) = serde_wasm_bindgen::to_value(&target) {
...
impl ExtensionPoint {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate use_case reference exists
        if !UseCase::exists(self.use_case.clone()) {
            errors.push(format!("UseCase {} not found", self.use_case));
        }
