// RedefinableTemplateSignature - Generated UML Class
...
const TYPE_NAME: &str = "RedefinableTemplateSignature";
...
impl RedefinableTemplateSignature {
    /// Creates a new RedefinableTemplateSignature instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_extended_signature(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.extended_signature.len();
        instance.extended_signature.retain(|id| id != &ref_id);
        let removed = instance.extended_signature.len() < initial_len;
