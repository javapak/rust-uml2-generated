...
lazy_static! {
    static ref STEREOTYPE_REGISTRY: Mutex<RefCell<HashMap<String, Stereotype>>> = 
...
#[wasm_bindgen]
impl Stereotype {
    /// Creates a new Stereotype and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_active: String) -> String {
        ...
        STEREOTYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Stereotype instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Stereotype = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Stereotype exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Stereotype instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Stereotype> = STEREOTYPE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Stereotype instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STEREOTYPE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Stereotype instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STEREOTYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Stereotype instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Stereotype = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a Image to icon
    #[wasm_bindgen]
    pub fn add_icon(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Stereotype = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.icon.contains(&ref_id) {
            return Ok(false);
        }

        instance.icon.push(ref_id.clone());
    ...
    /// Removes a Image from icon
    #[wasm_bindgen]
    pub fn remove_icon(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Stereotype = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.icon.iter().position(|x| x == &ref_id) {
            instance.icon.remove(pos);
    ...
    /// Clears all Image from icon
    #[wasm_bindgen]
    pub fn clear_icon(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Stereotype = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.icon.len();
...
impl Stereotype {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all icon references exist
        for id in &self.icon {
            if !Image::exists(id.clone()) {
                errors.push(format!("Image {} not found", id));
            }
        }
