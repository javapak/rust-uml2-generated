...
lazy_static! {
    static ref CONTINUATION_REGISTRY: Mutex<RefCell<HashMap<String, Continuation>>> = 
...
#[wasm_bindgen]
impl Continuation {
    /// Creates a new Continuation and returns its ID
    #[wasm_bindgen]
    pub fn create(setting: String) -> String {
        ...
        CONTINUATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Continuation instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Continuation = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Continuation exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Continuation instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Continuation> = CONTINUATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Continuation instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONTINUATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Continuation instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONTINUATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Continuation instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Continuation = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_setting(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Continuation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
