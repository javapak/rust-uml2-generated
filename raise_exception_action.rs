...
impl RaiseExceptionAction {
    pub fn new(is_leaf: bool, exception: InputPin) -> Self {
        Self {
    ...
    /// Returns a reference to exception
    pub fn exception(&self) -> &InputPin {
        &self.exception
    }

    /// Returns a mutable reference to exception
    pub fn exception_mut(&mut self) -> &mut InputPin {
        &mut self.exception
    }

    /// Sets exception
    pub fn set_exception(&mut self, value: InputPin) {
        self.exception = value;
    }

}

impl Default for RaiseExceptionAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for RaiseExceptionAction {
