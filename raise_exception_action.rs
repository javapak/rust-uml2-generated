...
// ============================================================================
//
// Type:           RaiseExceptionAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref RAISE_EXCEPTION_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, RaiseExceptionAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct RaiseExceptionAction {
...
#[wasm_bindgen]
impl RaiseExceptionAction {
    /// Creates a new RaiseExceptionAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, exception: String) -> String {
        ...
        RAISE_EXCEPTION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a RaiseExceptionAction by ID
    ...
    /// Updates a RaiseExceptionAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: RaiseExceptionAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a RaiseExceptionAction by ID
    ...
    /// Checks if a RaiseExceptionAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all RaiseExceptionAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<RaiseExceptionAction> = RAISE_EXCEPTION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of RaiseExceptionAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        RAISE_EXCEPTION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all RaiseExceptionAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        RAISE_EXCEPTION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds RaiseExceptionAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: RaiseExceptionAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_exception(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: RaiseExceptionAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.exception = ref_id;
...
impl RaiseExceptionAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate exception reference exists
        if !InputPin::exists(self.exception.clone()) {
            errors.push(format!("InputPin {} not found", self.exception));
        }
