// RaiseExceptionAction - Generated UML Class
...
const TYPE_NAME: &str = "RaiseExceptionAction";
...
impl RaiseExceptionAction {
    /// Creates a new RaiseExceptionAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_exception(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.exception = ref_id.clone();
    ...
    pub fn type_name() -> String {
        "RaiseExceptionAction".to_string()
    }
