...
lazy_static! {
    static ref INITIAL_NODE_REGISTRY: Mutex<RefCell<HashMap<String, InitialNode>>> = 
...
#[wasm_bindgen]
impl InitialNode {
    /// Creates a new InitialNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        INITIAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a InitialNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: InitialNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a InitialNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InitialNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InitialNode> = INITIAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InitialNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INITIAL_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InitialNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INITIAL_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InitialNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InitialNode = serde_wasm_bindgen::from_value(instance_js)
