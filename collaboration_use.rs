...
lazy_static! {
    static ref COLLABORATION_USE_REGISTRY: Mutex<RefCell<HashMap<String, CollaborationUse>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct CollaborationUse {
    ...
    pub type_: String,
    pub role_binding: Vec<String>,
}

#[wasm_bindgen]
impl CollaborationUse {
    /// Creates a new CollaborationUse and returns its ID
    #[wasm_bindgen]
    pub fn create(type_: String) -> String {
        ...
        let instance = Self {
            ...
            type_: type_,
            role_binding: Vec::new(),
        };

        COLLABORATION_USE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CollaborationUse instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CollaborationUse = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CollaborationUse by ID
    ...
    /// Checks if a CollaborationUse exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CollaborationUse instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CollaborationUse> = COLLABORATION_USE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CollaborationUse instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        COLLABORATION_USE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CollaborationUse instances
    #[wasm_bindgen]
    pub fn clear_all() {
        COLLABORATION_USE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CollaborationUse instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CollaborationUse = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_type_(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CollaborationUse = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
    ...
    /// Adds a Dependency to role_binding
    #[wasm_bindgen]
    pub fn add_role_binding(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CollaborationUse = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.role_binding.contains(&ref_id) {
            return Ok(false);
        }

        instance.role_binding.push(ref_id.clone());
    ...
    /// Removes a Dependency from role_binding
    #[wasm_bindgen]
    pub fn remove_role_binding(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CollaborationUse = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.role_binding.iter().position(|x| x == &ref_id) {
            instance.role_binding.remove(pos);
    ...
    /// Clears all Dependency from role_binding
    #[wasm_bindgen]
    pub fn clear_role_binding(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CollaborationUse = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.role_binding.len();

        instance.role_binding.clear();
...
impl CollaborationUse {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !Collaboration::exists(self.type_.clone()) {
            errors.push(format!("Collaboration {} not found", self.type_));
        }

        // Validate all role_binding references exist
        for id in &self.role_binding {
            if !Dependency::exists(id.clone()) {
                errors.push(format!("Dependency {} not found", id));
            }
        }
