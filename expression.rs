...
lazy_static! {
    static ref EXPRESSION_REGISTRY: Mutex<RefCell<HashMap<String, Expression>>> = 
...
#[wasm_bindgen]
impl Expression {
    /// Creates a new Expression and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Expression instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Expression = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Expression exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Expression instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Expression> = EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Expression instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXPRESSION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Expression instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXPRESSION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Expression instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Expression = serde_wasm_bindgen::from_value(instance_js)
