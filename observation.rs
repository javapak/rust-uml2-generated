...
lazy_static! {
    static ref OBSERVATION_REGISTRY: Mutex<RefCell<HashMap<String, Observation>>> = 
...
#[wasm_bindgen]
impl Observation {
    /// Creates a new Observation and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Observation instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Observation = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Observation exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Observation instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Observation> = OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Observation instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        OBSERVATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Observation instances
    #[wasm_bindgen]
    pub fn clear_all() {
        OBSERVATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Observation instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Observation = serde_wasm_bindgen::from_value(instance_js)
