...
lazy_static! {
    static ref E_ATTRIBUTE_REGISTRY: Mutex<RefCell<HashMap<String, EAttribute>>> = 
...
#[wasm_bindgen]
impl EAttribute {
    /// Creates a new EAttribute and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        E_ATTRIBUTE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Checks if a EAttribute exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all EAttribute instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<EAttribute> = E_ATTRIBUTE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of EAttribute instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        E_ATTRIBUTE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all EAttribute instances
    #[wasm_bindgen]
    pub fn clear_all() {
        E_ATTRIBUTE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds EAttribute instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: EAttribute = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the i_d field
    #[wasm_bindgen]
    pub fn set_i_d(instance_id: String, value: Option<bool>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: EAttribute = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
