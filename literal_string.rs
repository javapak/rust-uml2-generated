...
lazy_static! {
    static ref LITERAL_STRING_REGISTRY: Mutex<RefCell<HashMap<String, LiteralString>>> = 
...
#[wasm_bindgen]
impl LiteralString {
    /// Creates a new LiteralString and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        LITERAL_STRING_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a LiteralString instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LiteralString = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a LiteralString exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LiteralString instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LiteralString> = LITERAL_STRING_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LiteralString instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LITERAL_STRING_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LiteralString instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LITERAL_STRING_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LiteralString instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LiteralString = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_value(instance_id: String, value: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: LiteralString = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
