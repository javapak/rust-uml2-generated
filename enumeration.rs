...
pub struct Enumeration {
    ...
    owned_literal: Vec<EnumerationLiteral>,
}
...
impl Enumeration {
    ...
    /// Returns a slice of owned_literal
    pub fn owned_literal(&self) -> &[EnumerationLiteral] {
        &self.owned_literal
    }

    /// Returns a mutable reference to owned_literal
    pub fn owned_literal_mut(&mut self) -> &mut Vec<EnumerationLiteral> {
        &mut self.owned_literal
    }

    /// Adds an item to owned_literal
    pub fn add_owned_literal(&mut self, item: EnumerationLiteral) {
        self.owned_literal.push(item);
    }

    /// Clears all items from owned_literal
    pub fn clear_owned_literal(&mut self) {
        self.owned_literal.clear();
    }
