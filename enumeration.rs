// Enumeration - Generated UML Class
...
const TYPE_NAME: &str = "Enumeration";
...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn add_owned_literal(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        if let Some(mut target) = registry::get::<EnumerationLiteral>(&ref_id) {
            target.enumeration = Some(instance_id.clone());
            let _ = registry::insert(ref_id.clone(), "EnumerationLiteral", &target);
        }
    ...
    pub fn remove_owned_literal(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.owned_literal.len();
        instance.owned_literal.retain(|id| id != &ref_id);
        let removed = instance.owned_literal.len() < initial_len;
