...
lazy_static! {
    static ref ACTIVITY_GROUP_REGISTRY: Mutex<RefCell<HashMap<String, ActivityGroup>>> = 
...
#[wasm_bindgen]
impl ActivityGroup {
    /// Creates a new ActivityGroup and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        ACTIVITY_GROUP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ActivityGroup instance
    ...
    /// Checks if a ActivityGroup exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ActivityGroup instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ActivityGroup> = ACTIVITY_GROUP_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ActivityGroup instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTIVITY_GROUP_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ActivityGroup instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACTIVITY_GROUP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ActivityGroup = serde_wasm_bindgen::from_value(instance_js)
