...
pub struct TimeEvent {
    ...
    is_relative: bool,
    when: ValueSpecification,
}

impl TimeEvent {
    pub fn new(is_relative: bool, when: ValueSpecification) -> Self {
        Self {
    ...
    /// Sets is_relative
    pub fn set_is_relative(&mut self, value: bool) {
        self.is_relative = value;
    }

    /// Returns a reference to when
    pub fn when(&self) -> &ValueSpecification {
        &self.when
    }

    /// Returns a mutable reference to when
    pub fn when_mut(&mut self) -> &mut ValueSpecification {
        &mut self.when
    }

    /// Sets when
    pub fn set_when(&mut self, value: ValueSpecification) {
        self.when = value;
    }
...
impl std::fmt::Display for TimeEvent {
