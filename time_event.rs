...
lazy_static! {
    static ref TIME_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, TimeEvent>>> = 
...
pub struct TimeEvent {
    ...
    pub is_relative: String,
    pub when: String,
}

#[wasm_bindgen]
impl TimeEvent {
    /// Creates a new TimeEvent and returns its ID
    #[wasm_bindgen]
    pub fn create(is_relative: String, when: String) -> String {
        ...
        TIME_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a TimeEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TimeEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a TimeEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TimeEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TimeEvent> = TIME_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TimeEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TIME_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TimeEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TIME_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TimeEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TimeEvent = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the when reference
    #[wasm_bindgen]
    pub fn set_when(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TimeEvent = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.when = ref_id;
    ...
    /// Sets the is_relative field
    #[wasm_bindgen]
    pub fn set_is_relative(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TimeEvent = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_relative = value;
...
impl TimeEvent {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate when reference exists
        if !ValueSpecification::exists(self.when.clone()) {
            errors.push(format!("ValueSpecification {} not found", self.when));
        }
