...
lazy_static! {
    static ref COMMUNICATION_PATH_REGISTRY: Mutex<RefCell<HashMap<String, CommunicationPath>>> = 
...
impl CommunicationPath {
    /// Creates a new CommunicationPath and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String, is_derived: String) -> String {
        ...
        COMMUNICATION_PATH_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CommunicationPath by ID
    ...
    /// Updates a CommunicationPath instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CommunicationPath = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CommunicationPath by ID
    ...
    /// Checks if a CommunicationPath exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CommunicationPath instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CommunicationPath> = COMMUNICATION_PATH_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CommunicationPath instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        COMMUNICATION_PATH_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CommunicationPath instances
    #[wasm_bindgen]
    pub fn clear_all() {
        COMMUNICATION_PATH_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CommunicationPath instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CommunicationPath = serde_wasm_bindgen::from_value(instance_js)
