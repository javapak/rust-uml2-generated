...
pub fn clear_file_name(instance_id: String) -> Result<(), JsValue> {
    ...
    pub fn remove_nested_artifact(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.nested_artifact.len();
        instance.nested_artifact.retain(|id| id != &ref_id);
        let removed = instance.nested_artifact.len() < initial_len;
    ...
    pub fn remove_manifestation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.manifestation.len();
        instance.manifestation.retain(|id| id != &ref_id);
        let removed = instance.manifestation.len() < initial_len;
