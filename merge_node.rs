...
lazy_static! {
    static ref MERGE_NODE_REGISTRY: Mutex<RefCell<HashMap<String, MergeNode>>> = 
...
#[wasm_bindgen]
impl MergeNode {
    /// Creates a new MergeNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        MERGE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a MergeNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: MergeNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a MergeNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all MergeNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<MergeNode> = MERGE_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of MergeNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        MERGE_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all MergeNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        MERGE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds MergeNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: MergeNode = serde_wasm_bindgen::from_value(instance_js)
