...
lazy_static! {
    static ref INTERACTION_FRAGMENT_REGISTRY: Mutex<RefCell<HashMap<String, InteractionFragment>>> = 
...
impl InteractionFragment {
    /// Creates a new InteractionFragment and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        INTERACTION_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a InteractionFragment by ID
    ...
    /// Updates a InteractionFragment instance
    ...
    /// Deletes a InteractionFragment by ID
    ...
    /// Checks if a InteractionFragment exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all InteractionFragment instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<InteractionFragment> = INTERACTION_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of InteractionFragment instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        INTERACTION_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all InteractionFragment instances
    #[wasm_bindgen]
    pub fn clear_all() {
        INTERACTION_FRAGMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds InteractionFragment instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: InteractionFragment = serde_wasm_bindgen::from_value(instance_js)
