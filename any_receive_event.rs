...
lazy_static! {
    static ref ANY_RECEIVE_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, AnyReceiveEvent>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct AnyReceiveEvent {
...
#[wasm_bindgen]
impl AnyReceiveEvent {
    /// Creates a new AnyReceiveEvent and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        ANY_RECEIVE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a AnyReceiveEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AnyReceiveEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AnyReceiveEvent by ID
    ...
    /// Checks if a AnyReceiveEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AnyReceiveEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AnyReceiveEvent> = ANY_RECEIVE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AnyReceiveEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ANY_RECEIVE_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AnyReceiveEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ANY_RECEIVE_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AnyReceiveEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AnyReceiveEvent = serde_wasm_bindgen::from_value(instance_js)
