...
lazy_static! {
    static ref LITERAL_BOOLEAN_REGISTRY: Mutex<RefCell<HashMap<String, LiteralBoolean>>> = 
...
#[wasm_bindgen]
impl LiteralBoolean {
    /// Creates a new LiteralBoolean and returns its ID
    #[wasm_bindgen]
    pub fn create(value: String) -> String {
        ...
        LITERAL_BOOLEAN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a LiteralBoolean instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: LiteralBoolean = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a LiteralBoolean by ID
    ...
    /// Checks if a LiteralBoolean exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all LiteralBoolean instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<LiteralBoolean> = LITERAL_BOOLEAN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of LiteralBoolean instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        LITERAL_BOOLEAN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all LiteralBoolean instances
    #[wasm_bindgen]
    pub fn clear_all() {
        LITERAL_BOOLEAN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds LiteralBoolean instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: LiteralBoolean = serde_wasm_bindgen::from_value(instance_js)
