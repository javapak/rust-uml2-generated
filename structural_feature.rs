...
lazy_static! {
    static ref STRUCTURAL_FEATURE_REGISTRY: Mutex<RefCell<HashMap<String, StructuralFeature>>> = 
...
impl StructuralFeature {
    /// Creates a new StructuralFeature and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_static: String, is_ordered: String, is_unique: String, is_read_only: String) -> String {
        ...
        STRUCTURAL_FEATURE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a StructuralFeature by ID
    ...
    /// Updates a StructuralFeature instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: StructuralFeature = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a StructuralFeature by ID
    ...
    /// Checks if a StructuralFeature exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StructuralFeature instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StructuralFeature> = STRUCTURAL_FEATURE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StructuralFeature instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STRUCTURAL_FEATURE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StructuralFeature instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STRUCTURAL_FEATURE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StructuralFeature instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StructuralFeature = serde_wasm_bindgen::from_value(instance_js)
