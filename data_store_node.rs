...
lazy_static! {
    static ref DATA_STORE_NODE_REGISTRY: Mutex<RefCell<HashMap<String, DataStoreNode>>> = 
...
#[wasm_bindgen]
impl DataStoreNode {
    /// Creates a new DataStoreNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String) -> String {
        ...
        DATA_STORE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DataStoreNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DataStoreNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a DataStoreNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DataStoreNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DataStoreNode> = DATA_STORE_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DataStoreNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DATA_STORE_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DataStoreNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DATA_STORE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DataStoreNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DataStoreNode = serde_wasm_bindgen::from_value(instance_js)
