...
lazy_static! {
    static ref DIRECTED_RELATIONSHIP_REGISTRY: Mutex<RefCell<HashMap<String, DirectedRelationship>>> = 
...
impl DirectedRelationship {
    /// Creates a new DirectedRelationship and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DIRECTED_RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a DirectedRelationship by ID
    ...
    /// Updates a DirectedRelationship instance
    ...
    /// Deletes a DirectedRelationship by ID
    ...
    /// Checks if a DirectedRelationship exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DirectedRelationship instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DirectedRelationship> = DIRECTED_RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DirectedRelationship instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DIRECTED_RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DirectedRelationship instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DIRECTED_RELATIONSHIP_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DirectedRelationship = serde_wasm_bindgen::from_value(instance_js)
