...
// ============================================================================
//
// Type:           TestIdentityAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref TEST_IDENTITY_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, TestIdentityAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct TestIdentityAction {
...
#[wasm_bindgen]
impl TestIdentityAction {
    /// Creates a new TestIdentityAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, first: String, second: String, result: String) -> String {
        ...
        TEST_IDENTITY_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a TestIdentityAction by ID
    ...
    /// Updates a TestIdentityAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: TestIdentityAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a TestIdentityAction by ID
    ...
    /// Checks if a TestIdentityAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all TestIdentityAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<TestIdentityAction> = TEST_IDENTITY_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of TestIdentityAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TEST_IDENTITY_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all TestIdentityAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TEST_IDENTITY_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds TestIdentityAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: TestIdentityAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_first(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TestIdentityAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.first = ref_id;
    ...
    #[wasm_bindgen]
    pub fn set_second(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: TestIdentityAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.second = ref_id;
...
impl TestIdentityAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate first reference exists
        if !InputPin::exists(self.first.clone()) {
            errors.push(format!("InputPin {} not found", self.first));
        }

        // Validate second reference exists
        if !InputPin::exists(self.second.clone()) {
            errors.push(format!("InputPin {} not found", self.second));
        }
