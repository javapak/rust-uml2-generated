// TestIdentityAction - Generated UML Class
...
const TYPE_NAME: &str = "TestIdentityAction";
...
impl TestIdentityAction {
    /// Creates a new TestIdentityAction instance
    #[wasm_bindgen]
