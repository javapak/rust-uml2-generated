...
impl TestIdentityAction {
    pub fn new(is_leaf: bool, first: InputPin, second: InputPin, result: OutputPin) -> Self {
        Self {
    ...
    /// Returns a reference to first
    pub fn first(&self) -> &InputPin {
        &self.first
    }

    /// Returns a mutable reference to first
    pub fn first_mut(&mut self) -> &mut InputPin {
        &mut self.first
    }

    /// Sets first
    pub fn set_first(&mut self, value: InputPin) {
        self.first = value;
    }

    /// Returns a reference to second
    pub fn second(&self) -> &InputPin {
        &self.second
    }

    /// Returns a mutable reference to second
    pub fn second_mut(&mut self) -> &mut InputPin {
        &mut self.second
    }

    /// Sets second
    pub fn set_second(&mut self, value: InputPin) {
        self.second = value;
    }
...
impl Default for TestIdentityAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for TestIdentityAction {
