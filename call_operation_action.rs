...
// ============================================================================
//
// Type:           CallOperationAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref CALL_OPERATION_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CallOperationAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct CallOperationAction {
    ...
    pub on_port: Option<String>,
    pub is_synchronous: String,
...
#[wasm_bindgen]
impl CallOperationAction {
    /// Creates a new CallOperationAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_synchronous: String, operation: String, target: String) -> String {
        ...
        CALL_OPERATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a CallOperationAction by ID
    ...
    /// Updates a CallOperationAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CallOperationAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a CallOperationAction by ID
    ...
    /// Checks if a CallOperationAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CallOperationAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CallOperationAction> = CALL_OPERATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CallOperationAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CALL_OPERATION_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CallOperationAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CALL_OPERATION_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CallOperationAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CallOperationAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Removes a InputPin from argument
    #[wasm_bindgen]
    ...
    /// Clears all InputPin from argument
    #[wasm_bindgen]
    ...
    /// Sets the on_port reference
    #[wasm_bindgen]
    pub fn set_on_port(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CallOperationAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.on_port = ref_id;
    ...
    #[wasm_bindgen]
    pub fn set_operation(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CallOperationAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.operation = ref_id;
    ...
    /// Sets the is_synchronous field
    #[wasm_bindgen]
    pub fn set_is_synchronous(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: CallOperationAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_synchronous = value;
...
impl CallOperationAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate on_port reference exists
        if let Some(id) = &self.on_port {
            if !Port::exists(id.clone()) {
                errors.push(format!("Port {} not found", id));
            }
        }
        ...
        // Validate operation reference exists
        if !Operation::exists(self.operation.clone()) {
            errors.push(format!("Operation {} not found", self.operation));
        }

        // Validate target reference exists
        if !InputPin::exists(self.target.clone()) {
            errors.push(format!("InputPin {} not found", self.target));
        }
