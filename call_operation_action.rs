...
impl CallOperationAction {
    pub fn new(is_leaf: bool, is_synchronous: bool, operation: String, target: InputPin) -> Self {
        Self {
    ...
    /// Returns a clone of on_port if present
    pub fn on_port(&self) -> Option<String> {
        self.on_port.clone()
    }

    /// Sets on_port
    pub fn set_on_port(&mut self, value: String) {
        self.on_port = Some(value);
    }

    /// Takes on_port, leaving None in its place
    pub fn take_on_port(&mut self) -> Option<String> {
        self.on_port.take()
    }
    ...
    /// Takes ownership of operation, replacing it with an empty string
    pub fn take_operation(&mut self) -> String {
...
impl Default for CallOperationAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for CallOperationAction {
