// CallOperationAction - Generated UML Class
...
const TYPE_NAME: &str = "CallOperationAction";
...
impl CallOperationAction {
    /// Creates a new CallOperationAction instance
    #[wasm_bindgen]
...
pub fn set_is_synchronous(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_operation(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.operation = ref_id.clone();
