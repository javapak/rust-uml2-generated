...
impl CallOperationAction {
    pub fn new(is_leaf: bool, is_synchronous: bool, operation: Rc<RefCell<Operation>>, target: InputPin) -> Self {
        Self {
    ...
    /// Returns a reference to operation
    pub fn operation(&self) -> &Rc<RefCell<Operation>> {
        &self.operation
    }

    /// Returns a mutable reference to operation
    pub fn operation_mut(&mut self) -> &mut Rc<RefCell<Operation>> {
        &mut self.operation
    }

    /// Sets operation
    pub fn set_operation(&mut self, value: Rc<RefCell<Operation>>) {
