...
lazy_static! {
    static ref SEND_SIGNAL_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, SendSignalAction>>> = 
...
#[wasm_bindgen]
impl SendSignalAction {
    /// Creates a new SendSignalAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, target: String, signal: String) -> String {
        ...
        SEND_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a SendSignalAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SendSignalAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a SendSignalAction by ID
    ...
    /// Checks if a SendSignalAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SendSignalAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SendSignalAction> = SEND_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SendSignalAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SEND_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SendSignalAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SEND_SIGNAL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SendSignalAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SendSignalAction = serde_wasm_bindgen::from_value(instance_js)
