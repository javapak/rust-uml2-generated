...
// ============================================================================
//
// Type:           StructuralFeatureAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref STRUCTURAL_FEATURE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, StructuralFeatureAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct StructuralFeatureAction {
...
#[wasm_bindgen]
impl StructuralFeatureAction {
    /// Creates a new StructuralFeatureAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, structural_feature: String, object: String) -> String {
        ...
        STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a StructuralFeatureAction by ID
    ...
    /// Updates a StructuralFeatureAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: StructuralFeatureAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a StructuralFeatureAction by ID
    ...
    /// Checks if a StructuralFeatureAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all StructuralFeatureAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<StructuralFeatureAction> = STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of StructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all StructuralFeatureAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        STRUCTURAL_FEATURE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds StructuralFeatureAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: StructuralFeatureAction = serde_wasm_bindgen::from_value(instance_js)
