// StructuralFeatureAction - Generated UML Class
...
const TYPE_NAME: &str = "StructuralFeatureAction";
...
impl StructuralFeatureAction {
    /// Creates a new StructuralFeatureAction instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_structural_feature(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.structural_feature = ref_id.clone();
