...
// ============================================================================
//
// Type:           RedefinableElement (struct)
// Source Package: uml
...
lazy_static! {
    static ref REDEFINABLE_ELEMENT_REGISTRY: Mutex<RefCell<HashMap<String, RedefinableElement>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct RedefinableElement {
...
#[wasm_bindgen]
impl RedefinableElement {
    /// Creates a new RedefinableElement and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String) -> String {
        ...
        REDEFINABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a RedefinableElement by ID
    ...
    /// Updates a RedefinableElement instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: RedefinableElement = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a RedefinableElement by ID
    ...
    /// Checks if a RedefinableElement exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all RedefinableElement instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<RedefinableElement> = REDEFINABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of RedefinableElement instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        REDEFINABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all RedefinableElement instances
    #[wasm_bindgen]
    pub fn clear_all() {
        REDEFINABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds RedefinableElement instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: RedefinableElement = serde_wasm_bindgen::from_value(instance_js)
