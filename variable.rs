...
impl Variable {
    ...
    /// Returns a clone of scope if present
    ...
    pub fn take_scope(&mut self) -> Option<String> {
        self.scope.take()
    }

    /// Returns a clone of activity_scope if present
    pub fn activity_scope(&self) -> Option<String> {
        self.activity_scope.clone()
    }

    /// Sets activity_scope
    pub fn set_activity_scope(&mut self, value: String) {
        self.activity_scope = Some(value);
    }

    /// Takes activity_scope, leaving None in its place
    pub fn take_activity_scope(&mut self) -> Option<String> {
