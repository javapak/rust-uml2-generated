...
pub fn set_is_unique(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    #[wasm_bindgen]
    pub fn clear_scope(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.scope.is_none() {
            return Ok(false);
        }
    ...
    pub fn set_activity_scope(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        instance.activity_scope = ref_id.clone();
    ...
    #[wasm_bindgen]
    pub fn clear_activity_scope(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.activity_scope.is_none() {
            return Ok(false);
        }
