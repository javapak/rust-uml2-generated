...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_local_precondition(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.local_precondition.len();
        instance.local_precondition.retain(|id| id != &ref_id);
        let removed = instance.local_precondition.len() < initial_len;
    ...
    pub fn remove_local_postcondition(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.local_postcondition.len();
        instance.local_postcondition.retain(|id| id != &ref_id);
        let removed = instance.local_postcondition.len() < initial_len;
