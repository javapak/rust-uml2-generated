...
lazy_static! {
    static ref ACTION_REGISTRY: Mutex<RefCell<HashMap<String, Action>>> = 
...
impl Action {
    ...
    /// Updates a Action instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Action = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Action exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Action instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Action> = ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Action instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Action instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Action = serde_wasm_bindgen::from_value(instance_js)
