...
lazy_static! {
    static ref DATA_TYPE_REGISTRY: Mutex<RefCell<HashMap<String, DataType>>> = 
...
#[wasm_bindgen]
impl DataType {
    /// Creates a new DataType and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_abstract: String) -> String {
        ...
        DATA_TYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DataType instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DataType = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a DataType exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DataType instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DataType> = DATA_TYPE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DataType instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DATA_TYPE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DataType instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DATA_TYPE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DataType instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DataType = serde_wasm_bindgen::from_value(instance_js)
