// MessageOccurrenceSpecification - Generated UML Class
...
const TYPE_NAME: &str = "MessageOccurrenceSpecification";
...
impl MessageOccurrenceSpecification {
    /// Creates a new MessageOccurrenceSpecification instance
    #[wasm_bindgen]
