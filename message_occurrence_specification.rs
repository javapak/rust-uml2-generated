...
// ============================================================================
//
// Type:           MessageOccurrenceSpecification (struct)
// Source Package: uml
...
lazy_static! {
    static ref MESSAGE_OCCURRENCE_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, MessageOccurrenceSpecification>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct MessageOccurrenceSpecification {
...
#[wasm_bindgen]
impl MessageOccurrenceSpecification {
    /// Creates a new MessageOccurrenceSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create(event: String) -> String {
        ...
        MESSAGE_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a MessageOccurrenceSpecification by ID
    ...
    /// Updates a MessageOccurrenceSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: MessageOccurrenceSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a MessageOccurrenceSpecification by ID
    ...
    /// Checks if a MessageOccurrenceSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all MessageOccurrenceSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<MessageOccurrenceSpecification> = MESSAGE_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of MessageOccurrenceSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        MESSAGE_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all MessageOccurrenceSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        MESSAGE_OCCURRENCE_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds MessageOccurrenceSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: MessageOccurrenceSpecification = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_message(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: MessageOccurrenceSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.message = ref_id;
...
impl MessageOccurrenceSpecification {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate message reference exists
