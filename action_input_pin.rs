...
impl ActionInputPin {
    ...
    /// Returns a reference to from_action
    pub fn from_action(&self) -> &Action {
        &self.from_action
    }

    /// Returns a mutable reference to from_action
    pub fn from_action_mut(&mut self) -> &mut Action {
        &mut self.from_action
    }

    /// Sets from_action
    pub fn set_from_action(&mut self, value: Action) {
