...
lazy_static! {
    static ref ACTION_INPUT_PIN_REGISTRY: Mutex<RefCell<HashMap<String, ActionInputPin>>> = 
...
#[wasm_bindgen]
impl ActionInputPin {
    /// Creates a new ActionInputPin and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, ordering: ObjectNodeOrderingKind, is_control_type: String, upper_bound: String, is_ordered: String, is_unique: String, is_control: String, from_action: String) -> String {
        ...
        ACTION_INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ActionInputPin instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ActionInputPin = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ActionInputPin by ID
    ...
    /// Checks if a ActionInputPin exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ActionInputPin instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ActionInputPin> = ACTION_INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ActionInputPin instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTION_INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ActionInputPin instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACTION_INPUT_PIN_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ActionInputPin instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ActionInputPin = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the from_action reference
    #[wasm_bindgen]
    pub fn set_from_action(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ActionInputPin = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.from_action = ref_id;
...
impl ActionInputPin {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate from_action reference exists
        if !Action::exists(self.from_action.clone()) {
            errors.push(format!("Action {} not found", self.from_action));
        }
