...
lazy_static! {
    static ref ACTION_EXECUTION_SPECIFICATION_REGISTRY: Mutex<RefCell<HashMap<String, ActionExecutionSpecification>>> = 
...
impl ActionExecutionSpecification {
    /// Creates a new ActionExecutionSpecification and returns its ID
    #[wasm_bindgen]
    pub fn create(start: String, finish: String, action: String) -> String {
        ...
        ACTION_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ActionExecutionSpecification by ID
    ...
    /// Updates a ActionExecutionSpecification instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ActionExecutionSpecification = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ActionExecutionSpecification by ID
    ...
    /// Checks if a ActionExecutionSpecification exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ActionExecutionSpecification instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ActionExecutionSpecification> = ACTION_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ActionExecutionSpecification instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACTION_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ActionExecutionSpecification instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACTION_EXECUTION_SPECIFICATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ActionExecutionSpecification instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ActionExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_action(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ActionExecutionSpecification = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.action = ref_id;
...
impl ActionExecutionSpecification {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !Action::exists(self.action.clone()) {
            errors.push(format!("Action {} not found", self.action));
        }
