// ActionExecutionSpecification - Generated UML Class
...
const TYPE_NAME: &str = "ActionExecutionSpecification";
...
impl ActionExecutionSpecification {
    /// Creates a new ActionExecutionSpecification instance
    #[wasm_bindgen]
