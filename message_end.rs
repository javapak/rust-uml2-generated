// MessageEnd - Generated UML Class
...
const TYPE_NAME: &str = "MessageEnd";
...
#[wasm_bindgen]
impl MessageEnd {
    /// Creates a new MessageEnd instance
    #[wasm_bindgen]
...
pub fn clear_visibility(instance_id: String) -> Result<(), JsValue> {
    ...
    #[wasm_bindgen]
    pub fn clear_message(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.message.is_none() {
            return Ok(false);
        }
