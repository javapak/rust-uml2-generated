...
lazy_static! {
    static ref MESSAGE_END_REGISTRY: Mutex<RefCell<HashMap<String, MessageEnd>>> = 
...
#[wasm_bindgen]
impl MessageEnd {
    /// Creates a new MessageEnd and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        MESSAGE_END_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a MessageEnd instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: MessageEnd = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a MessageEnd exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all MessageEnd instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<MessageEnd> = MESSAGE_END_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of MessageEnd instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        MESSAGE_END_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all MessageEnd instances
    #[wasm_bindgen]
    pub fn clear_all() {
        MESSAGE_END_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds MessageEnd instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: MessageEnd = serde_wasm_bindgen::from_value(instance_js)
