// DecisionNode - Generated UML Class
...
const TYPE_NAME: &str = "DecisionNode";
...
#[wasm_bindgen]
impl DecisionNode {
    /// Creates a new DecisionNode instance
    #[wasm_bindgen]
...
pub fn set_is_leaf(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_decision_input(instance_id: String, ref_id: Option<String>) -> Result<(), JsValue> {
        ...
        instance.decision_input = ref_id.clone();
    ...
    #[wasm_bindgen]
    pub fn clear_decision_input(instance_id: String) -> Result<bool, JsValue> {
        let mut instance: Self = registry::get(&instance_id)
            .ok_or_else(|| JsValue::from_str("Instance not found"))?;
        
        if instance.decision_input.is_none() {
            return Ok(false);
        }
        
        instance.decision_input = None;
