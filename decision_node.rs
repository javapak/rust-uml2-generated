...
pub struct DecisionNode {
    ...
    decision_input: Option<Rc<RefCell<Behavior>>>,
}
...
impl DecisionNode {
    ...
    /// Returns a reference to decision_input if present
    pub fn decision_input(&self) -> Option<&Rc<RefCell<Behavior>>> {
        self.decision_input.as_ref()
    }

    /// Returns a mutable reference to decision_input if present
    pub fn decision_input_mut(&mut self) -> Option<&mut Rc<RefCell<Behavior>>> {
        self.decision_input.as_mut()
    }

    /// Sets decision_input
    pub fn set_decision_input(&mut self, value: Rc<RefCell<Behavior>>) {
        self.decision_input = Some(value);
    }

    /// Takes decision_input, leaving None in its place
    pub fn take_decision_input(&mut self) -> Option<Rc<RefCell<Behavior>>> {
        self.decision_input.take()
    }

}

impl std::fmt::Display for DecisionNode {
