...
impl DecisionNode {
    ...
    /// Returns a clone of decision_input if present
    pub fn decision_input(&self) -> Option<String> {
        self.decision_input.clone()
    }

    /// Sets decision_input
    pub fn set_decision_input(&mut self, value: String) {
        self.decision_input = Some(value);
    }

    /// Takes decision_input, leaving None in its place
    pub fn take_decision_input(&mut self) -> Option<String> {
