...
lazy_static! {
    static ref SEQUENCE_NODE_REGISTRY: Mutex<RefCell<HashMap<String, SequenceNode>>> = 
...
pub struct SequenceNode {
    ...
    pub node: Vec<String>,
    pub executable_node: Vec<String>,
}

#[wasm_bindgen]
impl SequenceNode {
    /// Creates a new SequenceNode and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, must_isolate: String) -> String {
        ...
        SEQUENCE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a SequenceNode instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: SequenceNode = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a SequenceNode exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all SequenceNode instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<SequenceNode> = SEQUENCE_NODE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of SequenceNode instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        SEQUENCE_NODE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all SequenceNode instances
    #[wasm_bindgen]
    pub fn clear_all() {
        SEQUENCE_NODE_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds SequenceNode instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: SequenceNode = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Adds a ExecutableNode to executable_node
    #[wasm_bindgen]
    pub fn add_executable_node(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: SequenceNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if instance.executable_node.contains(&ref_id) {
            return Ok(false);
        }

        instance.executable_node.push(ref_id.clone());
    ...
    /// Removes a ExecutableNode from executable_node
    #[wasm_bindgen]
    pub fn remove_executable_node(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: SequenceNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        if let Some(pos) = instance.executable_node.iter().position(|x| x == &ref_id) {
            instance.executable_node.remove(pos);
    ...
    /// Clears all ExecutableNode from executable_node
    #[wasm_bindgen]
    pub fn clear_executable_node(instance_id: String) -> Result<usize, JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: SequenceNode = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        let count = instance.executable_node.len();

        instance.executable_node.clear();
...
impl SequenceNode {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate all executable_node references exist
        for id in &self.executable_node {
