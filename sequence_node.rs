// SequenceNode - Generated UML Class
...
const TYPE_NAME: &str = "SequenceNode";
...
#[wasm_bindgen]
impl SequenceNode {
    /// Creates a new SequenceNode instance
    #[wasm_bindgen]
...
pub fn set_must_isolate(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_executable_node(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.executable_node.len();
        instance.executable_node.retain(|id| id != &ref_id);
        let removed = instance.executable_node.len() < initial_len;
