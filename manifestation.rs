...
lazy_static! {
    static ref MANIFESTATION_REGISTRY: Mutex<RefCell<HashMap<String, Manifestation>>> = 
...
pub struct Manifestation {
    ...
    pub utilized_element: String,
}

#[wasm_bindgen]
impl Manifestation {
    /// Creates a new Manifestation and returns its ID
    #[wasm_bindgen]
    pub fn create(utilized_element: String) -> String {
        ...
        MANIFESTATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Manifestation instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Manifestation = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Manifestation exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Manifestation instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Manifestation> = MANIFESTATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Manifestation instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        MANIFESTATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Manifestation instances
    #[wasm_bindgen]
    pub fn clear_all() {
        MANIFESTATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Manifestation instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Manifestation = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the utilized_element reference
    #[wasm_bindgen]
    pub fn set_utilized_element(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: Manifestation = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.utilized_element = ref_id;
...
impl Manifestation {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate utilized_element reference exists
        if !PackageableElement::exists(self.utilized_element.clone()) {
            errors.push(format!("PackageableElement {} not found", self.utilized_element));
        }
