...
// ============================================================================
//
// Type:           ConnectableElement (struct)
// Source Package: uml
...
lazy_static! {
    static ref CONNECTABLE_ELEMENT_REGISTRY: Mutex<RefCell<HashMap<String, ConnectableElement>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ConnectableElement {
...
#[wasm_bindgen]
impl ConnectableElement {
    /// Creates a new ConnectableElement and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        CONNECTABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ConnectableElement by ID
    ...
    /// Updates a ConnectableElement instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ConnectableElement = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ConnectableElement by ID
    ...
    /// Checks if a ConnectableElement exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ConnectableElement instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ConnectableElement> = CONNECTABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ConnectableElement instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CONNECTABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ConnectableElement instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CONNECTABLE_ELEMENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ConnectableElement instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ConnectableElement = serde_wasm_bindgen::from_value(instance_js)
