...
pub struct Profile {
    ...
    metaclass_reference: Vec<Rc<RefCell<ElementImport>>>,
    metamodel_reference: Vec<Rc<RefCell<PackageImport>>>,
}
...
impl Profile {
    ...
    /// Returns a reference to metaclass_reference
    pub fn metaclass_reference(&self) -> &Vec<Rc<RefCell<ElementImport>>> {
        &self.metaclass_reference
    }

    /// Returns a mutable reference to metaclass_reference
    pub fn metaclass_reference_mut(&mut self) -> &mut Vec<Rc<RefCell<ElementImport>>> {
        &mut self.metaclass_reference
    }

    /// Adds an item to metaclass_reference
    pub fn add_metaclass_reference(&mut self, item: Rc<RefCell<ElementImport>>) {
        self.metaclass_reference.push(item);
    }
    ...
    /// Returns a reference to metamodel_reference
    pub fn metamodel_reference(&self) -> &Vec<Rc<RefCell<PackageImport>>> {
        &self.metamodel_reference
    }

    /// Returns a mutable reference to metamodel_reference
    pub fn metamodel_reference_mut(&mut self) -> &mut Vec<Rc<RefCell<PackageImport>>> {
        &mut self.metamodel_reference
    }

    /// Adds an item to metamodel_reference
    pub fn add_metamodel_reference(&mut self, item: Rc<RefCell<PackageImport>>) {
        self.metamodel_reference.push(item);
    }
