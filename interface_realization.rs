...
pub struct InterfaceRealization {
    ...
    contract: String,
    implementing_classifier: String,
}

#[wasm_bindgen]
impl InterfaceRealization {
    pub fn new(supplier: Vec<String>, client: Vec<String>, contract: String, implementing_classifier: String) -> Self {
        Self {
    ...
    /// Sets contract
    pub fn set_contract(&mut self, value: String) {
        self.contract = value;
    }

    /// Takes ownership of contract, replacing it with an empty string
    pub fn take_contract(&mut self) -> String {
        std::mem::take(&mut self.contract)
    }

    /// Returns a clone of implementing_classifier
    pub fn implementing_classifier(&self) -> String {
        self.implementing_classifier.clone()
    }

    /// Sets implementing_classifier
    pub fn set_implementing_classifier(&mut self, value: String) {
        self.implementing_classifier = value;
    }

    /// Takes ownership of implementing_classifier, replacing it with an empty string
    pub fn take_implementing_classifier(&mut self) -> String {
        std::mem::take(&mut self.implementing_classifier)
    }
