...
lazy_static! {
    static ref EXECUTION_EVENT_REGISTRY: Mutex<RefCell<HashMap<String, ExecutionEvent>>> = 
...
#[wasm_bindgen]
impl ExecutionEvent {
    /// Creates a new ExecutionEvent and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        EXECUTION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ExecutionEvent instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ExecutionEvent = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ExecutionEvent by ID
    ...
    /// Checks if a ExecutionEvent exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ExecutionEvent instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ExecutionEvent> = EXECUTION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ExecutionEvent instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        EXECUTION_EVENT_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ExecutionEvent instances
    #[wasm_bindgen]
    pub fn clear_all() {
        EXECUTION_EVENT_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ExecutionEvent instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ExecutionEvent = serde_wasm_bindgen::from_value(instance_js)
