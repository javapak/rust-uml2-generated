...
lazy_static! {
    static ref DURATION_REGISTRY: Mutex<RefCell<HashMap<String, Duration>>> = 
...
#[wasm_bindgen]
impl Duration {
    /// Creates a new Duration and returns its ID
    #[wasm_bindgen]
    ...
    /// Updates a Duration instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Duration = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Duration exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Duration instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Duration> = DURATION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Duration instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DURATION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Duration instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DURATION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Duration instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Duration = serde_wasm_bindgen::from_value(instance_js)
