...
lazy_static! {
    static ref CALL_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, CallAction>>> = 
...
#[wasm_bindgen]
impl CallAction {
    /// Creates a new CallAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_synchronous: String) -> String {
        ...
        CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a CallAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: CallAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a CallAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all CallAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<CallAction> = CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of CallAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all CallAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds CallAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: CallAction = serde_wasm_bindgen::from_value(instance_js)
