...
lazy_static! {
    static ref GATE_REGISTRY: Mutex<RefCell<HashMap<String, Gate>>> = 
...
#[wasm_bindgen]
impl Gate {
    /// Creates a new Gate and returns its ID
    #[wasm_bindgen]
    ...
    /// Updates a Gate instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Gate = serde_wasm_bindgen::from_value(value)
    ...
    /// Gets all Gate instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Gate> = GATE_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Gate instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        GATE_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Finds Gate instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Gate = serde_wasm_bindgen::from_value(instance_js)
