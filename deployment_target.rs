...
lazy_static! {
    static ref DEPLOYMENT_TARGET_REGISTRY: Mutex<RefCell<HashMap<String, DeploymentTarget>>> = 
...
impl DeploymentTarget {
    /// Creates a new DeploymentTarget and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        DEPLOYMENT_TARGET_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a DeploymentTarget instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: DeploymentTarget = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a DeploymentTarget by ID
    ...
    /// Checks if a DeploymentTarget exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all DeploymentTarget instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<DeploymentTarget> = DEPLOYMENT_TARGET_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of DeploymentTarget instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        DEPLOYMENT_TARGET_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all DeploymentTarget instances
    #[wasm_bindgen]
    pub fn clear_all() {
        DEPLOYMENT_TARGET_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds DeploymentTarget instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: DeploymentTarget = serde_wasm_bindgen::from_value(instance_js)
