...
// ============================================================================
//
// Type:           ReadIsClassifiedObjectAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref READ_IS_CLASSIFIED_OBJECT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadIsClassifiedObjectAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadIsClassifiedObjectAction {
...
#[wasm_bindgen]
impl ReadIsClassifiedObjectAction {
    /// Creates a new ReadIsClassifiedObjectAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_direct: String, classifier: String, result: String, object: String) -> String {
        ...
        READ_IS_CLASSIFIED_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a ReadIsClassifiedObjectAction by ID
    ...
    /// Updates a ReadIsClassifiedObjectAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadIsClassifiedObjectAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadIsClassifiedObjectAction by ID
    ...
    /// Checks if a ReadIsClassifiedObjectAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadIsClassifiedObjectAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadIsClassifiedObjectAction> = READ_IS_CLASSIFIED_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadIsClassifiedObjectAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_IS_CLASSIFIED_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadIsClassifiedObjectAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_IS_CLASSIFIED_OBJECT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadIsClassifiedObjectAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadIsClassifiedObjectAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    #[wasm_bindgen]
    pub fn set_classifier(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReadIsClassifiedObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.classifier = ref_id;
    ...
    /// Sets the is_direct field
    #[wasm_bindgen]
    pub fn set_is_direct(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: ReadIsClassifiedObjectAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_direct = value;
...
impl ReadIsClassifiedObjectAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        // Validate classifier reference exists
        if !Classifier::exists(self.classifier.clone()) {
            errors.push(format!("Classifier {} not found", self.classifier));
        }
