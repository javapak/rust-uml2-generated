...
pub struct ReadIsClassifiedObjectAction {
    ...
    is_direct: bool,
    classifier: Rc<RefCell<Classifier>>,
    result: OutputPin,
    object: InputPin,
}

impl ReadIsClassifiedObjectAction {
    pub fn new(is_leaf: bool, is_direct: bool, classifier: Rc<RefCell<Classifier>>, result: OutputPin, object: InputPin) -> Self {
        Self {
    ...
    /// Sets is_direct
    pub fn set_is_direct(&mut self, value: bool) {
        self.is_direct = value;
    }

    /// Returns a reference to classifier
    pub fn classifier(&self) -> &Rc<RefCell<Classifier>> {
        &self.classifier
    }

    /// Returns a mutable reference to classifier
    pub fn classifier_mut(&mut self) -> &mut Rc<RefCell<Classifier>> {
        &mut self.classifier
    }

    /// Sets classifier
    pub fn set_classifier(&mut self, value: Rc<RefCell<Classifier>>) {
...
impl Default for ReadIsClassifiedObjectAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadIsClassifiedObjectAction {
