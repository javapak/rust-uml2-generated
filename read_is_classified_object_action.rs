...
impl ReadIsClassifiedObjectAction {
    pub fn new(is_leaf: bool, is_direct: bool, classifier: String, result: OutputPin, object: InputPin) -> Self {
        Self {
    ...
    /// Returns a clone of classifier
    pub fn classifier(&self) -> String {
        self.classifier.clone()
    }

    /// Sets classifier
    pub fn set_classifier(&mut self, value: String) {
        self.classifier = value;
    }

    /// Takes ownership of classifier, replacing it with an empty string
    pub fn take_classifier(&mut self) -> String {
        std::mem::take(&mut self.classifier)
    }
