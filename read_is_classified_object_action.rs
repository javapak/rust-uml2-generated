// ReadIsClassifiedObjectAction - Generated UML Class
...
const TYPE_NAME: &str = "ReadIsClassifiedObjectAction";
...
impl ReadIsClassifiedObjectAction {
    /// Creates a new ReadIsClassifiedObjectAction instance
    #[wasm_bindgen]
...
pub fn set_is_direct(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn set_classifier(instance_id: String, ref_id: String) -> Result<(), JsValue> {
        ...
        instance.classifier = ref_id.clone();
    ...
    pub fn type_name() -> String {
        "ReadIsClassifiedObjectAction".to_string()
    }
