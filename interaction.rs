...
pub struct Interaction {
    ...
    lifeline: Vec<Lifeline>,
    fragment: Vec<InteractionFragment>,
    action: Vec<Action>,
    formal_gate: Vec<Gate>,
    message: Vec<Message>,
}
...
impl Interaction {
    ...
    /// Returns a slice of lifeline
    pub fn lifeline(&self) -> &[Lifeline] {
        &self.lifeline
    }

    /// Returns a mutable reference to lifeline
    pub fn lifeline_mut(&mut self) -> &mut Vec<Lifeline> {
        &mut self.lifeline
    }

    /// Adds an item to lifeline
    pub fn add_lifeline(&mut self, item: Lifeline) {
        self.lifeline.push(item);
    }

    /// Clears all items from lifeline
    pub fn clear_lifeline(&mut self) {
        self.lifeline.clear();
    }
    ...
    /// Returns a slice of action
    pub fn action(&self) -> &[Action] {
        &self.action
    }

    /// Returns a mutable reference to action
    pub fn action_mut(&mut self) -> &mut Vec<Action> {
        &mut self.action
    }

    /// Adds an item to action
    pub fn add_action(&mut self, item: Action) {
        self.action.push(item);
    }

    /// Clears all items from action
    pub fn clear_action(&mut self) {
        self.action.clear();
    }

    /// Returns a slice of formal_gate
    pub fn formal_gate(&self) -> &[Gate] {
        &self.formal_gate
    }

    /// Returns a mutable reference to formal_gate
    pub fn formal_gate_mut(&mut self) -> &mut Vec<Gate> {
        &mut self.formal_gate
    }

    /// Adds an item to formal_gate
    pub fn add_formal_gate(&mut self, item: Gate) {
        self.formal_gate.push(item);
    }

    /// Clears all items from formal_gate
    pub fn clear_formal_gate(&mut self) {
        self.formal_gate.clear();
    }

    /// Returns a slice of message
    pub fn message(&self) -> &[Message] {
        &self.message
    }

    /// Returns a mutable reference to message
    pub fn message_mut(&mut self) -> &mut Vec<Message> {
        &mut self.message
    }

    /// Adds an item to message
    pub fn add_message(&mut self, item: Message) {
