...
lazy_static! {
    static ref ACCEPT_CALL_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, AcceptCallAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct AcceptCallAction {
...
#[wasm_bindgen]
impl AcceptCallAction {
    /// Creates a new AcceptCallAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, is_unmarshall: String, return_information: String) -> String {
        ...
        let instance = Self {
            ...
            is_unmarshall: is_unmarshall,
            result: Vec::new(),
            trigger: Vec::new(),
            return_information: return_information,
        };

        ACCEPT_CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a AcceptCallAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: AcceptCallAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a AcceptCallAction by ID
    ...
    /// Checks if a AcceptCallAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all AcceptCallAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<AcceptCallAction> = ACCEPT_CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of AcceptCallAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ACCEPT_CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all AcceptCallAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ACCEPT_CALL_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds AcceptCallAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: AcceptCallAction = serde_wasm_bindgen::from_value(instance_js)
    ...
    /// Sets the is_unmarshall field
    #[wasm_bindgen]
    pub fn set_is_unmarshall(instance_id: String, value: String) -> Result<(), JsValue> {
        let instance_js = Self::get(instance_id.clone())?;
        let mut instance: AcceptCallAction = serde_wasm_bindgen::from_value(instance_js)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;

        instance.is_unmarshall = value;
...
impl AcceptCallAction {
    ...
    pub fn validate(&self) -> Result<(), Vec<String>> {
        ...
        if !OutputPin::exists(self.return_information.clone()) {
            errors.push(format!("OutputPin {} not found", self.return_information));
        }
