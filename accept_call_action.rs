...
pub struct AcceptCallAction {
    ...
    trigger: Vec<Trigger>,
    return_information: OutputPin,
}

impl AcceptCallAction {
    pub fn new(is_leaf: bool, is_unmarshall: bool, trigger: Vec<Trigger>, return_information: OutputPin) -> Self {
        Self {
    ...
    /// Returns is_unmarshall
    pub fn is_unmarshall(&self) -> bool {
        self.is_unmarshall
    }

    /// Sets is_unmarshall
    pub fn set_is_unmarshall(&mut self, value: bool) {
        self.is_unmarshall = value;
    }
    ...
    pub fn return_information(&self) -> &OutputPin {
        &self.return_information
    }

    /// Returns a mutable reference to return_information
    pub fn return_information_mut(&mut self) -> &mut OutputPin {
        &mut self.return_information
    }

    /// Sets return_information
    pub fn set_return_information(&mut self, value: OutputPin) {
        self.return_information = value;
    }

}

impl Default for AcceptCallAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for AcceptCallAction {
