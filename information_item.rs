// InformationItem - Generated UML Class
...
const TYPE_NAME: &str = "InformationItem";
...
impl InformationItem {
    /// Creates a new InformationItem instance
    #[wasm_bindgen]
...
pub fn set_is_abstract(instance_id: String, value: String) -> Result<(), JsValue> {
    ...
    pub fn remove_represented(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let initial_len = instance.represented.len();
        instance.represented.retain(|id| id != &ref_id);
        let removed = instance.represented.len() < initial_len;
