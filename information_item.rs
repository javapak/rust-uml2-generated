...
impl InformationItem {
    ...
    /// Returns a clone of represented
    pub fn represented(&self) -> Vec<String> {
        self.represented.clone()
    }

    /// Adds an existing Classifier to represented by ID
    pub fn add_represented_by_id(&mut self, id: String) {
        self.represented.push(id);
    }
