...
lazy_static! {
    static ref TRANSITION_REGISTRY: Mutex<RefCell<HashMap<String, Transition>>> = 
...
#[wasm_bindgen]
impl Transition {
    /// Creates a new Transition and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, kind: TransitionKind, container: String, target: String, source: String) -> String {
        ...
        TRANSITION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Transition instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Transition = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Transition exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Transition instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Transition> = TRANSITION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Transition instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        TRANSITION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Transition instances
    #[wasm_bindgen]
    pub fn clear_all() {
        TRANSITION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Transition instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Transition = serde_wasm_bindgen::from_value(instance_js)
