...
// ============================================================================
//
// Type:           WriteVariableAction (struct)
// Source Package: uml
...
lazy_static! {
    static ref WRITE_VARIABLE_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, WriteVariableAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct WriteVariableAction {
...
#[wasm_bindgen]
impl WriteVariableAction {
    /// Creates a new WriteVariableAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, variable: String, value: String) -> String {
        ...
        WRITE_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Gets a WriteVariableAction by ID
    ...
    /// Updates a WriteVariableAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: WriteVariableAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a WriteVariableAction by ID
    ...
    /// Checks if a WriteVariableAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all WriteVariableAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<WriteVariableAction> = WRITE_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of WriteVariableAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        WRITE_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all WriteVariableAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        WRITE_VARIABLE_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds WriteVariableAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: WriteVariableAction = serde_wasm_bindgen::from_value(instance_js)
