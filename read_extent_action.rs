...
impl ReadExtentAction {
    pub fn new(is_leaf: bool, result: OutputPin, classifier: Rc<RefCell<Classifier>>) -> Self {
        Self {
...
impl Default for ReadExtentAction {
    fn default() -> Self {
        Self {
            e_annotations: Vec::new(),
            owned_comment: Vec::new(),
...
impl std::fmt::Display for ReadExtentAction {
