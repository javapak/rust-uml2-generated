...
lazy_static! {
    static ref READ_EXTENT_ACTION_REGISTRY: Mutex<RefCell<HashMap<String, ReadExtentAction>>> = 
        Mutex::new(RefCell::new(HashMap::new()));
}

#[derive(Debug, Clone, Serialize, Deserialize, Tsify)]
pub struct ReadExtentAction {
...
#[wasm_bindgen]
impl ReadExtentAction {
    /// Creates a new ReadExtentAction and returns its ID
    #[wasm_bindgen]
    pub fn create(is_leaf: String, result: String, classifier: String) -> String {
        ...
        READ_EXTENT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a ReadExtentAction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: ReadExtentAction = serde_wasm_bindgen::from_value(value)
    ...
    /// Deletes a ReadExtentAction by ID
    ...
    /// Checks if a ReadExtentAction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all ReadExtentAction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<ReadExtentAction> = READ_EXTENT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of ReadExtentAction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        READ_EXTENT_ACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all ReadExtentAction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        READ_EXTENT_ACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds ReadExtentAction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: ReadExtentAction = serde_wasm_bindgen::from_value(instance_js)
