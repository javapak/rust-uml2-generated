...
lazy_static! {
    static ref ABSTRACTION_REGISTRY: Mutex<RefCell<HashMap<String, Abstraction>>> = 
...
#[wasm_bindgen]
impl Abstraction {
    /// Creates a new Abstraction and returns its ID
    #[wasm_bindgen]
    pub fn create() -> String {
        ...
        ABSTRACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Updates a Abstraction instance
    /// Takes a JavaScript object and updates the registry
    #[wasm_bindgen]
    pub fn update(value: JsValue) -> Result<(), JsValue> {
        let instance: Abstraction = serde_wasm_bindgen::from_value(value)
    ...
    /// Checks if a Abstraction exists by ID
    #[wasm_bindgen]
    ...
    /// Gets all Abstraction instances
    /// Returns an array of JavaScript objects
    #[wasm_bindgen]
    pub fn get_all() -> Result<JsValue, JsValue> {
        let instances: Vec<Abstraction> = ABSTRACTION_REGISTRY.lock().unwrap()
            .borrow()
            .values()
            .cloned()
            .collect();
    ...
    /// Returns the count of Abstraction instances
    #[wasm_bindgen]
    pub fn count() -> usize {
        ABSTRACTION_REGISTRY.lock().unwrap()
            .borrow()
    ...
    /// Removes all Abstraction instances
    #[wasm_bindgen]
    pub fn clear_all() {
        ABSTRACTION_REGISTRY.lock().unwrap()
            .borrow_mut()
    ...
    /// Finds Abstraction instances by name pattern
    ...
    pub fn add_e_annotation(instance_id: String, ref_id: String) -> Result<bool, JsValue> {
        ...
        let mut instance: Abstraction = serde_wasm_bindgen::from_value(instance_js)
